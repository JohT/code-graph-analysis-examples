...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>19</td>
      <td>1</td>
      <td>[SubscribingEventProcessor$Builder-&gt;SpanFactory, AbstractEventBus$Builder-&gt;SpanFactory, AbstractEventBus$Builder-&gt;NoOpSpanFactory, DefaultEventBusSpanFactory-&gt;Span, DefaultEventBusSpanFactory-&gt;SpanFactory, EventProcessorSpanFactory-&gt;Span, EventBusSpanFactory-&gt;Span, DefaultEventProcessorSpanFacto...</td>
    ...
    <tr>
      ...
      <td>23</td>
      <td>2</td>
      <td>[SequenceNumberParameterResolverFactory$SequenceNumberParameterResolver-&gt;ParameterResolver, SimpleEventHandlerInvoker$Builder-&gt;HandlerDefinition, SimpleEventHandlerInvoker$Builder-&gt;ParameterResolverFactory, SequenceNumberParameterResolverFactory-&gt;AbstractAnnotatedParameterResolverFactory, Sequen...</td>
    ...
    <tr>
      ...
      <td>9</td>
      <td>1</td>
      <td>[SimpleDeadlineManager-&gt;Span, SimpleDeadlineManager$DeadlineTask-&gt;Span, SimpleDeadlineManager$DeadlineTask-&gt;SpanScope, SimpleDeadlineManager$Builder-&gt;SpanFactory, SimpleDeadlineManager$Builder-&gt;NoOpSpanFactory, DefaultDeadlineManagerSpanFactory-&gt;Span, DefaultDeadlineManagerSpanFactory-&gt;SpanFacto...</td>
    ...
    <tr>
      ...
      <td>14</td>
      <td>3</td>
      <td>[AbstractDomainEventEntry-&gt;Serializer, AbstractEventEntry-&gt;SerializedObject, AbstractEventEntry-&gt;SerializedMetaData, AbstractEventEntry-&gt;SimpleSerializedObject, AbstractEventEntry-&gt;Serializer, AbstractEventEntry-&gt;SerializedType, AbstractEventEntry-&gt;SimpleSerializedType, GenericEventMessage-&gt;Cach...</td>
    ...
    <tr>
      ...
      <td>14</td>
      <td>3</td>
      <td>[ExecutionResult-&gt;ResultMessage, CurrentUnitOfWork-&gt;MetaData, DefaultUnitOfWork-&gt;ResultMessage, DefaultUnitOfWork-&gt;Message, DefaultUnitOfWork-&gt;GenericResultMessage, BatchingUnitOfWork-&gt;ResultMessage, BatchingUnitOfWork-&gt;GenericResultMessage, BatchingUnitOfWork-&gt;Message, AbstractUnitOfWork-&gt;Message]</td>
    ...
    <tr>
      ...
      <td>10</td>
      <td>3</td>
      <td>[PropertySequencingPolicy-&gt;EventMessage, PropertySequencingPolicy$Builder-&gt;EventMessage, FullConcurrencyPolicy-&gt;EventMessage, SequentialPerAggregatePolicy-&gt;EventMessage, SequentialPerAggregatePolicy-&gt;DomainEventMessage, AsynchronousEventProcessingStrategy-&gt;EventMessage, AsynchronousEventProcessi...</td>
    ...
    <tr>
      ...
      <td>6</td>
      <td>3</td>
      <td>[IntermediateEventRepresentation-&gt;TrackingToken, UpcastedEventRepresentation-&gt;TrackingToken, InitialEventRepresentation-&gt;EventData, InitialEventRepresentation-&gt;TrackingToken, InitialEventRepresentation-&gt;TrackedEventData, InitialEventRepresentation-&gt;DomainEventData]</td>
    ...
    <tr>
      ...
      <td>13</td>
      <td>8</td>
      <td>[Headers-&gt;SerializedObject, Headers-&gt;SerializedType, Message-&gt;Serializer, Message-&gt;SerializedObject, MessageDecorator-&gt;Serializer, MessageDecorator-&gt;SerializedObject, GenericMessage-&gt;SerializedObjectHolder, GenericMessage-&gt;Serializer, GenericMessage-&gt;SerializedObject]</td>
      <td>[SerializedObjectHolder-&gt;Message, SerializedMessage-&gt;Message, SerializedMessage-&gt;AbstractMessage, SerializedMessage-&gt;GenericMessage, SerializedMessage-&gt;MetaData, AbstractXStreamSerializer-&gt;MetaData, AbstractXStreamSerializer$MetaDataConverter-&gt;MetaData, SerializedMetaData-&gt;MetaData]</td>
    </tr>
    <tr>
      <th>24</th>
      <td>axon-server-connector-4.10.3</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.140625</td>
      <td>[org.axonframework.messaging, org.axonframework.messaging.annotation, org.axonframework.commandhandling.callbacks, org.axonframework.common, org.axonframework.common.transaction, org.axonframework.monitoring, org.axonframework.commandhandling, org.axonframework.messaging.unitofwork, org.axonfram...</td>
      <td>[messaging, annotation, callbacks, common, transaction, monitoring, commandhandling, unitofwork, caching]</td>
    </tr>
    <tr>
      <th>4</th>
      <td>axon-test-4.10.3</td>
      ...
      <td>64</td>
      <td>0.156250</td>
      <td>[org.axonframework.common, org.axonframework.messaging, org.axonframework.commandhandling, org.axonframework.eventhandling, org.axonframework.eventhandling.scheduling, org.axonframework.messaging.annotation, org.axonframework.messaging.unitofwork, org.axonframework.commandhandling.gateway, org.a...</td>
      <td>[common, messaging, commandhandling, eventhandling, scheduling, annotation, unitofwork, gateway, deadline, stream]</td>
    </tr>
    <tr>
      <th>5</th>
      <td>axon-disruptor-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.281250</td>
      <td>[org.axonframework.serialization.xml, org.axonframework.serialization, org.axonframework.common, org.axonframework.common.legacyjpa, org.axonframework.messaging.annotation, org.axonframework.eventhandling, org.axonframework.common.lock, org.axonframework.tracing, org.axonframework.common.jpa, or...</td>
      <td>[xml, serialization, common, legacyjpa, annotation, eventhandling, lock, tracing, jpa, commandhandling, property, messaging, unitofwork, deadline, interceptors, caching, jdbc]</td>
    </tr>
    <tr>
      <th>10</th>
      <td>axon-eventsourcing-4.10.3</td>
      ...
      <td>64</td>
      <td>0.312500</td>
      <td>[org.axonframework.eventhandling, org.axonframework.common.transaction, org.axonframework.tracing, org.axonframework.messaging, org.axonframework.serialization.upcasting.event, org.axonframework.common.lock, org.axonframework.common, org.axonframework.messaging.unitofwork, org.axonframework.comm...</td>
      <td>[eventhandling, transaction, tracing, messaging, event, lock, common, unitofwork, caching, annotation, serialization, jdbc, xml, monitoring, io, stream, lifecycle, legacyjpa, commandhandling, jpa]</td>
    </tr>
    <tr>
      <th>11</th>
      <td>axon-server-connector-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.390625</td>
      <td>[org.axonframework.lifecycle, org.axonframework.tracing, org.axonframework.messaging.responsetypes, org.axonframework.serialization, org.axonframework.util, org.axonframework.messaging, org.axonframework.queryhandling, org.axonframework.common, org.axonframework.common.transaction, org.axonframe...</td>
      <td>[lifecycle, tracing, responsetypes, serialization, util, messaging, queryhandling, common, transaction, commandhandling, inmemory, distributed, tokenstore, eventhandling, monitoring, scheduling, stream, xml, java, jdbc, event, async, unitofwork, pooled, callbacks]</td>
    </tr>
    <tr>
      <th>14</th>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.531250</td>
      <td>[org.axonframework.common.annotation, org.axonframework.monitoring, org.axonframework.serialization.upcasting.event, org.axonframework.serialization.xml, org.axonframework.eventhandling.scheduling, org.axonframework.eventhandling.deadletter, org.axonframework.commandhandling.gateway, org.axonfra...</td>
      <td>[annotation, monitoring, event, xml, scheduling, deadletter, gateway, lock, lifecycle, jpa, eventhandling, serialization, correlation, tokenstore, commandhandling, unitofwork, inmemory, async, caching, transaction, deadline, jdbc, pooled, util, common, queryhandling, messaging, interceptors, tra...</td>
    </tr>
    <tr>
      <th>17</th>
      <td>axon-spring-boot-autoconfigure-4.10.3</td>
    ...
    <tr>
      ...
      <td>10</td>
      <td>0.600000</td>
      <td>[org.axonframework.modelling.saga.repository, org.axonframework.modelling.saga, org.axonframework.modelling.saga.repository.jpa, org.axonframework.modelling.command, org.axonframework.modelling.command.inspection, org.axonframework.modelling.saga.metamodel]</td>
      <td>[repository, saga, jpa, command, inspection, metamodel]</td>
    </tr>
    <tr>
      <th>19</th>
      <td>axon-configuration-4.10.3</td>
      ...
      <td>10</td>
      <td>0.600000</td>
      <td>[org.axonframework.modelling.saga.repository, org.axonframework.modelling.saga, org.axonframework.modelling.command, org.axonframework.modelling.command.inspection, org.axonframework.modelling.saga.repository.jpa, org.axonframework.modelling.saga.repository.inmemory]</td>
      <td>[repository, saga, command, inspection, jpa, inmemory]</td>
    </tr>
    <tr>
      <th>20</th>
      <td>axon-spring-boot-autoconfigure-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.609375</td>
      <td>[org.axonframework.common.jpa, org.axonframework.messaging.deadletter, org.axonframework.eventhandling, org.axonframework.common.legacyjpa, org.axonframework.messaging.correlation, org.axonframework.eventhandling.pooled, org.axonframework.deadline.jobrunr, org.axonframework.lifecycle, org.axonfr...</td>
      <td>[jpa, deadletter, eventhandling, legacyjpa, correlation, pooled, jobrunr, lifecycle, annotation, attributes, messaging, transaction, event, queryhandling, gateway, distributed, commandhandling, jdbc, dbscheduler, common, serialization, xml, json, async, interceptors, scheduling, deadline, tokens...</td>
    </tr>
    <tr>
      <th>22</th>
      <td>axon-test-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.640625</td>
      <td>[org.axonframework.common, org.axonframework.messaging, org.axonframework.queryhandling, org.axonframework.eventhandling.scheduling, org.axonframework.common.transaction, org.axonframework.serialization.xml, org.axonframework.lifecycle, org.axonframework.eventhandling, org.axonframework.messagin...</td>
      <td>[common, messaging, queryhandling, scheduling, transaction, xml, lifecycle, eventhandling, unitofwork, serialization, tracing, deadline, monitoring, tokenstore, stream, io, annotation, commandhandling, digest, commandfilter, callbacks, event, async, replay, correlation, distributed, jdbc, jpa, d...</td>
    </tr>
    <tr>
      <th>24</th>
      <td>axon-eventsourcing-4.10.3</td>
    ...
    <tr>
      ...
      <td>11</td>
      <td>0.818182</td>
      <td>[org.axonframework.axonserver.connector.util, org.axonframework.axonserver.connector.command, org.axonframework.axonserver.connector.query.subscription, org.axonframework.axonserver.connector, org.axonframework.axonserver.connector.event.axon, org.axonframework.axonserver.connector.query, org.ax...</td>
      <td>[util, command, subscription, connector, axon, query, heartbeat, processor]</td>
    </tr>
    <tr>
      <th>26</th>
      <td>axon-spring-boot-autoconfigure-4.10.3</td>
      ...
      <td>9</td>
      <td>0.888889</td>
      <td>[org.axonframework.springboot, org.axonframework.actuator, org.axonframework.actuator.axonserver, org.axonframework.springboot.service.connection, org.axonframework.springboot.util.jpa, org.axonframework.springboot.util, org.axonframework.springboot.autoconfig, org.axonframework.springboot.util....</td>
      <td>[springboot, actuator, axonserver, connection, jpa, util, autoconfig, legacyjpa]</td>
    </tr>
    <tr>
      <th>27</th>
      <td>axon-configuration-4.10.3</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Method</td>
      <td>78</td>
      <td>[org.axonframework.springboot.autoconfig.AxonServerBusAutoConfiguration.queryBus, org.axonframework.springboot.autoconfig.AxonServerBusAutoConfiguration.eventStore, org.axonframework.springboot.autoconfig.legacyjpa.JpaJavaxAutoConfiguration.entityManagerProvider, org.axonframework.springboot.aut...</td>
    </tr>
    <tr>
      <th>4</th>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>1029</td>
      <td>1164</td>
      <td>[/axon-test-4.10.3.jar uses /axon-messaging-4.10.3.jar, /axon-modelling-4.10.3.jar uses /axon-messaging-4.10.3.jar, /axon-disruptor-4.10.3.jar uses /axon-messaging-4.10.3.jar, /axon-server-connector-4.10.3.jar uses /axon-messaging-4.10.3.jar]</td>
    </tr>
    <tr>
      <th>1</th>
      <td>1</td>
