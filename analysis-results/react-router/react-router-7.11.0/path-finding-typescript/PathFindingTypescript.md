...
#### All pairs shortest path in total - Longest shortest path (Graph diameter)
    ...
    The diameter (longest shortest path) of the projected module dependencies Graph is: 6
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>9</td>
      <td>9</td>
      <td>[./index.ts -&gt; ./copy-template.ts, ./index.ts -&gt; ./loading-indicator.ts, ./index.ts -&gt; ./prompt.ts, ./prompt.ts -&gt; ./prompts-confirm.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
      <th>1</th>
      ...
      <td>2</td>
      <td>5</td>
      <td>[./index.ts -&gt; ./prompts-confirm.ts, ./index.ts -&gt; ./prompts-multi-select.ts, ./prompt.ts -&gt; ./prompts-prompt-base.ts, ./index.ts -&gt; ./prompts-select.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>1</td>
      <td>[./index.ts -&gt; ./prompts-prompt-base.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
      ...
      <td>40</td>
      <td>48</td>
      <td>[./lib/rsc/server.rsc.ts -&gt; ./dom-export.ts, ./lib/rsc/server.rsc.ts -&gt; ./index-react-server-client.ts, ./lib/router/utils.ts -&gt; ./index-react-server.ts, ./lib/rsc/server.rsc.ts -&gt; ./index-react-server.ts]</td>
    ...
    <tr>
      ...
      <td>35</td>
      <td>48</td>
      <td>[./lib/router/utils.ts -&gt; ./dom-export.ts, ./lib/server-runtime/build.ts -&gt; ./dom-export.ts, ./lib/server-runtime/cookies.ts -&gt; ./dom-export.ts, ./lib/server-runtime/data.ts -&gt; ./dom-export.ts]</td>
      <td>[react-router -&gt; react-router]</td>
      <td>[react-router -&gt; react-router]</td>
    </tr>
    <tr>
      ...
      <td>35</td>
      <td>43</td>
      <td>[./lib/server-runtime/serverHandoff.ts -&gt; ./dom-export.ts, ./lib/server-runtime/serverHandoff.ts -&gt; ./index-react-server-client.ts, ./lib/server-runtime/serverHandoff.ts -&gt; ./index-react-server.ts, ./lib/server-runtime/serverHandoff.ts -&gt; ./lib/context.ts]</td>
      <td>[react-router -&gt; react-router]</td>
      <td>[react-router -&gt; react-router]</td>
    </tr>
    <tr>
      ...
      <td>35</td>
      <td>18</td>
      <td>[./lib/server-runtime/serverHandoff.ts -&gt; ./lib/errors.ts, ./lib/router/utils.ts -&gt; ./lib/dom/ssr/markup.ts, ./lib/rsc/server.rsc.ts -&gt; ./lib/dom/ssr/markup.ts, ./lib/server-runtime/build.ts -&gt; ./lib/dom/ssr/markup.ts]</td>
      <td>[react-router -&gt; react-router]</td>
      <td>[react-router -&gt; react-router]</td>
    </tr>
    <tr>
      ...
      <td>34</td>
      <td>5</td>
      <td>[./lib/router/utils.ts -&gt; ./lib/types/utils.ts, ./lib/server-runtime/build.ts -&gt; ./lib/types/utils.ts, ./lib/server-runtime/cookies.ts -&gt; ./lib/types/utils.ts, ./lib/server-runtime/data.ts -&gt; ./lib/types/utils.ts]</td>
      <td>[react-router -&gt; react-router]</td>
      <td>[react-router -&gt; react-router]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>3</td>
      <td>[./lib/server-runtime/serverHandoff.ts -&gt; ./vendor/turbo-stream-v2/flatten.ts, ./lib/server-runtime/serverHandoff.ts -&gt; ./vendor/turbo-stream-v2/unflatten.ts, ./lib/server-runtime/serverHandoff.ts -&gt; ./vendor/turbo-stream-v2/utils.ts]</td>
      <td>[react-router -&gt; react-router]</td>
      <td>[react-router -&gt; react-router]</td>
    </tr>
    <tr>
      ...
      <td>2</td>
      <td>4</td>
      <td>[./server.ts -&gt; ./binaryTypes.ts, ./server.ts -&gt; ./index.ts, ./index.ts -&gt; ./server.ts, ./index.ts -&gt; ./sessions/arcTableSessionStorage.ts]</td>
      <td>[react-router-architect -&gt; react-router-architect]</td>
      <td>[react-router-architect -&gt; react-router-architect]</td>
    </tr>
  </tbody>
</table>
...
Shows the top 20 projects with the longest shortest path (=Graph Diameter).
    ...
    react-router-remix-routes-option-adapter    1
...
#### All pairs shortest path for each project - Bar chart (absolute)
    ...
    /tmp/ipykernel_29239/2329962485.py:20: FutureWarning: The provided callable <built-in function sum> is currently using np.sum. In a future version of pandas, the provided callable will be used directly. To keep current behavior pass the string np.sum instead.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>react-router-remix-routes-option-adapter</th>
      <td>100.000000</td>
      <td>0.000000</td>
      <td>0.000000</td>
      <td>0.000000</td>
...
**Note:** It is possible that a (shortest) path could have nodes in between that belong to different root projects. Therefore, the data of each root project isn't perfectly isolated. However, it shows how the dependencies interact across root projects "in real life" while still providing a decent isolation of each root project.
    ...
    /tmp/ipykernel_29239/4070276133.py:8: FutureWarning: The provided callable <built-in function max> is currently using np.maximum.reduce. In a future version of pandas, the provided callable will be used directly. To keep current behavior pass the string np.maximum.reduce instead.
      apply(max).head(20))
...
#### Longest path in total - Max longest path
    ...
    The max. longest path of the projected module dependencies is: 5
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>1</td>
      <td>3</td>
      <td>[./index.ts -&gt; ./copy-template.ts, ./index.ts -&gt; ./loading-indicator.ts, ./index.ts -&gt; ./prompt.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>3</td>
      <td>[./index.ts -&gt; ./prompts-confirm.ts, ./index.ts -&gt; ./prompts-multi-select.ts, ./index.ts -&gt; ./prompts-text.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>1</td>
      <td>[./index.ts -&gt; ./prompts-select.ts]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
      <td>[create-react-router -&gt; create-react-router]</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>3</td>
      <td>10</td>
      <td>[./cli/run.ts -&gt; ./cli/commands.ts, ./vite/rsc/plugin.ts -&gt; ./vite/has-dependency.ts, ./vite/rsc/plugin.ts -&gt; ./vite/load-dotenv.ts, ./vite/cloudflare-dev-proxy.ts -&gt; ./vite/node-adapter.ts]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
    </tr>
    <tr>
      <th>7</th>
      ...
      <td>2</td>
      <td>8</td>
      <td>[./vite/rsc/plugin.ts -&gt; ./routes.ts, ./cli/run.ts -&gt; ./cli/useJavascript.ts, ./cli/run.ts -&gt; ./config/format.ts, ./cli/run.ts -&gt; ./typegen/index.ts]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>6</td>
      <td>[./cli/run.ts -&gt; ./config/config.ts, ./cli/run.ts -&gt; ./config/routes.ts, ./cli/run.ts -&gt; ./vite/has-rsc-plugin.ts, ./cli/run.ts -&gt; ./vite/plugin.ts]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
      <td>[react-router-dev -&gt; react-router-dev]</td>
    </tr>
    <tr>
      ...
      <td>1</td>
      <td>1</td>
      <td>[./index.ts -&gt; ./flatRoutes.ts]</td>
      <td>[react-router-fs-routes -&gt; react-router-fs-routes]</td>
      <td>[react-router-fs-routes -&gt; react-router-fs-routes]</td>
    </tr>
  </tbody>
</table>
...
Shows the top 20 projects with their max. longest path.
    ...
    sourceProject
    create-react-router                         5
    react-router-dev                            3
    react-router-fs-routes                      2
    react-router                                1
    react-router-remix-routes-option-adapter    1
    Name: distance, dtype: int64
