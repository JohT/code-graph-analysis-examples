...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TS,Local,Module | 154 | 7 | 10 | 10 | 7 | 0 | 6 |
...
| --- | --- |
| *Node embeddings aggregated* | 0.045001 |
| pageToArticleRankDifference | 0.021814 |
| pageRank | 0.018535 |
| articleRank | 0.010940 |
| incomingDependencies | 0.009308 |
| nodeEmbeddingPCA_18 | 0.008482 |
| nodeEmbeddingPCA_16 | 0.006364 |
| nodeEmbeddingPCA_10 | 0.006175 |
| degree | 0.004970 |
| nodeEmbeddingPCA_13 | 0.003768 |
| nodeEmbeddingPCA_19 | 0.003019 |

#### Archetype Distribution

| Archetype | Count | Max. Score | Model Status | Examples |
| --- | --- | --- | --- | --- |
|  | 7 | 0.0661 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/config.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index-react-server.ts |
| Authority | 4 | 0.0661 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/config.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-express/server.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-express/index.ts |
| Bottleneck | 2 | 0.0639 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index-react-server.ts |
| Bridge | 7 | 0.0661 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/config.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index-react-server.ts |
| Outlier | 1 | 0.0661 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/config.ts |
|  | 120 | -0.0014 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/is-react-router-repo.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/rsc/html-stream/browser.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/vite/cache.ts |
| Authority | 6 | -0.0014 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/is-react-router-repo.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/rsc/server.rsc.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config.ts |
| Bottleneck | 8 | -0.042 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/router/router.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/dom-export.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/dom/ssr/routeModules.ts |
| Outlier | 5 | -0.005 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/vite/cache.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-fs-routes/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/types/utils.ts |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/config.ts | react-router-dev | 0.0661 | , Outlier, Bridge, Authority | pageToArticleRankDifference | -0.1698 | pageRank | -0.1194 | nodeEmbeddingPCA_18 | -0.0707 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index.ts | react-router | 0.0639 | Bottleneck, , Bridge | pageRank | -0.1901 | articleRank | -0.1824 | pageToArticleRankDifference | -0.1794 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/index-react-server.ts | react-router | 0.0602 | , Bridge, Bottleneck | pageRank | -0.1937 | articleRank | -0.1682 | pageToArticleRankDifference | -0.1554 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-express/server.ts | react-router-express | 0.032 | Bridge, , Authority | nodeEmbeddingPCA_10 | -0.1565 | pageToArticleRankDifference | -0.152 | nodeEmbeddingPCA_16 | -0.1135 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-express/index.ts | react-router-express | 0.0238 | Bridge, , Authority | nodeEmbeddingPCA_10 | -0.1568 | pageToArticleRankDifference | -0.1513 | nodeEmbeddingPCA_16 | -0.1135 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router/lib/router/utils.ts | react-router | 0.0084 | Bridge,  | pageRank | -0.1662 | articleRank | -0.1551 | incomingDependencies | -0.132 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.11.0/source/react-router-7.11.0/packages/react-router-dev/config/routes.ts | react-router-dev | 0.0006 | Authority, Bridge,  | pageToArticleRankDifference | -0.1992 | pageRank | -0.181 | articleRank | -0.1351 | Anomalous |
...
![TopOutlier 3](./Typescript_Module/GraphVisualizations/TopOutlier3.svg)
