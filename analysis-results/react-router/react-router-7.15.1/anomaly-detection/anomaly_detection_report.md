...
| --- | --- | --- | --- | --- | --- |
| 7 | 7 | 10 | 130 | 696 | 0.041503 |

##### Top global contributing features (via SHAP)

| Feature | Mean absolute SHAP value |
| --- | --- |
| *Node embeddings aggregated* | 0.028138 |
| pageToArticleRankDifference | 0.024666 |
| pageRank | 0.018355 |
| articleRank | 0.010537 |
| degree | 0.007645 |
| incomingDependencies | 0.007585 |
| topologicalComponentLayer | 0.005527 |
| nodeEmbeddingPCA_14 | 0.003145 |
| nodeEmbeddingPCA_11 | 0.003038 |
| nodeEmbeddingPCA_16 | 0.002531 |
| nodeEmbeddingPCA_3 | 0.002522 |

#### Archetype Distribution

| Archetype | Count | Max. Score | Model Status | Examples |
| --- | --- | --- | --- | --- |
| Bridge | 7 | 0.0876 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/index-react-server.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-dev/config/config.ts |
| Outlier | 10 | -0.0062 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/lib/types/register.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-remix-routes-option-adapter/manifest.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-remix-routes-option-adapter/defineRoutes.ts |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/index.ts | react-router | 0.0876 | Bridge, Outlier | pageToArticleRankDifference | -0.2264 | pageRank | -0.1719 | articleRank | -0.1318 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/index-react-server.ts | react-router | 0.0548 | Bridge, Outlier | pageToArticleRankDifference | -0.2157 | pageRank | -0.1862 | articleRank | -0.1387 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-dev/config/config.ts | react-router-dev | 0.0428 | Bridge, Outlier | pageToArticleRankDifference | -0.1975 | topologicalComponentLayer | -0.0642 | pageRank | -0.0614 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-dev/config/routes.ts | react-router-dev | 0.0371 | Bridge, Outlier | pageToArticleRankDifference | -0.226 | pageRank | -0.1904 | articleRank | -0.1057 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router/lib/router/utils.ts | react-router | 0.0198 | Bridge, Outlier | pageRank | -0.1798 | pageToArticleRankDifference | -0.1642 | articleRank | -0.1338 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-dev/config.ts | react-router-dev | 0.0076 | Bridge, Outlier | pageToArticleRankDifference | -0.1604 | nodeEmbeddingPCA_3 | -0.1058 | pageRank | -0.0641 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.15.1/source/react-router-7.15.1/packages/react-router-dev/routes.ts | react-router-dev | 0.005 | Bridge, Outlier | pageToArticleRankDifference | -0.2367 | pageRank | -0.1931 | articleRank | -0.1135 | Anomalous |
