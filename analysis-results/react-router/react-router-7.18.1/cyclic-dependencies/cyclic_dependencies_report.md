...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| react-router | ./lib/router/router.ts | react-router | ./lib/router/instrumentation.ts | 0.75 | 7 | 1 | ["RouterInit->ClientInstrumentation","createRouter->instrumentClientSideRouter","createRouter->InstrumentRouterFunction","createStaticHandler->InstrumentRouteFunction","createRouter->InstrumentRouteFunction","createStaticHandler->getRouteInstrumentationUpdates","createRouter->getRouteInstrumentationUpdates"] | ["Router<-instrumentClientSideRouter"] |
| react-router | ./lib/server-runtime/routes.ts | react-router | ./index.ts | 0.75 | 7 | 1 | ["createStaticHandlerDataRoutes->redirect","createStaticHandlerDataRoutes->MiddlewareFunction","createStaticHandlerDataRoutes->replace","createStaticHandlerDataRoutes->decodeViaTurboStream","createStaticHandlerDataRoutes->redirectDocument","createStaticHandlerDataRoutes->SingleFetchRedirectSymbol","createStaticHandlerDataRoutes->DataRouteObject"] | ["ServerRouteManifest<-ServerBuild"] |
| react-router | ./index-react-server.ts | react-router | ./lib/router/utils.ts | 0.7142857142857143 | 36 | 6 | ["createStaticHandler->ErrorResult","createStaticHandler->ErrorResponseImpl","MiddlewareFunction->MiddlewareNextFunction","replace->replace","createStaticHandler->SuccessResult","matchRSCServerRequest->RouterContextProvider","createStaticHandler->RouterContextProvider","createStaticHandler->isRouteErrorResponse","createStaticHandler->getRoutePattern"] | ["RouterContext<-createContext","RouterContext<-RouterContextProvider","MiddlewareNextFunction<-MiddlewareFunction","data<-convertRouteMatchToUiMatch","MiddlewareFunction<-BaseRouteObject","MiddlewareFunction<-RouteObject"] |
| react-router | ./lib/server-runtime/data.ts | react-router | ./index.ts | 0.6666666666666666 | 5 | 1 | ["callRouteHandler->ActionFunction","callRouteHandler->DataWithResponseInit","callRouteHandler->ActionFunctionArgs","callRouteHandler->LoaderFunctionArgs","callRouteHandler->LoaderFunction"] | ["AppLoadContext<-RequestHandler"] |
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | 0.6363636363636364 | 18 | 4 | ["getPartialManifest->RouteMatch","fetchAndApplyManifestPatches->createClientRoutes","getPartialManifest->RouterState","getPatchRoutesOnNavigationFunction->RouterState","getPatchRoutesOnNavigationFunction->createPath","getPatchRoutesOnNavigationFunction->PatchRoutesOnNavigationFunction","useFogOFWarDiscovery->Router","fetchAndApplyManifestPatches->Router","getPartialManifest->Router"] | ["fetchAndApplyManifestPatches<-getPatchRoutesOnNavigationFunction","isFogOfWarEnabled<-getPatchRoutesOnNavigationFunction","fetchAndApplyManifestPatches<-useFogOFWarDiscovery","isFogOfWarEnabled<-useFogOFWarDiscovery"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["createSessionStorage->SessionIdStorageStrategy","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","createSessionStorage->SessionStorage","createSessionStorage->createCookie","isSession->IsSessionFunction","SessionStorage->Session","CreateSessionFunction->Session"] | ["createSessionStorage<-createMemorySessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSession<-createCookieSessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","createSessionStorage->isCookie","isSession->IsSessionFunction","createSessionStorage->createCookie","SessionIdStorageStrategy->CookieSignatureOptions","SessionStorage->Session","CreateSessionFunction->Session"] | ["warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSession<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4666666666666667 | 77 | 28 | ["Router->RouteObject","RouterInit->RouteObject","createRouter->RouteObject","createStaticHandler->RouteObject","RouterState->Fetcher","Router->Fetcher","Navigation->FormEncType","NavigationStates->FormEncType","FetcherStates->FormEncType"] | ["StaticHandlerContext<-EntryContext","IDLE_FETCHER<-createRouter","Router<-createRouter","RouterInit<-createRouter","BlockerFunction<-createRouter","RouterSubscriber<-createRouter","IDLE_BLOCKER<-createRouter","isMutationMethod<-createRouter","RouterState<-createRouter"] |
| react-router | ./lib/server-runtime/server.ts | react-router | ./index.ts | 0.42857142857142855 | 5 | 2 | ["createRequestHandler->CreateRequestHandlerFunction","CreateRequestHandlerFunction->ServerBuild","createRequestHandler->ServerBuild","RequestHandler->AppLoadContext","CreateRequestHandlerFunction->RequestHandler"] | ["RequestHandler<-CreateRequestHandlerFunction","CreateRequestHandlerFunction<-createRequestHandler"] |
