...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 139 | 645 | ["<reactRouterVitePlugin> of module <vite> imports <UserConfig.environments> from external module <node>","<reactRouterVitePlugin> of module <vite> imports <ResolvedConfig.command> from external module <node>","<reactRouterVitePlugin> of module <vite> imports <UserConfig.plugins> from external module <node>","<reactRouterVitePlugin> of module <vite> imports <ViteDevServer> from external module <node>"] |
...
| dist | 17 | 27 | 104 | 263 | 139 | 645 | ["<relative> of module <routes> imports <resolve> from external module <dist>","<relative> of module <routes> imports <resolve> from external module <dist>","<reactRouterRSCVitePlugin> of module <vite> imports <path.normalize> from external module <dist>","<reactRouterRSCVitePlugin> of module <vite> imports <relative> from external module <dist>"] |
| @types/path | 14 | 20 | 55 | 122 | 139 | 645 | ["<getDirectoryFilesRecursive> of module <utils> imports <path.PlatformPath.sep> from external module <path>","<stripDirectoryFromPath> of module <utils> imports <path.PlatformPath.sep> from external module <path>","<flatRoutesUniversal> of module <flatRoutes> imports <path.PlatformPath.relative> from external module <path>","<flatRoutesUniversal> of module <flatRoutes> imports <path.PlatformPath.dirname> from external module <path>"] |
...
| http | 7 | 6 | 16 | 22 | 139 | 645 | ["<reactRouterVitePlugin> of module <vite> imports <ServerResponse.setHeader> from external module <http>","<reactRouterVitePlugin> of module <vite> imports <ServerResponse.end> from external module <http>","<reactRouterVitePlugin> of module <plugin> imports <ServerResponse.setHeader> from external module <http>","<reactRouterVitePlugin> of module <plugin> imports <ServerResponse.end> from external module <http>"] |
...
| @types/babel__generator | 6 | 8 | 13 | 15 | 139 | 645 | ["<reactRouterVitePlugin> of module <vite> imports <GeneratorResult.code> from external module <babel__generator>","<reactRouterVitePlugin> of module <vite> imports <GeneratorResult> from external module <babel__generator>","<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult.code> from external module <babel__generator>","<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult> from external module <babel__generator>"] |
...
| fs | 6 | 6 | 17 | 27 | 139 | 645 | ["<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>","<directoryExists> of module <utils> imports <Stats.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>"] |
...
| sisteransi | 6 | 6 | 27 | 270 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 645 | ["<createPagesFunctionHandler> of module <worker> imports <Request.headers> from external module <workers-types>","<createPagesFunctionHandler> of module <worker> imports <Request.url> from external module <workers-types>","<createPagesFunctionHandler> of module <worker> imports <Request.clone> from external module <workers-types>","<createPagesFunctionHandler> of module <worker> imports <Console.error> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 139 | 645 | ["<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.map> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 139 | 645 | ["<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>"] |
...
| @types/api-gateway-proxy | 2 | 5 | 24 | 34 | 139 | 645 | ["<GetLoadContextFunction> of module <server> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<GetLoadContextFunction> of module <server> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>","<GetLoadContextFunction> of module <react-router-architect> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<GetLoadContextFunction> of module <react-router-architect> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>"] |
| @types/express | 2 | 4 | 26 | 30 | 139 | 645 | ["<RequestHandler> of module <server> imports <e.Request> from external module <express>","<RequestHandler> of module <server> imports <e.NextFunction> from external module <express>","<RequestHandler> of module <server> imports <e.Response> from external module <express>","<RequestHandler> of module <react-router-express> imports <e.Request> from external module <express>"] |
| @types/express-serve-static-core | 2 | 3 | 6 | 6 | 139 | 645 | ["<RequestHandler> of module <server> imports <ParamsDictionary> from external module <express-serve-static-core>","<RequestHandler> of module <react-router-express> imports <ParamsDictionary> from external module <express-serve-static-core>","<GetLoadContextFunction> of module <react-router-express> imports <ParamsDictionary> from external module <express-serve-static-core>","<GetLoadContextFunction> of module <server> imports <ParamsDictionary> from external module <express-serve-static-core>"] |
...
| @types/qs | 2 | 3 | 5 | 5 | 139 | 645 | ["<RequestHandler> of module <server> imports <QueryString.ParsedQs> from external module <qs>","<RequestHandler> of module <react-router-express> imports <QueryString.ParsedQs> from external module <qs>","<GetLoadContextFunction> of module <react-router-express> imports <QueryString.ParsedQs> from external module <qs>","<GetLoadContextFunction> of module <server> imports <QueryString.ParsedQs> from external module <qs>"] |
| @types/stream | 2 | 3 | 18 | 20 | 139 | 645 | ["<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>"] |
| async_hooks | 2 | 4 | 8 | 8 | 139 | 645 | ["<getRequest> of module <react-router> imports <AsyncLocalStorage.getStore> from external module <async_hooks>","<getRequest> of module <server> imports <AsyncLocalStorage.getStore> from external module <async_hooks>","<replace> of module <server> imports <AsyncLocalStorage.getStore> from external module <async_hooks>","<replace> of module <react-router> imports <AsyncLocalStorage.getStore> from external module <async_hooks>"] |
...
| esm | 2 | 2 | 6 | 7 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.on> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.add> from external module <esm>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| no namespace | 53 | 97 | 595 | 1574 | 139 | 645 | ["<copyTemplate> of module <copy-template> imports <node:url> from external namespace <>","<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external namespace <>","<Context> of module <create-react-router> imports <node:process> from external namespace <>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external namespace <>"] |
...
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 645 | ["<createPagesFunctionHandler> of module <worker> imports <Request.headers> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <worker> imports <Request.url> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <worker> imports <Request.clone> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <worker> imports <Console.error> from external namespace <@cloudflare>"] |
...
| @types/path | 13 | 41 | 1 | 7 | 2 | 3.153846153846154 | 2.192645048267573 | 22 | 1 | 5 | 1 | 1.6923076923076923 | 1.1821319289469756 | 0.15503875968992248 | 0.7751937984496124 | 0.15503875968992248 | 0.2623732856290996 | 0.18327626805379468 | ["utils","flatRoutes","react-router-fs-routes","normalizeSlashes"] |
...
| @types/buffer | 6 | 11 | 1 | 3 | 2 | 1.8333333333333335 | 0.752772652709081 | 7 | 1 | 2 | 1 | 1.1666666666666665 | 0.408248290463863 | 0.15503875968992248 | 0.31007751937984496 | 0.15503875968992248 | 0.18087855297157623 | 0.06329430859904853 | ["vite","plugin","server","fileStorage"] |
...
| @types/express | 2 | 19 | 3 | 16 | 9.5 | 9.5 | 9.192388155425117 | 6 | 2 | 4 | 3 | 3 | 1.4142135623730951 | 0.31007751937984496 | 0.6201550387596899 | 0.46511627906976744 | 0.46511627906976744 | 0.21925791664699149 | ["server","react-router-express"] |
| @types/express-serve-static-core | 2 | 3 | 1 | 2 | 1.5 | 1.5 | 0.7071067811865476 | 5 | 2 | 3 | 2.5 | 2.5 | 0.7071067811865476 | 0.31007751937984496 | 0.46511627906976744 | 0.3875968992248062 | 0.3875968992248062 | 0.10962895832349576 | ["server","react-router-express"] |
...
| @types/qs | 2 | 2 | 1 | 1 | 1 | 1 | 0 | 5 | 2 | 3 | 2.5 | 2.5 | 0.7071067811865476 | 0.31007751937984496 | 0.46511627906976744 | 0.3875968992248062 | 0.3875968992248062 | 0.10962895832349576 | ["server","react-router-express"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["UserConfig.environments","ResolvedConfig.command","UserConfig.plugins","ViteDevServer","ModuleNode.file","Logger.info","loadConfigFromFile","ManifestChunk.css","UserConfig.logLevel","ViteDevServer.config","Plugin.name","Plugin","EnvironmentOptions.optimizeDeps","createServer","Logger.warn","ViteDevServer.transformRequest","Connect.Server.use","ManifestChunk.file","ConfigEnv.command","PluginContainer.buildStart","UserConfig.build","ViteBuilder.environments","ResolvedConfig.server","ViteDevServer.ssrFixStacktrace","ViteDevServer.ssrLoadModule","Environment.config","UserConfig.root","EnvironmentOptions","ResolvedConfig.configFile","ViteDevServer.middlewares","Environment.name","RunnableDevEnvironment.runner","ResolvedServerOptions.middlewareMode","isRunnableDevEnvironment","ViteBuilder.build","DevEnvironment.reloadModule","UserConfig.server","PreviewServer.middlewares","ViteDevServer.environments","ViteDevServer.hot","ManifestChunk.assets","DevEnvironment.name","ViteDevServer.pluginContainer","ResolvedConfig.mode","ConfigEnv.isSsrBuild","HotUpdatePluginContext.environment","ResolvedConfig.root","ResolvedBuildOptions.assetsDir","ResolvedConfig.build","HotBroadcaster.send","ModuleNode.url","ResolvedConfig","ResolvedConfig.logger","normalizePath","Logger.error","defaultClientConditions","PreviewServer","DevEnvironment.moduleGraph","ResolvedServerOptions.watch","EnvironmentOptions.resolve","Connect.IncomingMessage.url","ConfigEnv.mode","UserConfig.base","createLogger","ResolvedEnvironmentOptions.build","ResolvedBuildEnvironmentOptions.outDir","ResolvedConfig.base","transformWithEsbuild","PluginOption","ResolvedConfig.environments","version","node","ESBuildOptions"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.Process.cwd","global.NodeJS.Process.exit","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["path.normalize","relative","dist","path.join","resolve","join","path.extname"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readdir","mkdir","rm","readFile","rename","cp"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.resolve","path.PlatformPath.dirname","path.PlatformPath.basename","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.join"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["Dirent.isFile","Dirent.path","Dirent.parentPath","Dirent.name","existsSync"] |
| vite | http | 5 | 8 | 6 | 129 | 25 | 2150 | ["ServerResponse.setHeader","ServerResponse.end","ServerResponse.statusCode"] |
| vite | @types/babel__core | 3 | 3 | 6 | 129 | 25 | 2150 | ["BabelFileResult.map","BabelFileResult.code","transformAsync"] |
| vite | node:fs | 3 | 8 | 6 | 129 | 25 | 2150 | ["existsSync","readdirSync","rmSync"] |
...
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ConfigEnv.mode","Connect.Server.use","Plugin","Plugin.name","UserConfig.root","ResolvedConfig.plugins","ViteDevServer.ssrLoadModule","ResolvedConfig.server","ResolvedServerOptions.middlewareMode","EnvironmentOptions.resolve","ViteDevServer.middlewares","EnvironmentResolveOptions.externalConditions","ViteDevServer.config"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ConfigEnv.mode","Connect.Server.use","Plugin","Plugin.name","UserConfig.root","ResolvedConfig.plugins","ViteDevServer.ssrLoadModule","ResolvedConfig.server","ResolvedServerOptions.middlewareMode","EnvironmentOptions.resolve","ViteDevServer.middlewares","EnvironmentResolveOptions.externalConditions","ViteDevServer.config"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["ModuleNode","ViteDevServer","UserConfig.build","UserConfig.environments","defaultServerConditions","resolveConfig","ResolvedConfig.build","Plugin","ResolvedBuildOptions.manifest","ResolvedConfig","UserConfig","ResolvedBuildOptions.emptyOutDir","ResolvedConfig.command","UserConfig.plugins","ModuleNode.file","Logger.info","loadConfigFromFile","ManifestChunk.css","UserConfig.logLevel","ViteDevServer.config","Plugin.name","EnvironmentOptions.optimizeDeps","createServer","Logger.warn","ViteDevServer.transformRequest","Connect.Server.use","ManifestChunk.file","ConfigEnv.command","PluginContainer.buildStart","ViteBuilder.environments","ResolvedConfig.server","ViteDevServer.ssrFixStacktrace","ViteDevServer.ssrLoadModule","Environment.config","UserConfig.root","EnvironmentOptions","ResolvedConfig.configFile","ViteDevServer.middlewares","Environment.name","RunnableDevEnvironment.runner","ResolvedServerOptions.middlewareMode","isRunnableDevEnvironment","ViteBuilder.build","DevEnvironment.reloadModule","UserConfig.server","PreviewServer.middlewares","ViteDevServer.environments","ViteDevServer.hot","ManifestChunk.assets","DevEnvironment.name","ViteDevServer.pluginContainer","ResolvedConfig.mode","ConfigEnv.isSsrBuild","HotUpdatePluginContext.environment","ResolvedConfig.root","ResolvedBuildOptions.assetsDir","HotBroadcaster.send","ModuleNode.url","ResolvedConfig.logger","normalizePath","Logger.error","defaultClientConditions","PreviewServer","DevEnvironment.moduleGraph","ResolvedServerOptions.watch","EnvironmentOptions.resolve","Connect.IncomingMessage.url","ConfigEnv.mode","UserConfig.base","createLogger","ResolvedEnvironmentOptions.build","ResolvedBuildEnvironmentOptions.outDir","ResolvedConfig.base","transformWithEsbuild","PluginOption","ResolvedConfig.environments"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.resolve","path.PlatformPath.join","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.relative","path.PlatformPath.isAbsolute","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","mkdir","readFile","rename","cp"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.Process.cwd","global.NodeJS.Process.exit","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["path.normalize","relative","dist","path.join","resolve","join","path.extname"] |
| plugin | fs | 5 | 10 | 18 | 135 | 26 | 750 | ["Dirent.isFile","Dirent.path","Dirent.parentPath","Dirent.name","existsSync"] |
...
| plugin | @types/babel__core | 3 | 3 | 18 | 135 | 26 | 750 | ["BabelFileResult.map","BabelFileResult.code","transformAsync"] |
...
| prompts-prompt-base | node:readline | 3 | 48 | 2 | 14 | 6 | 700 | [".createInterface",".emitKeypressEvents","node:readline"] |
| prompts-prompt-base | sisteransi | 3 | 36 | 2 | 14 | 6 | 700 | ["cursor.show","cursor","beep"] |
...
| prompts-text | sisteransi | 7 | 84 | 2 | 8 | 2 | 400 | ["cursor.restore","cursor.to","cursor.down","erase","cursor.save","erase.line","cursor.move"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["Request.headers","Request.url","Request.clone","Console.error","Response","EventContext.env","Response.status","Headers.delete","EventContext","EventContext.request","Response.body","Request","CfProperties","IncomingRequestCfProperties","CacheStorage","KVNamespace.delete","Crypto.getRandomValues","KVNamespace.put","KVNamespace.get","EventContext.passThroughOnException","EventContext.waitUntil","Request.cf"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Request","EventContext","CfProperties","IncomingRequestCfProperties","CacheStorage","EventContext.passThroughOnException","EventContext.waitUntil","Request.cf","EventContext.request","Response","Request.headers","Request.url","Request.clone","Console.error","EventContext.env","Response.status","Headers.delete","Response.body"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ResolvedConfig.logger","Logger.info","ViteDevServer.listen","ViteDevServer.printUrls","ViteDevServer.bindCLIShortcuts","Plugin.name","createServer","ResolvedConfig.plugins","ViteDevServer.config"] |
| dev | @types/process | 4 | 5 | 5 | 14 | 5 | 280 | ["global.NodeJS.Process.exit","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.hasOwnProperty","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST"] |
...
| prompts-multi-select | sisteransi | 4 | 48 | 2 | 5 | 2 | 250 | ["cursor.hide","erase.line","erase","cursor.to"] |
...
| react-router-node | @types/stream | 9 | 10 | 7 | 17 | 8 | 242.85714285714286 | ["Stream.Writable.end","Stream.Writable.write","Stream.Writable","Stream.Writable.destroy","Stream.Readable"] |
...
| react-router-node | promises | 4 | 7 | 7 | 17 | 8 | 242.85714285714286 | [".mkdir",".readFile",".unlink",".writeFile"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["path.dirname","path.resolve","dist","path.join","ViteNodeRunner.moduleCache","path.relative","path.normalize","ModuleCacheMap.clear","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["esm","FSWatcher.on","FSWatcher.add","_default.watch","FSWatcher.unwatch"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["ViteDevServer.close","ModuleGraph.invalidateAll","ModuleGraph.getModuleById","ViteDevServer.moduleGraph","createLogger"] |
...
| prompts-select | sisteransi | 4 | 48 | 3 | 6 | 3 | 200 | ["cursor.hide","erase.line","erase","cursor.to"] |
...
| stream | @types/stream | 9 | 10 | 4 | 7 | 3 | 175 | ["Stream.Readable","Stream.Writable.end","Stream.Writable.destroy","Stream.Writable","Stream.Writable.write"] |
| stream | @types/buffer | 2 | 2 | 4 | 7 | 3 | 175 | ["global.BufferConstructor.concat","global.Buffer.toString"] |
| prompts-confirm | sisteransi | 4 | 48 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.to","erase.line","erase","cursor.hide"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","flatten","safeParse","isAbsolute","relative","array","ArraySchema","BaseSchema","BaseIssue","pipe","boolean","BooleanSchema","SchemaWithPipe","custom","notValue","object","CustomIssue","CustomSchema","OptionalSchema","lazy","LazySchema","optional","NotValueAction","StringSchema","ObjectSchema","string"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["File","VariableDeclaration.declarations","isNodesEquivalent","isFunctionDeclaration","File.program","isImportDeclaration","ExportNamedDeclaration.specifiers","isClassDeclaration","isVariableDeclaration","Identifier.name","isExportDefaultDeclaration","isExportAllDeclaration","ExportNamedDeclaration.declaration","Program.body","isExportNamedDeclaration","isExportDeclaration","ImportDeclaration.specifiers"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Response.statusMessage","e.Response","e.Response.end","e.Response.status","e.Response.append","e.Response.flushHeaders","e.Request","e.Request.hostname","e.Request.protocol","e.Request.headers","e.Request.method","e.Request.get","e.Request.originalUrl","e.Request.app","e.Response.on","e.NextFunction"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2","APIGatewayProxyEventV2.cookies","APIGatewayEventRequestContextV2","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2.body","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.requestContext","APIGatewayEventRequestContextV2.http","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
| server | @types/react | 6 | 22 | 41 | 53 | 14 | 129.2682926829268 | ["React.createElement","React.Fragment","React.ReactElement","React.ReactNode","React.ComponentClass","React.FunctionComponent"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.relative","path.PlatformPath.dirname","path.PlatformPath.extname","path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.sep","path.PlatformPath.win32"] |
...
| cookies | dist | 7 | 13 | 6 | 6 | 2 | 100 | ["SerializeOptions","ParseOptions","Cookies.name","serialize","parse","StringifyOptions"] |
...
| sessions | dist | 6 | 17 | 11 | 5 | 1 | 45.45454545454546 | ["SerializeOptions.maxAge","SerializeOptions.expires","ParseOptions","SerializeOptions","StringifyOptions"] |
| context | @types/react | 27 | 45 | 21 | 9 | 1 | 42.857142857142854 | ["React.Context","React.createContext","React.Context.Provider","React.FunctionComponentElement","React.createElement","React.ProviderProps","React.useContext","React.ReactNode","React.ReactElement"] |
...
| routeModules | @types/react | 12 | 50 | 21 | 3 | 1 | 14.285714285714285 | ["React.ComponentClass","React.FunctionComponent","React.ReactElement"] |
| fog-of-war | @types/react | 1 | 1 | 8 | 1 | 1 | 12.5 | ["React.useEffect"] |
| react-router | @types/react | 31 | 79 | 178 | 19 | 4 | 10.674157303370787 | ["React.Context.Provider","React.FunctionComponentElement","React.createElement","React.ProviderProps","React.ReactElement","React.ReactNode","React.Fragment","React.ComponentClass","React.FunctionComponent","React.createContext","React.Context","React.useEffect"] |
| react-router | dist | 7 | 13 | 178 | 19 | 4 | 10.674157303370787 | ["SerializeOptions","ParseOptions","Cookies.name","serialize","parse","StringifyOptions"] |
