...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4766355140186916 | 79 | 28 | ["createRouter->isRouteErrorResponse","createStaticHandler->isRouteErrorResponse","getStaticContextFromError->isRouteErrorResponse","Router->GetScrollPositionFunction","StaticHandler->StaticHandlerContext","createStaticHandler->StaticHandlerContext","getStaticContextFromError->StaticHandlerContext","Router->RouterState","createRouter->RouterState"] | ["Blocker<-RouterState","Navigation<-RouterState","Fetcher<-RouterState","RevalidationState<-RouterState","StaticHandlerContext<-EntryContext","StaticHandlerContext<-StaticHandler","RouterState<-DataRouterStateContext","Router<-DataRouterStateContext","RouterState<-createRouter"] |
