...
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | 0.6363636363636364 | 18 | 4 | ["getPatchRoutesOnNavigationFunction->RouterState","getPartialManifest->RouterState","fetchAndApplyManifestPatches->createClientRoutes","getPatchRoutesOnNavigationFunction->RouteModules","useFogOFWarDiscovery->RouteModules","fetchAndApplyManifestPatches->RouteModules","getPartialManifest->DataRouteObject","getPatchRoutesOnNavigationFunction->PatchRoutesOnNavigationFunction","getPatchRoutesOnNavigationFunction->AssetsManifest"] | ["isFogOfWarEnabled<-getPatchRoutesOnNavigationFunction","fetchAndApplyManifestPatches<-getPatchRoutesOnNavigationFunction","isFogOfWarEnabled<-useFogOFWarDiscovery","fetchAndApplyManifestPatches<-useFogOFWarDiscovery"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["createSessionStorage->SessionIdStorageStrategy","isSession->IsSessionFunction","createSessionStorage->SessionStorage","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","createSessionStorage->createCookie","SessionStorage->Session","CreateSessionFunction->Session"] | ["warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSession<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["createSessionStorage->SessionIdStorageStrategy","createSessionStorage->isCookie","createSessionStorage->SessionStorage","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","createSessionStorage->createCookie","SessionStorage->Session","CreateSessionFunction->Session"] | ["createSessionStorage<-createMemorySessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSession<-createCookieSessionStorage"] |
...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4766355140186916 | 79 | 28 | ["createRouter->isRouteErrorResponse","createStaticHandler->isRouteErrorResponse","getStaticContextFromError->isRouteErrorResponse","Router->GetScrollPositionFunction","StaticHandler->StaticHandlerContext","getStaticContextFromError->StaticHandlerContext","createStaticHandler->StaticHandlerContext","Router->RouterState","createRouter->RouterState"] | ["Blocker<-RouterState","Navigation<-RouterState","Fetcher<-RouterState","RevalidationState<-RouterState","StaticHandlerContext<-EntryContext","StaticHandlerContext<-StaticHandler","RouterState<-DataRouterStateContext","Router<-DataRouterStateContext","RouterState<-createRouter"] |
