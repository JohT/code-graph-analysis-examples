...
| --- | --- |
| *Node embeddings aggregated* | 0.038630 |
| pageToArticleRankDifference | 0.019608 |
| pageRank | 0.016371 |
| articleRank | 0.010217 |
| degree | 0.008917 |
| nodeEmbeddingPCA_13 | 0.006849 |
| incomingDependencies | 0.006320 |
| nodeEmbeddingPCA_11 | 0.005418 |
| nodeEmbeddingPCA_12 | 0.003874 |
| localClusteringCoefficient | 0.003486 |
| nodeEmbeddingPCA_3 | 0.003421 |

#### Archetype Distribution

| Archetype | Count | Max. Score | Model Status | Examples |
| --- | --- | --- | --- | --- |
| Bridge | 7 | 0.0667 | Anomalous | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router/index.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router/index-react-server.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-express/server.ts |
| Outlier | 4 | -0.0242 | Typical | /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-dev/vite/profiler.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-dev/cli/run.ts, /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-dev/cli/useJavascript.ts |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router/index.ts | react-router | 0.0667 | Bridge, Outlier | pageToArticleRankDifference | -0.1777 | pageRank | -0.1616 | articleRank | -0.1539 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router/index-react-server.ts | react-router | 0.0577 | Bridge, Outlier | pageToArticleRankDifference | -0.1833 | pageRank | -0.1665 | articleRank | -0.1526 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-express/server.ts | react-router-express | 0.018 | Bridge, Outlier | pageToArticleRankDifference | -0.1672 | nodeEmbeddingPCA_13 | -0.1606 | nodeEmbeddingPCA_11 | -0.0935 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-express/index.ts | react-router-express | 0.0127 | Bridge, Outlier | nodeEmbeddingPCA_13 | -0.1595 | pageToArticleRankDifference | -0.1521 | nodeEmbeddingPCA_11 | -0.0941 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router/lib/router/utils.ts | react-router | 0.0062 | Bridge, Outlier | pageRank | -0.1406 | articleRank | -0.1405 | pageToArticleRankDifference | -0.11 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-dev/config/routes.ts | react-router-dev | 0.0043 | Bridge, Outlier | pageToArticleRankDifference | -0.187 | pageRank | -0.1573 | articleRank | -0.0988 | Anomalous |
| /home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.3/source/react-router-7.18.3/packages/react-router-dev/config/config.ts | react-router-dev | 0.0025 | Bridge, Outlier | pageToArticleRankDifference | -0.1701 | nodeEmbeddingPCA_13 | -0.0773 | pageRank | -0.0756 | Anomalous |
