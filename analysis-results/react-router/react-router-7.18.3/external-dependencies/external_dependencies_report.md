...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 140 | 648 | ["<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedConfig.base> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <transformWithEsbuild> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedConfig.environments> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <normalizePath> from external module <node>"] |
...
| node:fs | 10 | 12 | 26 | 49 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <.existsSync> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <node:fs> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <.readdirSync> from external module <node:fs>","<flatRoutes> of module <react-router-fs-routes> imports <.existsSync> from external module <node:fs>"] |
...
| fs | 6 | 6 | 17 | 27 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
...
| sisteransi | 6 | 6 | 27 | 116 | 140 | 648 | ["<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 140 | 648 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportDefaultDeclaration.declaration> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportSpecifier.local> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 140 | 648 | ["<createRequestHandler> of module <worker> imports <EventContext.passThroughOnException> from external module <workers-types>","<createRequestHandler> of module <worker> imports <Request.cf> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.waitUntil> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.request> from external module <workers-types>"] |
...
| @types/babel__traverse | 3 | 3 | 17 | 49 | 140 | 648 | ["<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>"] |
...
| @types/stream | 2 | 3 | 14 | 16 | 140 | 648 | ["<createReadableStreamFromReadable> of module <react-router-node> imports <Stream.Readable> from external module <stream>","<createReadableStreamFromReadable> of module <stream> imports <Stream.Readable> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>"] |
...
| esm | 2 | 2 | 6 | 7 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.on> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.add> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.unwatch> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.resolve> from external module <rollup>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["ExportDefaultDeclaration.declaration","ExportSpecifier.local","ExpressionStatement.expression","Identifier.name","ClassDeclaration.id","VariableDeclarator.id","ExportNamedDeclaration.specifiers","ExportSpecifier.exported","FunctionDeclaration.id","MemberExpression.object","AssignmentExpression.left","ExportNamedDeclaration.declaration","ExportDeclaration.type","Expression.type","LVal.type","VariableDeclaration.declarations"] |
| remove-exports | @types/babel__traverse | 4 | 24 | 1 | 23 | 4 | 2300 | ["NodePath.remove","NodePath.node","NodePath.parentPath","NodePath.isProgram"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["ResolvedConfig.base","transformWithEsbuild","ResolvedConfig.environments","normalizePath","UserConfig.logLevel","Logger.error","ResolvedEnvironmentOptions.build","Connect.Server.use","Logger.info","PluginOption","Connect.IncomingMessage.url","PreviewServer.middlewares","UserConfig.base","createLogger","UserConfig.server","ResolvedBuildEnvironmentOptions.outDir","UserConfig.build","ConfigEnv.mode","ResolvedConfig.mode","ResolvedConfig.command","ManifestChunk.assets","ResolvedConfig.build","UserConfig.environments","DevEnvironment.moduleGraph","ViteDevServer.config","ViteDevServer.pluginContainer","ViteBuilder.build","isRunnableDevEnvironment","ResolvedConfig.root","ModuleNode.file","ViteDevServer.hot","ResolvedConfig","ViteDevServer","DevEnvironment.reloadModule","ViteBuilder.environments","loadConfigFromFile","HotUpdatePluginContext.environment","ViteDevServer.environments","EnvironmentOptions","DevEnvironment.name","ViteDevServer.transformRequest","ResolvedConfig.configFile","createServer","ManifestChunk.css","ModuleNode.url","EnvironmentOptions.optimizeDeps","Plugin.name","ResolvedBuildOptions.assetsDir","RunnableDevEnvironment.runner","defaultClientConditions","ManifestChunk.file","HotBroadcaster.send","EnvironmentOptions.resolve","Logger.warn","UserConfig.plugins","Plugin","ResolvedConfig.logger","Environment.config","ResolvedServerOptions.middlewareMode","ConfigEnv.command","ViteDevServer.middlewares","ViteDevServer.ssrFixStacktrace","UserConfig.root","Environment.name","ResolvedServerOptions.watch","ConfigEnv.isSsrBuild","ViteDevServer.ssrLoadModule","PreviewServer","PluginContainer.buildStart","ResolvedConfig.server","version","node","ESBuildOptions"] |
...
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["relative","path.extname","path.join","resolve","dist","path.normalize","join"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","cp","rm","readdir","mkdir","rename"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.basename","path.PlatformPath.dirname","path.PlatformPath.relative"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.isFile","Dirent.name","Dirent.parentPath","Dirent.path"] |
...
| vite | node:fs | 3 | 8 | 6 | 129 | 25 | 2150 | ["rmSync","existsSync","readdirSync"] |
| vite | rollup | 3 | 5 | 6 | 129 | 25 | 2150 | ["PluginContext.resolve","PluginContext.environment","ResolvedId.id"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.isVariableDeclaration","NodePath.scope","NodePath.isExportDefaultDeclaration","NodePath.isFunctionDeclaration","NodePath.replaceWith","NodePath.isExportNamedDeclaration","Scope.generateUidIdentifier","NodePath.node","NodePath.isExpression","NodePath.isIdentifier","NodePath.get"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["identifier","Program.body","callExpression","variableDeclarator","stringLiteral","importSpecifier","importDeclaration","variableDeclaration"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult","ParseResult.program"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.middlewares","Plugin.name","Plugin","ViteDevServer.ssrLoadModule","UserConfig.root","ResolvedServerOptions.middlewareMode","ViteDevServer.config","EnvironmentOptions.resolve","EnvironmentResolveOptions.externalConditions","ResolvedConfig.plugins","ResolvedConfig.server","ConfigEnv.mode","Connect.Server.use"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.build","ResolvedBuildOptions.sourcemap","ResolvedConfig.logger","Plugin","ResolvedBuildOptions.ssr","Logger.warn","ResolvedConfig.mode","ResolvedConfig.environments","ResolvedBuildEnvironmentOptions.sourcemap","ConfigEnv.command","ResolvedEnvironmentOptions.build"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","ResolvedConfig.build","ResolvedBuildOptions.emptyOutDir","UserConfig.build","defaultServerConditions","UserConfig.environments","Plugin","ResolvedBuildOptions.manifest","resolveConfig","ViteDevServer","ModuleNode","UserConfig.server","ConfigEnv.mode","ResolvedConfig.mode","ResolvedConfig.command","ManifestChunk.assets","normalizePath","UserConfig.base","createLogger","DevEnvironment.moduleGraph","ViteDevServer.config","ViteDevServer.pluginContainer","ViteBuilder.build","isRunnableDevEnvironment","ResolvedConfig.root","Connect.Server.use","ModuleNode.file","ViteDevServer.hot","DevEnvironment.reloadModule","ViteBuilder.environments","loadConfigFromFile","HotUpdatePluginContext.environment","ViteDevServer.environments","EnvironmentOptions","Connect.IncomingMessage.url","DevEnvironment.name","ViteDevServer.transformRequest","ResolvedConfig.configFile","PreviewServer.middlewares","createServer","ManifestChunk.css","ModuleNode.url","EnvironmentOptions.optimizeDeps","Plugin.name","ResolvedBuildOptions.assetsDir","RunnableDevEnvironment.runner","defaultClientConditions","ManifestChunk.file","HotBroadcaster.send","EnvironmentOptions.resolve","Logger.warn","UserConfig.plugins","Logger.info","ResolvedConfig.logger","Environment.config","ResolvedServerOptions.middlewareMode","ConfigEnv.command","ViteDevServer.middlewares","ViteDevServer.ssrFixStacktrace","UserConfig.root","Environment.name","ResolvedServerOptions.watch","ConfigEnv.isSsrBuild","ViteDevServer.ssrLoadModule","PreviewServer","PluginContainer.buildStart","Logger.error","UserConfig.logLevel","ResolvedConfig.server","ResolvedConfig.base","transformWithEsbuild","ResolvedConfig.environments","ResolvedEnvironmentOptions.build","PluginOption","ResolvedBuildEnvironmentOptions.outDir"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.isAbsolute","path.PlatformPath.relative","path.PlatformPath.join","path.PlatformPath.dirname","path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","cp","mkdir","rename","readFile"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.exit","global.NodeJS.Process.cwd","global.NodeJS.Process.env"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["relative","path.extname","path.join","resolve","dist","path.normalize","join"] |
| plugin | fs | 5 | 10 | 18 | 135 | 26 | 750 | ["Dirent.isFile","Dirent.name","Dirent.parentPath","Dirent.path","existsSync"] |
...
| plugin | rollup | 3 | 5 | 18 | 135 | 26 | 750 | ["PluginContext.resolve","PluginContext.environment","ResolvedId.id"] |
...
| prompts-prompt-base | @types/process | 4 | 20 | 2 | 14 | 6 | 700 | ["global.NodeJS.Process.stdin","global.NodeJS.Process.stdout","global.NodeJS.ReadStream","global.NodeJS.WriteStream"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ViteDevServer.pluginContainer","ViteDevServer.config","Logger","ResolvedConfig.root","ResolvedConfig.base","createServer","PluginContainer.buildStart","ViteDevServer"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["path.dirname","path.basename","dist","path.resolve"] |
...
| resolve-file-url | @types/path | 4 | 6 | 1 | 5 | 2 | 500 | ["path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.isAbsolute"] |
| resolve-file-url | node | 1 | 3 | 1 | 5 | 2 | 500 | ["normalizePath"] |
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".readFile",".mkdir",".writeFile",".unlink"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["cursor.save","erase","cursor.move","erase.line","cursor.restore","cursor.down","cursor.to"] |
| prompts-text | readline | 1 | 5 | 2 | 8 | 2 | 400 | ["Key"] |
| workersKVStorage | @cloudflare/workers-types | 4 | 6 | 1 | 4 | 1 | 400 | ["KVNamespace.put","KVNamespace.delete","Crypto.getRandomValues","KVNamespace.get"] |
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["EventContext.passThroughOnException","Request.cf","EventContext.waitUntil","EventContext.request","Request","CacheStorage","IncomingRequestCfProperties","CfProperties","EventContext","KVNamespace.put","KVNamespace.delete","Crypto.getRandomValues","KVNamespace.get","Response","Console.error","Response.status","Response.body","Headers.delete","EventContext.env","Request.headers","Request.clone","Request.url"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Console.error","Response.status","Response.body","Headers.delete","EventContext.env","Response","Request.headers","Request.clone","EventContext","EventContext.request","Request.url","Request","CacheStorage","IncomingRequestCfProperties","CfProperties","EventContext.passThroughOnException","Request.cf","EventContext.waitUntil"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["Identifier.name","VariableDeclarator.id","VariableDeclarator.init","StringLiteral.value","VariableDeclaration.declarations","LVal.type"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ViteDevServer.bindCLIShortcuts","ViteDevServer.printUrls","createServer","ResolvedConfig.plugins","ResolvedConfig.logger","ViteDevServer.listen","Plugin.name","Logger.info","ViteDevServer.config"] |
...
| prompts-multi-select | sisteransi | 4 | 20 | 2 | 5 | 2 | 250 | ["cursor.hide","erase.line","erase","cursor.to"] |
...
| react-router-node | @types/stream | 7 | 8 | 7 | 16 | 8 | 228.57142857142858 | ["Stream.Readable","Stream.Writable.write","Stream.Writable","Stream.Writable.end"] |
...
| react-router-node | promises | 4 | 7 | 7 | 16 | 8 | 228.57142857142858 | [".readFile",".mkdir",".writeFile",".unlink"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["path.normalize","dist","path.relative","ModuleCacheMap.clear","ViteNodeRunner.moduleCache","path.join","path.resolve","path.dirname","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.on","FSWatcher.add","FSWatcher.unwatch","esm","_default.watch"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["ModuleGraph.invalidateAll","ViteDevServer.moduleGraph","createLogger","ViteDevServer.close","ModuleGraph.getModuleById"] |
...
| prerender | @types/path | 3 | 3 | 6 | 12 | 6 | 200 | ["path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.dirname"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["cursor.hide","cursor.to","erase","erase.line"] |
...
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["erase.line","cursor.hide","erase","cursor.to"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","array","BaseIssue","BaseSchema","ArraySchema","relative","isAbsolute","pipe","SchemaWithPipe","optional","string","lazy","BooleanSchema","ObjectSchema","NotValueAction","OptionalSchema","LazySchema","custom","object","StringSchema","CustomIssue","notValue","boolean","CustomSchema","flatten","safeParse"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| stream | @types/stream | 7 | 8 | 4 | 6 | 3 | 150 | ["Stream.Readable","Stream.Writable.write","Stream.Writable","Stream.Writable.end"] |
| stream | @types/buffer | 2 | 2 | 4 | 6 | 3 | 150 | ["global.Buffer.toString","global.BufferConstructor.concat"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["Identifier.name","isExportDeclaration","isNodesEquivalent","isVariableDeclaration","VariableDeclaration.declarations","isClassDeclaration","isImportDeclaration","isExportNamedDeclaration","isExportDefaultDeclaration","Program.body","isExportAllDeclaration","isFunctionDeclaration","File.program","ExportNamedDeclaration.specifiers","ExportNamedDeclaration.declaration","ImportDeclaration.specifiers","File"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.NextFunction","e.Request","e.Response","e.Response.flushHeaders","e.Response.append","e.Response.status","e.Response.statusMessage","e.Response.end","e.Response.on","e.Request.method","e.Request.app","e.Request.get","e.Request.headers","e.Request.hostname","e.Request.originalUrl","e.Request.protocol"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.cookies","APIGatewayEventRequestContextV2.http","APIGatewayEventRequestContextV2","APIGatewayProxyEventV2","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2.rawPath","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.join","path.PlatformPath.dirname","path.PlatformPath.extname","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.sep","path.PlatformPath.win32"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["cursor","erase","erase.lines","erase.line","cursor.to"] |
