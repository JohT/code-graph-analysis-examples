...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 140 | 648 | ["<reactRouterRSCVitePlugin> of module <vite> imports <UserConfig.logLevel> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedBuildEnvironmentOptions.outDir> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Logger.error> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Connect.IncomingMessage.url> from external module <node>"] |
| @types/process | 19 | 21 | 48 | 97 | 140 | 648 | ["<getBuildTimeHeader> of module <dev> imports <global.NodeJS.ProcessEnv.hasOwnProperty> from external module <process>","<getBuildTimeHeader> of module <dev> imports <global.NodeJS.Process.env> from external module <process>","<getBuildTimeHeader> of module <dev> imports <global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST> from external module <process>","<Context> of module <create-react-router> imports <global.NodeJS.WriteStream> from external module <process>"] |
...
| @types/path | 14 | 20 | 55 | 122 | 140 | 648 | ["<normalizeSlashes> of module <normalizeSlashes> imports <path.PlatformPath.win32> from external module <path>","<normalizeSlashes> of module <normalizeSlashes> imports <path.PlatformPath.sep> from external module <path>","<flatRoutesUniversal> of module <flatRoutes> imports <path.PlatformPath.join> from external module <path>","<flatRoutesUniversal> of module <flatRoutes> imports <path.PlatformPath.extname> from external module <path>"] |
| node:fs | 10 | 12 | 26 | 49 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <.existsSync> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <node:fs> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <.readdirSync> from external module <node:fs>","<flatRoutes> of module <react-router-fs-routes> imports <node:fs> from external module <node:fs>"] |
...
| http | 7 | 6 | 16 | 22 | 140 | 648 | ["<createRemixHeaders> of module <server> imports <IncomingHttpHeaders> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.setHeader> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.statusCode> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.end> from external module <http>"] |
...
| @types/buffer | 6 | 4 | 12 | 13 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <global.NonSharedBuffer.toString> from external module <buffer>","<reactRouterVitePlugin> of module <plugin> imports <global.NonSharedBuffer.toString> from external module <buffer>","<createReactRouterRequest> of module <server> imports <global.Buffer.toString> from external module <buffer>","<createReactRouterRequest> of module <server> imports <global.BufferConstructor.from> from external module <buffer>"] |
| fs | 6 | 6 | 17 | 27 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
| readline | 6 | 6 | 10 | 56 | 140 | 648 | ["<ConfirmPrompt> of module <prompts-confirm> imports <Key> from external module <readline>","<MultiSelectPrompt> of module <prompts-multi-select> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Interface.close> from external module <readline>"] |
| sisteransi | 6 | 6 | 27 | 116 | 140 | 648 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 140 | 648 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <AssignmentExpression.left> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportNamedDeclaration.declaration> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 140 | 648 | ["<createRequestHandler> of module <worker> imports <EventContext.request> from external module <workers-types>","<createRequestHandler> of module <worker> imports <Request.cf> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.waitUntil> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.passThroughOnException> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.code> from external module <babel__core>"] |
...
| @types/api-gateway-proxy | 2 | 5 | 24 | 34 | 140 | 648 | ["<RequestHandler> of module <server> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyResultV2> from external module <api-gateway-proxy>","<RequestHandler> of module <react-router-architect> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>"] |
...
| esm | 2 | 2 | 6 | 7 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.on> from external module <esm>","<createConfigLoader> of module <config> imports <_default.watch> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.environment> from external module <rollup>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["AssignmentExpression.left","ExportNamedDeclaration.declaration","FunctionDeclaration.id","LVal.type","ExpressionStatement.expression","ExportSpecifier.local","MemberExpression.object","ExportSpecifier.exported","ExportDefaultDeclaration.declaration","Expression.type","Identifier.name","ClassDeclaration.id","VariableDeclaration.declarations","ExportNamedDeclaration.specifiers","ExportDeclaration.type","VariableDeclarator.id"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["UserConfig.logLevel","ResolvedBuildEnvironmentOptions.outDir","Logger.error","Connect.IncomingMessage.url","normalizePath","ResolvedEnvironmentOptions.build","PreviewServer.middlewares","Connect.Server.use","createLogger","ResolvedConfig.base","transformWithEsbuild","UserConfig.base","PluginOption","Logger.info","UserConfig.server","ResolvedConfig.environments","EnvironmentOptions.optimizeDeps","ResolvedBuildOptions.assetsDir","DevEnvironment.name","ResolvedConfig.configFile","EnvironmentOptions","ManifestChunk.css","Plugin","ResolvedConfig","ViteDevServer.ssrFixStacktrace","ViteDevServer.ssrLoadModule","ViteDevServer.transformRequest","ConfigEnv.command","EnvironmentOptions.resolve","ViteDevServer.config","RunnableDevEnvironment.runner","ManifestChunk.assets","Environment.config","ViteDevServer.hot","ResolvedConfig.logger","ViteDevServer","ViteDevServer.middlewares","Logger.warn","ModuleNode.url","ResolvedConfig.root","UserConfig.build","ViteDevServer.environments","Plugin.name","DevEnvironment.reloadModule","ResolvedConfig.build","isRunnableDevEnvironment","HotUpdatePluginContext.environment","ViteBuilder.environments","ViteBuilder.build","HotBroadcaster.send","ResolvedConfig.server","createServer","ConfigEnv.isSsrBuild","ConfigEnv.mode","Environment.name","loadConfigFromFile","defaultClientConditions","ManifestChunk.file","PreviewServer","ResolvedConfig.command","UserConfig.root","ResolvedServerOptions.middlewareMode","ResolvedServerOptions.watch","UserConfig.plugins","PluginContainer.buildStart","DevEnvironment.moduleGraph","ModuleNode.file","UserConfig.environments","ViteDevServer.pluginContainer","ResolvedConfig.mode","version","node","ESBuildOptions"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.Process.env","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.exit","global.NodeJS.Process.cwd","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["dist","path.extname","path.normalize","join","path.join","relative","resolve"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","cp","mkdir","readdir","rm","rename"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.posix","path.PlatformPath.resolve","path.PlatformPath.relative","path.PlatformPath.basename","path.PlatformPath.dirname","path.PlatformPath.join"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.name","Dirent.parentPath","Dirent.path","Dirent.isFile"] |
| vite | http | 5 | 8 | 6 | 129 | 25 | 2150 | ["ServerResponse.setHeader","ServerResponse.statusCode","ServerResponse.end"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.isExportDefaultDeclaration","NodePath.isVariableDeclaration","NodePath.isExportNamedDeclaration","NodePath.isFunctionDeclaration","NodePath.isIdentifier","NodePath.node","NodePath.isExpression","NodePath.scope","NodePath.replaceWith","NodePath.get","Scope.generateUidIdentifier"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["importSpecifier","callExpression","variableDeclaration","identifier","variableDeclarator","importDeclaration","Program.body","stringLiteral"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult.program","ParseResult"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.middlewares","ConfigEnv.mode","ResolvedServerOptions.middlewareMode","EnvironmentResolveOptions.externalConditions","ViteDevServer.ssrLoadModule","ResolvedConfig.server","Plugin.name","EnvironmentOptions.resolve","ViteDevServer.config","Plugin","UserConfig.root","ResolvedConfig.plugins","Connect.Server.use"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.middlewares","ConfigEnv.mode","ResolvedServerOptions.middlewareMode","EnvironmentResolveOptions.externalConditions","ViteDevServer.ssrLoadModule","ResolvedConfig.server","Plugin.name","EnvironmentOptions.resolve","ViteDevServer.config","Plugin","UserConfig.root","ResolvedConfig.plugins","Connect.Server.use"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedBuildEnvironmentOptions.sourcemap","ResolvedConfig.logger","ResolvedConfig.environments","Logger.warn","ResolvedConfig.mode","ResolvedConfig.build","ResolvedBuildOptions.ssr","Plugin","ConfigEnv.command","ResolvedBuildOptions.sourcemap","ResolvedEnvironmentOptions.build"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","ResolvedConfig.build","ResolvedBuildOptions.emptyOutDir","defaultServerConditions","UserConfig.environments","UserConfig.build","Plugin","ResolvedBuildOptions.manifest","resolveConfig","ViteDevServer","ModuleNode","EnvironmentOptions.optimizeDeps","ResolvedBuildOptions.assetsDir","DevEnvironment.name","ResolvedConfig.configFile","EnvironmentOptions","Connect.IncomingMessage.url","ManifestChunk.css","ViteDevServer.ssrFixStacktrace","ViteDevServer.ssrLoadModule","ViteDevServer.transformRequest","ConfigEnv.command","EnvironmentOptions.resolve","ViteDevServer.config","Connect.Server.use","RunnableDevEnvironment.runner","ManifestChunk.assets","Environment.config","createLogger","ViteDevServer.hot","ResolvedConfig.logger","UserConfig.server","ViteDevServer.middlewares","Logger.warn","ModuleNode.url","ResolvedConfig.root","ViteDevServer.environments","Plugin.name","DevEnvironment.reloadModule","isRunnableDevEnvironment","HotUpdatePluginContext.environment","ViteBuilder.environments","ViteBuilder.build","HotBroadcaster.send","ResolvedConfig.server","createServer","ConfigEnv.isSsrBuild","ConfigEnv.mode","Environment.name","normalizePath","loadConfigFromFile","defaultClientConditions","Logger.info","UserConfig.base","UserConfig.logLevel","ManifestChunk.file","PreviewServer","ResolvedConfig.command","UserConfig.root","ResolvedServerOptions.middlewareMode","ResolvedServerOptions.watch","UserConfig.plugins","PluginContainer.buildStart","DevEnvironment.moduleGraph","Logger.error","ModuleNode.file","PreviewServer.middlewares","ViteDevServer.pluginContainer","ResolvedConfig.mode","ResolvedBuildEnvironmentOptions.outDir","ResolvedEnvironmentOptions.build","ResolvedConfig.base","transformWithEsbuild","PluginOption","ResolvedConfig.environments"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.isAbsolute","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.resolve","path.PlatformPath.dirname","path.PlatformPath.join","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","cp","mkdir","readFile","rename"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.Process.exit","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.cwd","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.env"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["dist","path.extname","path.normalize","join","path.join","relative","resolve"] |
| plugin | fs | 5 | 10 | 18 | 135 | 26 | 750 | ["Dirent.name","Dirent.parentPath","Dirent.path","Dirent.isFile","existsSync"] |
...
| prompts-prompt-base | @types/process | 4 | 20 | 2 | 14 | 6 | 700 | ["global.NodeJS.Process.stdin","global.NodeJS.Process.stdout","global.NodeJS.WriteStream","global.NodeJS.ReadStream"] |
| prompts-prompt-base | node:readline | 3 | 20 | 2 | 14 | 6 | 700 | [".emitKeypressEvents",".createInterface","node:readline"] |
| prompts-prompt-base | sisteransi | 3 | 15 | 2 | 14 | 6 | 700 | ["cursor.show","cursor","beep"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ResolvedConfig.root","Logger","PluginContainer.buildStart","ViteDevServer.pluginContainer","ResolvedConfig.base","createServer","ViteDevServer.config","ViteDevServer"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["dist","path.basename","path.resolve","path.dirname"] |
...
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".writeFile",".mkdir",".unlink",".readFile"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["erase","erase.line","cursor.restore","cursor.save","cursor.move","cursor.down","cursor.to"] |
| prompts-text | readline | 1 | 5 | 2 | 8 | 2 | 400 | ["Key"] |
| workersKVStorage | @cloudflare/workers-types | 4 | 6 | 1 | 4 | 1 | 400 | ["Crypto.getRandomValues","KVNamespace.delete","KVNamespace.get","KVNamespace.put"] |
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["EventContext.request","Request.cf","EventContext.waitUntil","EventContext.passThroughOnException","CfProperties","EventContext","IncomingRequestCfProperties","CacheStorage","Request","Crypto.getRandomValues","KVNamespace.delete","KVNamespace.get","KVNamespace.put","Response","Console.error","Request.url","Response.status","Request.clone","EventContext.env","Headers.delete","Request.headers","Response.body"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Response","Console.error","Request.url","Response.status","Request.clone","EventContext","EventContext.env","Headers.delete","Request.headers","EventContext.request","Response.body","CfProperties","IncomingRequestCfProperties","CacheStorage","Request","Request.cf","EventContext.waitUntil","EventContext.passThroughOnException"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["VariableDeclarator.init","VariableDeclaration.declarations","Identifier.name","VariableDeclarator.id","LVal.type","StringLiteral.value"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ViteDevServer.config","ViteDevServer.bindCLIShortcuts","Plugin.name","ResolvedConfig.logger","Logger.info","ViteDevServer.printUrls","ViteDevServer.listen","ResolvedConfig.plugins","createServer"] |
...
| prompts-multi-select | sisteransi | 4 | 20 | 2 | 5 | 2 | 250 | ["cursor.to","erase","cursor.hide","erase.line"] |
...
| commands | @types/path | 3 | 9 | 5 | 12 | 9 | 240 | ["path.PlatformPath.relative","path.PlatformPath.resolve","path.PlatformPath.dirname"] |
...
| react-router-node | promises | 4 | 7 | 7 | 16 | 8 | 228.57142857142858 | [".writeFile",".mkdir",".unlink",".readFile"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["ModuleCacheMap.clear","path.relative","path.normalize","ViteNodeRunner.moduleCache","dist","path.join","path.resolve","path.dirname","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.on","_default.watch","esm","FSWatcher.add","FSWatcher.unwatch"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["ViteDevServer.close","ViteDevServer.moduleGraph","ModuleGraph.getModuleById","createLogger","ModuleGraph.invalidateAll"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["cursor.hide","erase","erase.line","cursor.to"] |
...
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.hide","erase.line","erase","cursor.to"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BaseSchema","array","ArraySchema","BaseIssue","isAbsolute","relative","pipe","OptionalSchema","ObjectSchema","CustomSchema","notValue","NotValueAction","optional","boolean","SchemaWithPipe","LazySchema","string","StringSchema","lazy","BooleanSchema","object","custom","CustomIssue","flatten","safeParse"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| stream | @types/stream | 7 | 8 | 4 | 6 | 3 | 150 | ["Stream.Readable","Stream.Writable.end","Stream.Writable","Stream.Writable.write"] |
| stream | @types/buffer | 2 | 2 | 4 | 6 | 3 | 150 | ["global.BufferConstructor.concat","global.Buffer.toString"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["isExportDefaultDeclaration","ExportNamedDeclaration.declaration","isVariableDeclaration","isExportAllDeclaration","isExportDeclaration","ImportDeclaration.specifiers","isNodesEquivalent","Identifier.name","isClassDeclaration","isImportDeclaration","isExportNamedDeclaration","isFunctionDeclaration","ExportNamedDeclaration.specifiers","VariableDeclaration.declarations","Program.body","File.program","File"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Response","e.NextFunction","e.Request","e.Response.flushHeaders","e.Response.statusMessage","e.Response.end","e.Response.append","e.Response.status","e.Request.hostname","e.Response.on","e.Request.headers","e.Request.app","e.Request.originalUrl","e.Request.get","e.Request.protocol","e.Request.method"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventHeaders.host","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.headers","APIGatewayEventRequestContextV2","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.body","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.join","path.PlatformPath.extname","path.PlatformPath.dirname","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.sep","path.PlatformPath.win32"] |
...
| context | @types/react | 27 | 65 | 21 | 9 | 1 | 42.857142857142854 | ["React.createContext","React.Context","React.ReactNode","React.ReactElement","React.useContext","React.Context.Provider","React.createElement","React.ProviderProps","React.FunctionComponentElement"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["erase.line","erase.lines","erase","cursor","cursor.to"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key","Key.meta","Key.name","Key.ctrl"] |
