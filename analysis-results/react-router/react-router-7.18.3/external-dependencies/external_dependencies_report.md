...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 140 | 648 | ["<reactRouterRSCVitePlugin> of module <vite> imports <Connect.IncomingMessage.url> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <UserConfig.logLevel> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedConfig.base> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <UserConfig.base> from external module <node>"] |
...
| sisteransi | 6 | 6 | 27 | 116 | 140 | 648 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 140 | 648 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <AssignmentExpression.left> from external module <lib>","<removeExports> of module <remove-exports> imports <ClassDeclaration.id> from external module <lib>"] |
...
| @types/babel__core | 3 | 2 | 8 | 9 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <transformAsync> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 140 | 648 | ["<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>"] |
...
| @types/api-gateway-proxy | 2 | 5 | 24 | 34 | 140 | 648 | ["<RequestHandler> of module <server> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyResultV2> from external module <api-gateway-proxy>","<RequestHandler> of module <react-router-architect> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>"] |
| @types/express | 2 | 4 | 26 | 30 | 140 | 648 | ["<RequestHandler> of module <react-router-express> imports <e.Request> from external module <express>","<RequestHandler> of module <react-router-express> imports <e.NextFunction> from external module <express>","<RequestHandler> of module <react-router-express> imports <e.Response> from external module <express>","<RequestHandler> of module <server> imports <e.Request> from external module <express>"] |
...
| @types/stream | 2 | 3 | 14 | 16 | 140 | 648 | ["<createReadableStreamFromReadable> of module <react-router-node> imports <Stream.Readable> from external module <stream>","<createReadableStreamFromReadable> of module <stream> imports <Stream.Readable> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>"] |
...
| crypto | 2 | 1 | 4 | 4 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <Hash.update> from external module <crypto>","<reactRouterVitePlugin> of module <vite> imports <Hash.digest> from external module <crypto>","<reactRouterVitePlugin> of module <plugin> imports <Hash.update> from external module <crypto>","<reactRouterVitePlugin> of module <plugin> imports <Hash.digest> from external module <crypto>"] |
| esm | 2 | 2 | 6 | 7 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>","<createConfigLoader> of module <config> imports <_default.watch> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.unwatch> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.resolve> from external module <rollup>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["AssignmentExpression.left","ClassDeclaration.id","LVal.type","ExportNamedDeclaration.declaration","ExportSpecifier.local","VariableDeclarator.id","ExportNamedDeclaration.specifiers","VariableDeclaration.declarations","ExpressionStatement.expression","MemberExpression.object","ExportDeclaration.type","FunctionDeclaration.id","Expression.type","ExportDefaultDeclaration.declaration","ExportSpecifier.exported","Identifier.name"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["Connect.IncomingMessage.url","UserConfig.logLevel","ResolvedConfig.base","UserConfig.base","createLogger","Logger.info","UserConfig.server","PluginOption","ResolvedEnvironmentOptions.build","PreviewServer.middlewares","ResolvedConfig.environments","transformWithEsbuild","Connect.Server.use","ResolvedBuildEnvironmentOptions.outDir","normalizePath","Logger.error","ViteDevServer.ssrFixStacktrace","ViteDevServer","ModuleNode.url","ResolvedServerOptions.watch","DevEnvironment.name","EnvironmentOptions","UserConfig.build","ViteDevServer.pluginContainer","ResolvedConfig.logger","ManifestChunk.css","ModuleNode.file","ConfigEnv.isSsrBuild","HotBroadcaster.send","UserConfig.environments","DevEnvironment.moduleGraph","Environment.name","ResolvedServerOptions.middlewareMode","ViteDevServer.middlewares","ViteDevServer.transformRequest","ResolvedConfig.root","HotUpdatePluginContext.environment","ManifestChunk.file","ViteDevServer.ssrLoadModule","DevEnvironment.reloadModule","ResolvedConfig.mode","isRunnableDevEnvironment","ResolvedBuildOptions.assetsDir","ResolvedConfig.server","ViteDevServer.config","ConfigEnv.mode","ManifestChunk.assets","loadConfigFromFile","ConfigEnv.command","PluginContainer.buildStart","ViteBuilder.build","ViteDevServer.hot","Plugin","ViteBuilder.environments","ViteDevServer.environments","UserConfig.root","EnvironmentOptions.resolve","PreviewServer","defaultClientConditions","Logger.warn","UserConfig.plugins","EnvironmentOptions.optimizeDeps","ResolvedConfig.configFile","createServer","RunnableDevEnvironment.runner","ResolvedConfig.build","Environment.config","ResolvedConfig","ResolvedConfig.command","Plugin.name","version","ESBuildOptions","node"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.Process.env","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.exit","global.NodeJS.Process.cwd"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["path.join","resolve","path.normalize","relative","dist","join","path.extname"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","rename","rm","cp","mkdir","readdir"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.relative","path.PlatformPath.dirname","path.PlatformPath.join","path.PlatformPath.basename","path.PlatformPath.resolve","path.PlatformPath.posix"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.path","Dirent.parentPath","Dirent.name","Dirent.isFile"] |
...
| vite | rollup | 3 | 5 | 6 | 129 | 25 | 2150 | ["PluginContext.resolve","ResolvedId.id","PluginContext.environment"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.node","NodePath.scope","NodePath.get","NodePath.isExportNamedDeclaration","NodePath.isExpression","NodePath.replaceWith","NodePath.isIdentifier","NodePath.isVariableDeclaration","NodePath.isExportDefaultDeclaration","NodePath.isFunctionDeclaration","Scope.generateUidIdentifier"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["callExpression","Program.body","identifier","importDeclaration","variableDeclaration","stringLiteral","variableDeclarator","importSpecifier"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult","ParseResult.program"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["Connect.Server.use","EnvironmentResolveOptions.externalConditions","ConfigEnv.mode","Plugin","ViteDevServer.middlewares","ResolvedConfig.server","UserConfig.root","ResolvedConfig.plugins","EnvironmentOptions.resolve","ViteDevServer.ssrLoadModule","ViteDevServer.config","ResolvedServerOptions.middlewareMode","Plugin.name"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["Connect.Server.use","EnvironmentResolveOptions.externalConditions","ConfigEnv.mode","Plugin","ViteDevServer.middlewares","ResolvedConfig.server","UserConfig.root","ResolvedConfig.plugins","EnvironmentOptions.resolve","ViteDevServer.ssrLoadModule","ViteDevServer.config","ResolvedServerOptions.middlewareMode","Plugin.name"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.logger","ResolvedConfig.build","ResolvedConfig.environments","ResolvedConfig.mode","ConfigEnv.command","ResolvedBuildOptions.sourcemap","Logger.warn","ResolvedBuildOptions.ssr","ResolvedBuildEnvironmentOptions.sourcemap","ResolvedEnvironmentOptions.build","Plugin"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","ResolvedConfig.build","ResolvedBuildOptions.emptyOutDir","UserConfig.environments","defaultServerConditions","UserConfig.build","resolveConfig","ResolvedBuildOptions.manifest","Plugin","ViteDevServer","ModuleNode","ViteDevServer.ssrFixStacktrace","ModuleNode.url","ResolvedServerOptions.watch","DevEnvironment.name","EnvironmentOptions","ViteDevServer.pluginContainer","ResolvedConfig.logger","ManifestChunk.css","Logger.info","ModuleNode.file","ConfigEnv.isSsrBuild","HotBroadcaster.send","DevEnvironment.moduleGraph","Environment.name","ResolvedServerOptions.middlewareMode","ViteDevServer.middlewares","UserConfig.base","ViteDevServer.transformRequest","normalizePath","UserConfig.server","ResolvedConfig.root","HotUpdatePluginContext.environment","ManifestChunk.file","ViteDevServer.ssrLoadModule","DevEnvironment.reloadModule","ResolvedConfig.mode","isRunnableDevEnvironment","ResolvedBuildOptions.assetsDir","UserConfig.logLevel","ResolvedConfig.server","Logger.error","ViteDevServer.config","Connect.Server.use","ConfigEnv.mode","ManifestChunk.assets","loadConfigFromFile","ConfigEnv.command","PluginContainer.buildStart","ViteBuilder.build","ViteDevServer.hot","ViteBuilder.environments","PreviewServer.middlewares","ViteDevServer.environments","UserConfig.root","EnvironmentOptions.resolve","PreviewServer","defaultClientConditions","Logger.warn","UserConfig.plugins","Connect.IncomingMessage.url","EnvironmentOptions.optimizeDeps","ResolvedConfig.configFile","createServer","RunnableDevEnvironment.runner","createLogger","Environment.config","ResolvedConfig.command","Plugin.name","ResolvedConfig.base","PluginOption","ResolvedEnvironmentOptions.build","ResolvedConfig.environments","transformWithEsbuild","ResolvedBuildEnvironmentOptions.outDir"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.relative","path.PlatformPath.isAbsolute","path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.join","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","rename","cp","mkdir","readFile"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.exit","global.NodeJS.Process.cwd"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["path.join","resolve","path.normalize","relative","dist","join","path.extname"] |
| plugin | fs | 5 | 10 | 18 | 135 | 26 | 750 | ["Dirent.path","Dirent.parentPath","Dirent.name","Dirent.isFile","existsSync"] |
...
| plugin | rollup | 3 | 5 | 18 | 135 | 26 | 750 | ["PluginContext.resolve","ResolvedId.id","PluginContext.environment"] |
...
| prompts-prompt-base | sisteransi | 3 | 15 | 2 | 14 | 6 | 700 | ["cursor","cursor.show","beep"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["PluginContainer.buildStart","ResolvedConfig.root","ViteDevServer.config","createServer","ResolvedConfig.base","ViteDevServer.pluginContainer","Logger","ViteDevServer"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["dist","path.resolve","path.dirname","path.basename"] |
...
| resolve-file-url | @types/path | 4 | 6 | 1 | 5 | 2 | 500 | ["path.PlatformPath.isAbsolute","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.join"] |
| resolve-file-url | node | 1 | 3 | 1 | 5 | 2 | 500 | ["normalizePath"] |
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".readFile",".writeFile",".mkdir",".unlink"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["cursor.restore","erase.line","erase","cursor.down","cursor.move","cursor.to","cursor.save"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["Request.cf","EventContext.request","EventContext.passThroughOnException","EventContext.waitUntil","Request","IncomingRequestCfProperties","EventContext","CacheStorage","CfProperties","KVNamespace.delete","Crypto.getRandomValues","KVNamespace.get","KVNamespace.put","Response","Response.status","Request.url","Headers.delete","EventContext.env","Response.body","Request.headers","Request.clone","Console.error"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Response.status","EventContext","Request.url","Headers.delete","EventContext.env","Response.body","Request.headers","Request.clone","EventContext.request","Console.error","Response","Request","IncomingRequestCfProperties","CacheStorage","CfProperties","Request.cf","EventContext.passThroughOnException","EventContext.waitUntil"] |
| has-rsc-plugin | node | 3 | 3 | 1 | 3 | 2 | 300 | ["resolveConfig","Plugin.name","ResolvedConfig.plugins"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["VariableDeclaration.declarations","Identifier.name","LVal.type","VariableDeclarator.id","StringLiteral.value","VariableDeclarator.init"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ViteDevServer.printUrls","ViteDevServer.bindCLIShortcuts","ViteDevServer.listen","ResolvedConfig.plugins","createServer","Plugin.name","ResolvedConfig.logger","ViteDevServer.config","Logger.info"] |
...
| node-adapter | node | 4 | 6 | 2 | 5 | 2 | 250 | ["Connect.IncomingMessage.originalUrl","Connect.IncomingMessage","Connect.IncomingMessage.url"] |
| node-adapter | http | 3 | 3 | 2 | 5 | 2 | 250 | ["ServerResponse","IncomingMessage"] |
| prompts-multi-select | sisteransi | 4 | 20 | 2 | 5 | 2 | 250 | ["cursor.hide","cursor.to","erase","erase.line"] |
...
| commands | @types/path | 3 | 9 | 5 | 12 | 9 | 240 | ["path.PlatformPath.resolve","path.PlatformPath.relative","path.PlatformPath.dirname"] |
...
| react-router-node | @types/stream | 7 | 8 | 7 | 16 | 8 | 228.57142857142858 | ["Stream.Readable","Stream.Writable.end","Stream.Writable.write","Stream.Writable"] |
...
| react-router-node | promises | 4 | 7 | 7 | 16 | 8 | 228.57142857142858 | [".readFile",".writeFile",".mkdir",".unlink"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["dist","path.relative","path.normalize","ModuleCacheMap.clear","ViteNodeRunner.moduleCache","path.resolve","path.dirname","path.join","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["esm","_default.watch","FSWatcher.unwatch","FSWatcher.add","FSWatcher.on"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["createLogger","ViteDevServer.moduleGraph","ModuleGraph.invalidateAll","ViteDevServer.close","ModuleGraph.getModuleById"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["erase.line","erase","cursor.to","cursor.hide"] |
...
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.to","erase","cursor.hide","erase.line"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BaseIssue","array","BaseSchema","ArraySchema","relative","isAbsolute","SchemaWithPipe","boolean","notValue","CustomIssue","CustomSchema","string","optional","pipe","BooleanSchema","ObjectSchema","OptionalSchema","lazy","StringSchema","custom","NotValueAction","object","LazySchema","flatten","safeParse"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| stream | @types/stream | 7 | 8 | 4 | 6 | 3 | 150 | ["Stream.Readable","Stream.Writable.end","Stream.Writable.write","Stream.Writable"] |
| stream | @types/buffer | 2 | 2 | 4 | 6 | 3 | 150 | ["global.Buffer.toString","global.BufferConstructor.concat"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["Program.body","ExportNamedDeclaration.specifiers","isExportDefaultDeclaration","isVariableDeclaration","isExportAllDeclaration","ImportDeclaration.specifiers","isImportDeclaration","isClassDeclaration","ExportNamedDeclaration.declaration","isNodesEquivalent","isFunctionDeclaration","isExportDeclaration","File.program","VariableDeclaration.declarations","isExportNamedDeclaration","Identifier.name","File"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Request","e.NextFunction","e.Response","e.Response.statusMessage","e.Response.flushHeaders","e.Response.append","e.Response.end","e.Response.status","e.Request.app","e.Response.on","e.Request.get","e.Request.method","e.Request.protocol","e.Request.headers","e.Request.hostname","e.Request.originalUrl"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.cookies","APIGatewayEventRequestContextV2","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2","APIGatewayProxyEventHeaders.host","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.rawPath","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.join","path.PlatformPath.extname","path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.win32","path.PlatformPath.sep"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["cursor.to","erase.lines","erase.line","erase","cursor"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key.name","Key","Key.ctrl","Key.meta"] |
