...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 140 | 648 | ["<reactRouterRSCVitePlugin> of module <vite> imports <PreviewServer.middlewares> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <createLogger> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Connect.Server.use> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Logger.error> from external module <node>"] |
...
| node:fs | 10 | 12 | 26 | 49 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <.readdirSync> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <.existsSync> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <node:fs> from external module <node:fs>","<flatRoutes> of module <react-router-fs-routes> imports <node:fs> from external module <node:fs>"] |
...
| http | 7 | 6 | 16 | 22 | 140 | 648 | ["<createRemixHeaders> of module <server> imports <IncomingHttpHeaders> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.end> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.statusCode> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.setHeader> from external module <http>"] |
...
| fs | 6 | 6 | 17 | 27 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 140 | 648 | ["<createRequestHandler> of module <worker> imports <EventContext.request> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.waitUntil> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.passThroughOnException> from external module <workers-types>","<createRequestHandler> of module <worker> imports <Request.cf> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <transformAsync> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 140 | 648 | ["<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>"] |
...
| esm | 2 | 2 | 6 | 7 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.add> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.unwatch> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.environment> from external module <rollup>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["AssignmentExpression.left","ExportNamedDeclaration.declaration","VariableDeclarator.id","ExportDefaultDeclaration.declaration","Identifier.name","ExportSpecifier.local","ExportSpecifier.exported","Expression.type","VariableDeclaration.declarations","ClassDeclaration.id","MemberExpression.object","ExpressionStatement.expression","FunctionDeclaration.id","ExportDeclaration.type","LVal.type","ExportNamedDeclaration.specifiers"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["PreviewServer.middlewares","createLogger","Connect.Server.use","Logger.error","Connect.IncomingMessage.url","transformWithEsbuild","PluginOption","ResolvedEnvironmentOptions.build","ResolvedConfig.base","UserConfig.server","UserConfig.logLevel","ResolvedConfig.environments","UserConfig.base","Logger.info","normalizePath","ResolvedBuildEnvironmentOptions.outDir","ResolvedServerOptions.watch","ViteDevServer.pluginContainer","EnvironmentOptions.optimizeDeps","PreviewServer","ResolvedConfig.mode","ResolvedConfig.build","UserConfig.root","ManifestChunk.assets","ResolvedConfig.logger","ConfigEnv.isSsrBuild","ViteBuilder.environments","ConfigEnv.mode","ConfigEnv.command","Logger.warn","EnvironmentOptions.resolve","Environment.name","ManifestChunk.file","Plugin","isRunnableDevEnvironment","DevEnvironment.name","ResolvedConfig.configFile","RunnableDevEnvironment.runner","ViteDevServer.config","UserConfig.build","ResolvedServerOptions.middlewareMode","ResolvedBuildOptions.assetsDir","Plugin.name","ResolvedConfig","EnvironmentOptions","defaultClientConditions","ResolvedConfig.command","PluginContainer.buildStart","ModuleNode.url","createServer","UserConfig.plugins","ViteDevServer.middlewares","ViteBuilder.build","ViteDevServer.transformRequest","ViteDevServer.hot","ResolvedConfig.server","ViteDevServer.environments","ModuleNode.file","ViteDevServer.ssrFixStacktrace","HotUpdatePluginContext.environment","ManifestChunk.css","loadConfigFromFile","ResolvedConfig.root","DevEnvironment.moduleGraph","UserConfig.environments","HotBroadcaster.send","ViteDevServer","DevEnvironment.reloadModule","ViteDevServer.ssrLoadModule","Environment.config","version","node","ESBuildOptions"] |
...
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["dist","path.normalize","path.join","resolve","relative","path.extname","join"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","rename","mkdir","rm","cp","readdir"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.posix","path.PlatformPath.relative","path.PlatformPath.dirname","path.PlatformPath.basename","path.PlatformPath.resolve","path.PlatformPath.join"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.isFile","Dirent.path","Dirent.parentPath","Dirent.name"] |
| vite | http | 5 | 8 | 6 | 129 | 25 | 2150 | ["ServerResponse.end","ServerResponse.statusCode","ServerResponse.setHeader"] |
...
| vite | rollup | 3 | 5 | 6 | 129 | 25 | 2150 | ["PluginContext.environment","ResolvedId.id","PluginContext.resolve"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.isExpression","NodePath.isVariableDeclaration","NodePath.get","NodePath.isIdentifier","NodePath.scope","Scope.generateUidIdentifier","NodePath.isExportNamedDeclaration","NodePath.isExportDefaultDeclaration","NodePath.node","NodePath.replaceWith","NodePath.isFunctionDeclaration"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["variableDeclaration","stringLiteral","importDeclaration","identifier","Program.body","importSpecifier","variableDeclarator","callExpression"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult","ParseResult.program"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["UserConfig.root","ConfigEnv.mode","EnvironmentOptions.resolve","ViteDevServer.middlewares","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","EnvironmentResolveOptions.externalConditions","Connect.Server.use","ResolvedConfig.plugins","ResolvedConfig.server","ViteDevServer.config","Plugin.name","Plugin"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["UserConfig.root","ConfigEnv.mode","EnvironmentOptions.resolve","ViteDevServer.middlewares","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","EnvironmentResolveOptions.externalConditions","Connect.Server.use","ResolvedConfig.plugins","ResolvedConfig.server","ViteDevServer.config","Plugin.name","Plugin"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.environments","ResolvedBuildOptions.ssr","ConfigEnv.command","ResolvedBuildOptions.sourcemap","ResolvedConfig.logger","Logger.warn","ResolvedConfig.build","ResolvedBuildEnvironmentOptions.sourcemap","Plugin","ResolvedConfig.mode","ResolvedEnvironmentOptions.build"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","ResolvedConfig.build","ResolvedBuildOptions.emptyOutDir","UserConfig.build","UserConfig.environments","defaultServerConditions","resolveConfig","ResolvedBuildOptions.manifest","Plugin","ModuleNode","ViteDevServer","createLogger","ResolvedServerOptions.watch","ViteDevServer.pluginContainer","EnvironmentOptions.optimizeDeps","PreviewServer","ResolvedConfig.mode","UserConfig.root","ManifestChunk.assets","ResolvedConfig.logger","ConfigEnv.isSsrBuild","ViteBuilder.environments","ConfigEnv.mode","ConfigEnv.command","Logger.warn","EnvironmentOptions.resolve","Environment.name","ManifestChunk.file","isRunnableDevEnvironment","UserConfig.logLevel","Logger.error","PreviewServer.middlewares","normalizePath","DevEnvironment.name","ResolvedConfig.configFile","RunnableDevEnvironment.runner","ViteDevServer.config","ResolvedServerOptions.middlewareMode","ResolvedBuildOptions.assetsDir","Plugin.name","EnvironmentOptions","defaultClientConditions","Logger.info","ResolvedConfig.command","PluginContainer.buildStart","ModuleNode.url","createServer","UserConfig.plugins","ViteDevServer.middlewares","ViteBuilder.build","Connect.IncomingMessage.url","ViteDevServer.transformRequest","ViteDevServer.hot","ResolvedConfig.server","ViteDevServer.environments","ModuleNode.file","ViteDevServer.ssrFixStacktrace","UserConfig.server","HotUpdatePluginContext.environment","ManifestChunk.css","loadConfigFromFile","ResolvedConfig.root","DevEnvironment.moduleGraph","Connect.Server.use","UserConfig.base","HotBroadcaster.send","DevEnvironment.reloadModule","ViteDevServer.ssrLoadModule","Environment.config","transformWithEsbuild","PluginOption","ResolvedEnvironmentOptions.build","ResolvedConfig.base","ResolvedConfig.environments","ResolvedBuildEnvironmentOptions.outDir"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.relative","path.PlatformPath.isAbsolute","path.PlatformPath.join","path.PlatformPath.resolve","path.PlatformPath.dirname","path.PlatformPath.posix","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","readFile","rename","mkdir","cp"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.Process.env","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.exit","global.NodeJS.Process.cwd"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["dist","path.normalize","path.join","resolve","relative","path.extname","join"] |
...
| plugin | rollup | 3 | 5 | 18 | 135 | 26 | 750 | ["PluginContext.environment","ResolvedId.id","PluginContext.resolve"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ViteDevServer.config","createServer","ResolvedConfig.base","ViteDevServer.pluginContainer","ResolvedConfig.root","Logger","PluginContainer.buildStart","ViteDevServer"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["path.basename","dist","path.dirname","path.resolve"] |
...
| resolve-file-url | @types/path | 4 | 6 | 1 | 5 | 2 | 500 | ["path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.isAbsolute","path.PlatformPath.relative"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["cursor.to","cursor.move","erase","cursor.down","cursor.save","erase.line","cursor.restore"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["EventContext.request","EventContext.waitUntil","EventContext.passThroughOnException","Request.cf","CfProperties","Request","IncomingRequestCfProperties","CacheStorage","EventContext","KVNamespace.get","KVNamespace.delete","KVNamespace.put","Crypto.getRandomValues","Response","Request.headers","Response.body","Headers.delete","Request.clone","EventContext.env","Console.error","Request.url","Response.status"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Response","Request.headers","Response.body","Headers.delete","Request.clone","EventContext.env","EventContext.request","Console.error","Request.url","EventContext","Response.status","CfProperties","Request","IncomingRequestCfProperties","CacheStorage","EventContext.waitUntil","EventContext.passThroughOnException","Request.cf"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["StringLiteral.value","LVal.type","VariableDeclarator.init","VariableDeclarator.id","Identifier.name","VariableDeclaration.declarations"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ViteDevServer.config","Logger.info","ResolvedConfig.plugins","ViteDevServer.printUrls","ViteDevServer.listen","createServer","ResolvedConfig.logger","ViteDevServer.bindCLIShortcuts","Plugin.name"] |
...
| prompts-multi-select | sisteransi | 4 | 20 | 2 | 5 | 2 | 250 | ["cursor.hide","erase.line","cursor.to","erase"] |
...
| react-router-node | promises | 4 | 7 | 7 | 16 | 8 | 228.57142857142858 | [".unlink",".readFile",".writeFile",".mkdir"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["path.relative","dist","ModuleCacheMap.clear","ViteNodeRunner.moduleCache","path.normalize","path.resolve","path.dirname","path.join","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.add","FSWatcher.unwatch","esm","FSWatcher.on","_default.watch"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["ViteDevServer.close","ViteDevServer.moduleGraph","createLogger","ModuleGraph.getModuleById","ModuleGraph.invalidateAll"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["erase","cursor.to","cursor.hide","erase.line"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BaseIssue","array","BaseSchema","ArraySchema","isAbsolute","relative","custom","optional","BooleanSchema","boolean","string","object","ObjectSchema","CustomSchema","OptionalSchema","SchemaWithPipe","pipe","lazy","LazySchema","StringSchema","NotValueAction","notValue","CustomIssue","safeParse","flatten"] |
...
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["isFunctionDeclaration","File.program","isExportNamedDeclaration","VariableDeclaration.declarations","Identifier.name","isExportDeclaration","isVariableDeclaration","Program.body","isClassDeclaration","ImportDeclaration.specifiers","isNodesEquivalent","ExportNamedDeclaration.specifiers","isImportDeclaration","isExportAllDeclaration","ExportNamedDeclaration.declaration","isExportDefaultDeclaration","File"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.NextFunction","e.Request","e.Response","e.Response.end","e.Response.flushHeaders","e.Response.statusMessage","e.Response.status","e.Response.append","e.Request.originalUrl","e.Request.get","e.Request.hostname","e.Request.app","e.Request.protocol","e.Response.on","e.Request.headers","e.Request.method"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.rawQueryString","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.headers","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2","APIGatewayEventRequestContextV2","APIGatewayProxyEventV2.requestContext","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2.cookies","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.relative","path.PlatformPath.dirname","path.PlatformPath.extname","path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.win32","path.PlatformPath.sep"] |
...
| sessions | dist | 6 | 67 | 11 | 5 | 1 | 45.45454545454546 | ["StringifyOptions","ParseOptions","SerializeOptions","SerializeOptions.maxAge","SerializeOptions.expires"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["cursor.to","erase","erase.line","erase.lines","cursor"] |
