...
| 4 | 122 | 32.97 | 44 | 41 | ["./lib/rsc/route-modules.ts uses ./dom-export.ts","./lib/rsc/server.rsc.ts uses ./dom-export.ts","./lib/rsc/server.rsc.ts uses ./index-react-server-client.ts","./lib/server-runtime/errors.ts uses ./index-react-server.ts"] |
| 5 | 48 | 12.97 | 23 | 17 | ["./lib/server-runtime/sessions/memoryStorage.ts uses ./index-react-server.ts","./lib/dom/ssr/routeModules.ts uses ./index-react-server.ts","./lib/server-runtime/sessions/cookieStorage.ts uses ./index-react-server.ts","./lib/server-runtime/sessions/memoryStorage.ts uses ./index.ts"] |
...
| 1 | 353 | 88 | 116 | ["./index-react-server.ts ->./dom-export.ts","./index.ts ->./copy-template.ts"] |
