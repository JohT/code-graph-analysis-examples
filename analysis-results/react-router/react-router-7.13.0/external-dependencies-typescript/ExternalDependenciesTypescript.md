...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>25</td>
      <td>3275.0</td>
      <td>[PluginOption, EnvironmentModuleNode.file, Res...</td>
    </tr>
    <tr>
      <th>1</th>
      <td>vite</td>
    ...
    <tr>
      ...
      <td>25</td>
      <td>3275.0</td>
      <td>[readFile, mkdir, rename, cp, readdir, rm]</td>
    </tr>
    <tr>
      <th>3</th>
      <td>vite</td>
    ...
    <tr>
      ...
      <td>25</td>
      <td>3275.0</td>
      <td>[path.normalize, join, relative, path.dirname,...</td>
    </tr>
    <tr>
      <th>6</th>
      <td>vite</td>
    ...
    <tr>
      ...
      <td>4</td>
      <td>2300.0</td>
      <td>[AssignmentExpression.left, Expression.type, V...</td>
    </tr>
    <tr>
      <th>23</th>
      <td>remove-exports</td>
    ...
    <tr>
      ...
      <td>4</td>
      <td>2100.0</td>
      <td>[importSpecifier, callExpression, variableDecl...</td>
    </tr>
    <tr>
      <th>28</th>
      <td>with-props</td>
    ...
    <tr>
      ...
      <td>2</td>
      <td>1200.0</td>
      <td>[Logger.warn, ResolvedConfig.environments, Res...</td>
    </tr>
    <tr>
      <th>36</th>
      <td>warn-on-client-source-maps</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>25</td>
      <td>3275.000000</td>
      <td>[transformAsync, global.NodeRequire.resolve, B...</td>
    </tr>
    <tr>
      <th>2</th>
      <td>remove-exports</td>
    ...
    <tr>
      ...
      <td>4</td>
      <td>2100.000000</td>
      <td>[ParseResult, importSpecifier, callExpression,...</td>
    </tr>
    <tr>
      <th>7</th>
      <td>cloudflare</td>
      ...
      <td>3</td>
      <td>1500.000000</td>
      <td>[GetPlatformProxyOptions, EnvironmentResolveOp...</td>
    </tr>
    <tr>
      <th>8</th>
      <td>cloudflare</td>
    ...
    <tr>
      ...
      <td>2</td>
      <td>1200.000000</td>
      <td>[Logger.warn, picocolors, ResolvedConfig.envir...</td>
    </tr>
    <tr>
      <th>12</th>
      <td>run</td>
    ...
    <tr>
      ...
      <td>5</td>
      <td>800.000000</td>
      <td>[arg, arg.Result._, arg.Result."--no-typescript"]</td>
    </tr>
    <tr>
      <th>14</th>
      <td>plugin</td>
      ...
      <td>26</td>
      <td>772.222222</td>
      <td>[Dirent.isFile, DevEnvironment.reloadModule, l...</td>
    </tr>
    <tr>
      <th>15</th>
      <td>plugin</td>
    ...
    <tr>
      ...
      <td>6</td>
      <td>700.000000</td>
      <td>[node:process, beep, .createInterface, cursor,...</td>
    </tr>
    <tr>
      <th>17</th>
      <td>prompts-prompt-base</td>
    ...
    <tr>
      ...
      <td>2</td>
      <td>500.000000</td>
      <td>[dist, path.resolve, path.basename, path.dirname]</td>
    </tr>
    <tr>
      <th>24</th>
      <td>is-react-router-repo</td>
    ...
    <tr>
      ...
      <td>5</td>
      <td>450.000000</td>
      <td>[.writeFile, .mkdir, .readFile, promises, .unl...</td>
    </tr>
    <tr>
      <th>30</th>
      <td>fileStorage</td>
    ...
    <tr>
      ...
      <td>2</td>
      <td>400.000000</td>
      <td>[cursor.move, cursor.down, erase.line, erase, ...</td>
    </tr>
    <tr>
      <th>34</th>
    ...
    <tr>
      ...
      <td>2</td>
      <td>360.000000</td>
      <td>[CacheStorage, IncomingRequestCfProperties, Re...</td>
    </tr>
    <tr>
      <th>37</th>
    ...
    <tr>
      ...
      <td>5</td>
      <td>300.000000</td>
      <td>[Session.post, .writeFileSync, node:path, pico...</td>
    </tr>
  </tbody>
</table>
</div>
