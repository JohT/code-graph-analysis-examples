...
| sisteransi | 6 | 6 | 27 | 292 | 139 | 640 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>"] |
...
| @types/stream | 2 | 3 | 18 | 20 | 139 | 640 | ["<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| no namespace | 53 | 97 | 593 | 1643 | 139 | 640 | ["<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external namespace <>","<copyTemplate> of module <copy-template> imports <node:url> from external namespace <>","<Context> of module <create-react-router> imports <node:process> from external namespace <>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external namespace <>"] |
...
| prompts-text | sisteransi | 7 | 91 | 2 | 8 | 2 | 400 | ["cursor.move","erase.line","cursor.restore","cursor.save","cursor.to","erase","cursor.down"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["KVNamespace.get","Crypto.getRandomValues","KVNamespace.delete","KVNamespace.put","EventContext","Response","Request.cf","EventContext.request","EventContext.waitUntil","EventContext.passThroughOnException","Request","CacheStorage","CfProperties","IncomingRequestCfProperties","Request.url","Request.headers","EventContext.env","Response.body","Response.status","Console.error","Request.clone","Headers.delete"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Request.cf","EventContext.request","EventContext.waitUntil","EventContext.passThroughOnException","EventContext","Response","Request.url","Request.headers","EventContext.env","Response.body","Response.status","Console.error","Request.clone","Headers.delete","Request","CacheStorage","CfProperties","IncomingRequestCfProperties"] |
...
| prompts-multi-select | sisteransi | 4 | 52 | 2 | 5 | 2 | 250 | ["cursor.hide","cursor.to","erase","erase.line"] |
...
| react-router-node | @types/stream | 9 | 10 | 7 | 17 | 8 | 242.85714285714286 | ["Stream.Writable.end","Stream.Writable.destroy","Stream.Writable","Stream.Writable.write","Stream.Readable"] |
...
| prompts-select | sisteransi | 4 | 52 | 3 | 6 | 3 | 200 | ["cursor.hide","erase","erase.line","cursor.to"] |
...
| prompts-confirm | sisteransi | 4 | 52 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.to","erase.line","erase","cursor.hide"] |
...
| server | @types/express | 20 | 24 | 41 | 50 | 14 | 121.95121951219512 | ["e.Response.statusMessage","e.Response.append","e.Response","e.Response.status","e.Response.flushHeaders","e.Response.end","e.Request","e.NextFunction","e.Request.headers","e.Request.protocol","e.Request.get","e.Request.hostname","e.Response.on","e.Request.originalUrl","e.Request.method"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.posix","path.PlatformPath.relative","path.PlatformPath.extname","path.PlatformPath.dirname","path.PlatformPath.join","path.PlatformPath.sep","path.PlatformPath.win32"] |
