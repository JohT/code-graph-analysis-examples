...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4666666666666667 | 77 | 28 | ["createRouter->RouterContextProvider","createStaticHandler->RouterContextProvider","RouterInit->PatchRoutesOnNavigationFunction","NavigationStates->DataRouteMatch","Navigation->DataRouteMatch","StaticHandler->DataRouteMatch","RouterState->DataRouteMatch","createStaticHandler->DataStrategyMatch","createRouter->DataStrategyMatch"] | ["Fetcher<-RouterState","Navigation<-RouterState","RevalidationState<-RouterState","Blocker<-RouterState","Fetcher<-Router","BlockerFunction<-Router","GetScrollPositionFunction<-Router","RouterState<-Router","RouterSubscriber<-Router"] |
