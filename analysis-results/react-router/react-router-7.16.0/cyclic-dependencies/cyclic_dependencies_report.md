...
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["createSessionStorage->createCookie","createSessionStorage->isCookie","isSession->IsSessionFunction","createSessionStorage->SessionStorage","SessionIdStorageStrategy->Cookie","createSessionStorage->Cookie","warnOnceAboutSigningSessionCookie->Cookie","SessionIdStorageStrategy->CookieSignatureOptions","createSessionStorage->SessionIdStorageStrategy"] | ["createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["SessionStorage->Session","createSession->Session","CreateSessionFunction->Session","SessionIdStorageStrategy->CookieSignatureOptions","createSessionStorage->SessionIdStorageStrategy","createSessionStorage->isCookie","SessionIdStorageStrategy->Cookie","createSessionStorage->Cookie","warnOnceAboutSigningSessionCookie->Cookie"] | ["createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4666666666666667 | 77 | 28 | ["createRouter->RouterContextProvider","createStaticHandler->RouterContextProvider","RouterInit->PatchRoutesOnNavigationFunction","NavigationStates->DataRouteMatch","Navigation->DataRouteMatch","StaticHandler->DataRouteMatch","RouterState->DataRouteMatch","createRouter->DataStrategyMatch","createStaticHandler->DataStrategyMatch"] | ["Fetcher<-RouterState","Navigation<-RouterState","RevalidationState<-RouterState","Blocker<-RouterState","Fetcher<-Router","BlockerFunction<-Router","GetScrollPositionFunction<-Router","RouterState<-Router","RouterSubscriber<-Router"] |
