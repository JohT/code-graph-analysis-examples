...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>62</td>
      <td>26</td>
      <td>[createRouter-&gt;RouteObject, createRouter-&gt;Action, RouterState-&gt;Action, BlockerFunction-&gt;Action, RouterInit-&gt;DataStrategyFunction, StaticHandler-&gt;DataStrategyFunction, createRouter-&gt;DataStrategyFunction, createRouter-&gt;IDLE_NAVIGATION, createStaticHandler-&gt;DataStrategyMatch]</td>
    ...
    <tr>
      ...
      <td>44</td>
      <td>20</td>
      <td>[Router-&gt;To, Navigator-&gt;To, resolvePath-&gt;To, createBrowserHistory-&gt;BrowserHistory, generatePath-&gt;invariant, createRouter-&gt;invariant, createRouter-&gt;Action, RouterState-&gt;Action, createMemoryHistory-&gt;Action]</td>
    ...
    <tr>
      ...
      <td>17</td>
      <td>10</td>
      <td>[relative-&gt;layout, configRoutesToRouteManifest-&gt;route, prefix-&gt;route, relative-&gt;route, relative-&gt;prefix, resolvedRouteConfigSchema-&gt;RouteConfigEntry, routeConfigEntrySchema-&gt;RouteConfigEntry, index-&gt;RouteConfigEntry, prefix-&gt;RouteConfigEntry]</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>43</td>
      <td>40</td>
      <td>[./lib/rsc/server.rsc.ts uses ./dom-export.ts, ./lib/rsc/route-modules.ts uses ./dom-export.ts, ./lib/rsc/server.rsc.ts uses ./index-react-server-client.ts, ./lib/server-runtime/routes.ts uses ./index-react-server.ts]</td>
    </tr>
    <tr>
      <th>3</th>
      <td>5</td>
