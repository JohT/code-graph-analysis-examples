...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| react-router | ./lib/router/router.ts | react-router | ./lib/router/instrumentation.ts | 0.75 | 7 | 1 | ["createRouter->getRouteInstrumentationUpdates","createStaticHandler->getRouteInstrumentationUpdates","createRouter->InstrumentRouterFunction","RouterInit->ClientInstrumentation","createRouter->InstrumentRouteFunction","createStaticHandler->InstrumentRouteFunction","createRouter->instrumentClientSideRouter"] | ["Router<-instrumentClientSideRouter"] |
| react-router | ./lib/server-runtime/routes.ts | react-router | ./index.ts | 0.75 | 7 | 1 | ["createStaticHandlerDataRoutes->SingleFetchRedirectSymbol","createStaticHandlerDataRoutes->replace","createStaticHandlerDataRoutes->redirectDocument","createStaticHandlerDataRoutes->decodeViaTurboStream","createStaticHandlerDataRoutes->DataRouteObject","createStaticHandlerDataRoutes->redirect","createStaticHandlerDataRoutes->MiddlewareFunction"] | ["ServerRouteManifest<-ServerBuild"] |
| react-router | ./index-react-server.ts | react-router | ./lib/router/utils.ts | 0.7142857142857143 | 36 | 6 | ["Await->TrackedPromise","createStaticHandler->RouterContextProvider","matchRSCServerRequest->RouterContextProvider","createStaticHandler->isRouteErrorResponse","createStaticHandler->ResultType","createStaticHandler->convertRoutesToDataRoutes","MiddlewareFunction->MiddlewareNextFunction","RouterContextProvider->RouterContext","createContext->RouterContext"] | ["RouterContext<-RouterContextProvider","MiddlewareFunction<-RouteObject","data<-convertRouteMatchToUiMatch","MiddlewareNextFunction<-MiddlewareFunction","RouterContext<-createContext","MiddlewareFunction<-BaseRouteObject"] |
| react-router | ./lib/server-runtime/data.ts | react-router | ./index.ts | 0.6666666666666666 | 5 | 1 | ["callRouteHandler->LoaderFunctionArgs","callRouteHandler->ActionFunction","callRouteHandler->LoaderFunction","callRouteHandler->DataWithResponseInit","callRouteHandler->ActionFunctionArgs"] | ["AppLoadContext<-RequestHandler"] |
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | 0.6363636363636364 | 18 | 4 | ["getPatchRoutesOnNavigationFunction->PatchRoutesOnNavigationFunction","getPartialManifest->RouterState","getPatchRoutesOnNavigationFunction->RouterState","getPatchRoutesOnNavigationFunction->RouteModules","useFogOFWarDiscovery->RouteModules","fetchAndApplyManifestPatches->RouteModules","getPatchRoutesOnNavigationFunction->createPath","useFogOFWarDiscovery->AssetsManifest","getPatchRoutesOnNavigationFunction->AssetsManifest"] | ["isFogOfWarEnabled<-getPatchRoutesOnNavigationFunction","fetchAndApplyManifestPatches<-getPatchRoutesOnNavigationFunction","isFogOfWarEnabled<-useFogOFWarDiscovery","fetchAndApplyManifestPatches<-useFogOFWarDiscovery"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["SessionStorage->Session","createSession->Session","CreateSessionFunction->Session","createSessionStorage->createCookie","createSessionStorage->isCookie","SessionIdStorageStrategy->CookieSignatureOptions","createSessionStorage->Cookie","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie"] | ["createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["createSessionStorage->Cookie","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->createCookie","SessionStorage->Session","createSession->Session","CreateSessionFunction->Session","SessionIdStorageStrategy->CookieSignatureOptions","createSessionStorage->SessionStorage"] | ["createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage","createSessionStorage<-createMemorySessionStorage"] |
...
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4666666666666667 | 77 | 28 | ["createRouter->IDLE_FETCHER","RouterInit->PatchRoutesOnNavigationFunction","NavigationStates->Location","BlockerFunction->Location","createRouter->Location","Router->Location","RouterState->Location","createStaticHandler->Location","Navigation->Location"] | ["Blocker<-RouterState","Navigation<-RouterState","Fetcher<-RouterState","RevalidationState<-RouterState","Router<-getPatchRoutesOnNavigationFunction","RouterState<-getPatchRoutesOnNavigationFunction","IDLE_NAVIGATION<-createRouter","BlockerFunction<-createRouter","RouterInit<-createRouter"] |
| react-router | ./lib/server-runtime/server.ts | react-router | ./index.ts | 0.42857142857142855 | 5 | 2 | ["RequestHandler->AppLoadContext","CreateRequestHandlerFunction->RequestHandler","CreateRequestHandlerFunction->ServerBuild","createRequestHandler->ServerBuild","createRequestHandler->CreateRequestHandlerFunction"] | ["CreateRequestHandlerFunction<-createRequestHandler","RequestHandler<-CreateRequestHandlerFunction"] |
