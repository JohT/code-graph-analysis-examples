...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| react-router | ./lib/router/router.ts | react-router | ./lib/router/instrumentation.ts | 0.75 | 7 | 1 | ["createRouter->instrumentClientSideRouter","createStaticHandler->InstrumentRouteFunction","createRouter->InstrumentRouteFunction","RouterInit->ClientInstrumentation","createRouter->InstrumentRouterFunction","createStaticHandler->getRouteInstrumentationUpdates","createRouter->getRouteInstrumentationUpdates"] | ["Router<-instrumentClientSideRouter"] |
| react-router | ./lib/server-runtime/routes.ts | react-router | ./index.ts | 0.75 | 7 | 1 | ["createStaticHandlerDataRoutes->MiddlewareFunction","createStaticHandlerDataRoutes->replace","createStaticHandlerDataRoutes->redirectDocument","createStaticHandlerDataRoutes->decodeViaTurboStream","createStaticHandlerDataRoutes->DataRouteObject","createStaticHandlerDataRoutes->redirect","createStaticHandlerDataRoutes->SingleFetchRedirectSymbol"] | ["ServerRouteManifest<-ServerBuild"] |
| react-router | ./index-react-server.ts | react-router | ./lib/router/utils.ts | 0.7142857142857143 | 36 | 6 | ["matchRSCServerRequest->RouteMatch","createStaticHandler->RouteMatch","matchRoutes->RouteMatch","createStaticHandler->ErrorResult","redirectDocument->redirectDocument","createStaticHandler->SuccessResult","RSCRouteMatch->Params","createStaticHandler->getRoutePattern","createStaticHandler->RouteObject"] | ["MiddlewareNextFunction<-MiddlewareFunction","data<-convertRouteMatchToUiMatch","RouterContext<-createContext","MiddlewareFunction<-BaseRouteObject","MiddlewareFunction<-RouteObject","RouterContext<-RouterContextProvider"] |
| react-router | ./lib/server-runtime/data.ts | react-router | ./index.ts | 0.6666666666666666 | 5 | 1 | ["callRouteHandler->DataWithResponseInit","callRouteHandler->ActionFunctionArgs","callRouteHandler->LoaderFunction","callRouteHandler->ActionFunction","callRouteHandler->LoaderFunctionArgs"] | ["AppLoadContext<-RequestHandler"] |
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | 0.6363636363636364 | 18 | 4 | ["useFogOFWarDiscovery->Router","fetchAndApplyManifestPatches->Router","getPartialManifest->Router","getPatchRoutesOnNavigationFunction->Router","fetchAndApplyManifestPatches->createClientRoutes","getPartialManifest->RouterState","getPatchRoutesOnNavigationFunction->RouterState","useFogOFWarDiscovery->AssetsManifest","getPartialManifest->AssetsManifest"] | ["fetchAndApplyManifestPatches<-useFogOFWarDiscovery","isFogOfWarEnabled<-useFogOFWarDiscovery","fetchAndApplyManifestPatches<-getPatchRoutesOnNavigationFunction","isFogOfWarEnabled<-getPatchRoutesOnNavigationFunction"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["createSessionStorage->SessionStorage","createSessionStorage->createCookie","createSessionStorage->SessionIdStorageStrategy","SessionIdStorageStrategy->CookieSignatureOptions","isSession->IsSessionFunction","SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","SessionStorage->Session"] | ["createSessionStorage<-createMemorySessionStorage","createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["SessionIdStorageStrategy->Cookie","warnOnceAboutSigningSessionCookie->Cookie","createSessionStorage->Cookie","SessionStorage->Session","createSession->Session","CreateSessionFunction->Session","createSessionStorage->isCookie","isSession->IsSessionFunction","createSessionStorage->SessionStorage"] | ["createSessionStorage<-createMemorySessionStorage","createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage"] |
| react-router-dev | ./vite/plugin.ts | react-router-dev | ./vite/styles.ts | 0.5 | 3 | 1 | ["reactRouterVitePlugin->isCssModulesFile","reactRouterVitePlugin->getStylesForPathname","reactRouterVitePlugin->getCssStringFromViteDevModuleCode"] | ["LoadCssContents<-getStylesForPathname"] |
| react-router | ./lib/router/router.ts | react-router | ./index.ts | 0.4666666666666667 | 77 | 28 | ["createRouter->RouterInit","createStaticHandler->RouterContextProvider","createRouter->RouterContextProvider","createRouter->Router","createStaticHandler->InstrumentRouteFunction","createRouter->InstrumentRouteFunction","Router->RouterState","createRouter->RouterState","createRouter->parsePath"] | ["RouterState<-DataRouterStateContext","Router<-DataRouterStateContext","BlockerFunction<-Router","RouterSubscriber<-Router","FutureConfig<-Router","RouterState<-Router","Fetcher<-Router","GetScrollPositionFunction<-Router","Blocker<-Router"] |
| react-router | ./lib/server-runtime/server.ts | react-router | ./index.ts | 0.42857142857142855 | 5 | 2 | ["CreateRequestHandlerFunction->ServerBuild","createRequestHandler->ServerBuild","RequestHandler->AppLoadContext","createRequestHandler->CreateRequestHandlerFunction","CreateRequestHandlerFunction->RequestHandler"] | ["CreateRequestHandlerFunction<-createRequestHandler","RequestHandler<-CreateRequestHandlerFunction"] |
...
| react-router | ./lib/server-runtime/routes.ts | react-router | ./index.ts | createStaticHandlerDataRoutes->MiddlewareFunction | 0.75 | 7 | 1 |
...
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | fetchAndApplyManifestPatches<-useFogOFWarDiscovery | 0.6363636363636364 | 18 | 4 |
