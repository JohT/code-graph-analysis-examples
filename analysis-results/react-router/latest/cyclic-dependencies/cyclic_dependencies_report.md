...
| react-router | ./lib/dom/ssr/fog-of-war.ts | react-router | ./index.ts | 0.6363636363636364 | 18 | 4 | ["useFogOFWarDiscovery->Router","getPartialManifest->Router","fetchAndApplyManifestPatches->Router","getPatchRoutesOnNavigationFunction->Router","fetchAndApplyManifestPatches->createClientRoutes","getPartialManifest->RouterState","getPatchRoutesOnNavigationFunction->RouterState","useFogOFWarDiscovery->AssetsManifest","getPartialManifest->AssetsManifest"] | ["fetchAndApplyManifestPatches<-useFogOFWarDiscovery","isFogOfWarEnabled<-useFogOFWarDiscovery","fetchAndApplyManifestPatches<-getPatchRoutesOnNavigationFunction","isFogOfWarEnabled<-getPatchRoutesOnNavigationFunction"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index-react-server.ts | 0.6 | 12 | 3 | ["createSessionStorage->SessionStorage","createSessionStorage->createCookie","createSessionStorage->SessionIdStorageStrategy","SessionIdStorageStrategy->CookieSignatureOptions","isSession->IsSessionFunction","SessionIdStorageStrategy->Cookie","createSessionStorage->Cookie","warnOnceAboutSigningSessionCookie->Cookie","SessionStorage->Session"] | ["createSessionStorage<-createMemorySessionStorage","createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage"] |
| react-router | ./lib/server-runtime/sessions.ts | react-router | ./index.ts | 0.6 | 12 | 3 | ["SessionIdStorageStrategy->Cookie","createSessionStorage->Cookie","warnOnceAboutSigningSessionCookie->Cookie","SessionStorage->Session","createSession->Session","CreateSessionFunction->Session","createSessionStorage->isCookie","isSession->IsSessionFunction","createSessionStorage->SessionStorage"] | ["createSessionStorage<-createMemorySessionStorage","createSession<-createCookieSessionStorage","warnOnceAboutSigningSessionCookie<-createCookieSessionStorage"] |
