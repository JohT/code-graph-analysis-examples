...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 140 | 648 | ["<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedBuildEnvironmentOptions.outDir> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <normalizePath> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Connect.Server.use> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <createLogger> from external module <node>"] |
...
| http | 7 | 6 | 16 | 22 | 140 | 648 | ["<createRemixHeaders> of module <server> imports <IncomingHttpHeaders> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.statusCode> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.setHeader> from external module <http>","<reactRouterRSCVitePlugin> of module <vite> imports <ServerResponse.end> from external module <http>"] |
...
| @types/babel__generator | 6 | 8 | 13 | 15 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <GeneratorResult> from external module <babel__generator>","<reactRouterVitePlugin> of module <vite> imports <GeneratorResult.code> from external module <babel__generator>","<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult> from external module <babel__generator>","<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult.code> from external module <babel__generator>"] |
...
| fs | 6 | 6 | 17 | 27 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
...
| sisteransi | 6 | 6 | 27 | 116 | 140 | 648 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 140 | 648 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportDeclaration.type> from external module <lib>","<removeExports> of module <remove-exports> imports <ClassDeclaration.id> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 140 | 648 | ["<createRequestHandler> of module <worker> imports <Request.cf> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.request> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.passThroughOnException> from external module <workers-types>","<createRequestHandler> of module <worker> imports <EventContext.waitUntil> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.map> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 140 | 648 | ["<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>"] |
...
| node:url | 3 | 2 | 4 | 6 | 140 | 648 | ["<copyTemplate> of module <copy-template> imports <node:url> from external module <node:url>","<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external module <node:url>","<reactRouterVitePlugin> of module <vite> imports <.pathToFileURL> from external module <node:url>","<reactRouterVitePlugin> of module <plugin> imports <.pathToFileURL> from external module <node:url>"] |
...
| @mjackson/node-fetch-server | 2 | 2 | 4 | 4 | 140 | 648 | ["<createRequestListener> of module <server> imports <createRequestListener> from external module <node-fetch-server>","<createRequestListener> of module <react-router-node> imports <createRequestListener> from external module <node-fetch-server>","<RequestListenerOptions> of module <react-router-node> imports <ClientAddress> from external module <node-fetch-server>","<RequestListenerOptions> of module <server> imports <ClientAddress> from external module <node-fetch-server>"] |
| @types/api-gateway-proxy | 2 | 5 | 24 | 34 | 140 | 648 | ["<RequestHandler> of module <server> imports <APIGatewayProxyResultV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<RequestHandler> of module <react-router-architect> imports <APIGatewayProxyResultV2> from external module <api-gateway-proxy>"] |
| @types/express | 2 | 4 | 26 | 30 | 140 | 648 | ["<RequestHandler> of module <react-router-express> imports <e.NextFunction> from external module <express>","<RequestHandler> of module <react-router-express> imports <e.Request> from external module <express>","<RequestHandler> of module <react-router-express> imports <e.Response> from external module <express>","<RequestHandler> of module <server> imports <e.NextFunction> from external module <express>"] |
...
| @types/stream | 2 | 3 | 14 | 16 | 140 | 648 | ["<createReadableStreamFromReadable> of module <react-router-node> imports <Stream.Readable> from external module <stream>","<createReadableStreamFromReadable> of module <stream> imports <Stream.Readable> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>"] |
...
| esm | 2 | 2 | 6 | 7 | 140 | 648 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.unwatch> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>","<createConfigLoader> of module <config> imports <_default.watch> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 140 | 648 | ["<reactRouterVitePlugin> of module <vite> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <ResolvedId.id> from external module <rollup>"] |
...
| @types/semver | 1 | 1 | 2 | 2 | 140 | 648 | ["<run> of module <run> imports <major> from external module <semver>","<run> of module <run> imports <semver> from external module <semver>"] |
...
| arg | 1 | 1 | 2 | 3 | 140 | 648 | ["<run> of module <run> imports <arg> from external module <arg>","<run> of module <run> imports <arg.Result._> from external module <arg>"] |
...
| node:readline | 1 | 1 | 3 | 20 | 140 | 648 | ["<Prompt> of module <prompts-prompt-base> imports <.createInterface> from external module <node:readline>","<Prompt> of module <prompts-prompt-base> imports <.emitKeypressEvents> from external module <node:readline>","<Prompt> of module <prompts-prompt-base> imports <node:readline> from external module <node:readline>"] |
| p-map | 1 | 1 | 1 | 1 | 140 | 648 | ["<prerender> of module <prerender> imports <p-map> from external module <p-map>"] |
| prettier | 1 | 1 | 2 | 2 | 140 | 648 | ["<transpile> of module <useJavascript> imports <format> from external module <prettier>","<transpile> of module <useJavascript> imports <prettier> from external module <prettier>"] |
...
| @babel | 5 | 7 | 68 | 148 | 140 | 648 | ["<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ExportDeclaration.type> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ParseResult> from external namespace <@babel>"] |
| @cloudflare | 3 | 5 | 52 | 68 | 140 | 648 | ["<createRequestHandler> of module <worker> imports <Request.cf> from external namespace <@cloudflare>","<createRequestHandler> of module <worker> imports <EventContext.request> from external namespace <@cloudflare>","<createRequestHandler> of module <worker> imports <EventContext.passThroughOnException> from external namespace <@cloudflare>","<createRequestHandler> of module <worker> imports <EventContext.waitUntil> from external namespace <@cloudflare>"] |
...
| @types/path | 13 | 41 | 1 | 7 | 2 | 3.153846153846154 | 2.192645048267573 | 22 | 1 | 5 | 1 | 1.6923076923076923 | 1.1821319289469756 | 0.15432098765432098 | 0.7716049382716049 | 0.15432098765432098 | 0.2611585944919278 | 0.18242776681280484 | ["normalizeSlashes","flatRoutes","react-router-fs-routes","utils"] |
...
| @types/buffer | 6 | 11 | 1 | 3 | 2 | 1.8333333333333335 | 0.752772652709081 | 7 | 1 | 2 | 1 | 1.1666666666666665 | 0.408248290463863 | 0.15432098765432098 | 0.30864197530864196 | 0.15432098765432098 | 0.18004115226337447 | 0.06300127939257145 | ["vite","plugin","server","stream"] |
...
| @mjackson/node-fetch-server | 2 | 4 | 2 | 2 | 2 | 2 | 0 | 4 | 2 | 2 | 2 | 2 | 0 | 0.30864197530864196 | 0.30864197530864196 | 0.30864197530864196 | 0.30864197530864196 | 0 | ["server","react-router-node"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["ExportDeclaration.type","ClassDeclaration.id","FunctionDeclaration.id","Expression.type","ExportSpecifier.exported","Identifier.name","VariableDeclaration.declarations","MemberExpression.object","AssignmentExpression.left","ExportSpecifier.local","LVal.type","ExportNamedDeclaration.declaration","ExpressionStatement.expression","ExportNamedDeclaration.specifiers","ExportDefaultDeclaration.declaration","VariableDeclarator.id"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["ResolvedBuildEnvironmentOptions.outDir","normalizePath","Connect.Server.use","createLogger","Connect.IncomingMessage.url","Logger.error","UserConfig.base","Logger.info","UserConfig.server","transformWithEsbuild","PreviewServer.middlewares","ResolvedConfig.environments","ResolvedConfig.base","UserConfig.logLevel","ResolvedEnvironmentOptions.build","PluginOption","ModuleNode.file","createServer","ViteDevServer.config","ManifestChunk.assets","ManifestChunk.file","DevEnvironment.name","ConfigEnv.command","loadConfigFromFile","ResolvedBuildOptions.assetsDir","HotBroadcaster.send","Environment.name","DevEnvironment.reloadModule","Environment.config","ResolvedConfig.command","ConfigEnv.mode","Plugin.name","ViteBuilder.build","UserConfig.root","Plugin","ResolvedConfig.build","ResolvedConfig.configFile","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","defaultClientConditions","ViteDevServer.transformRequest","ResolvedConfig","ModuleNode.url","ViteBuilder.environments","ConfigEnv.isSsrBuild","UserConfig.build","EnvironmentOptions.optimizeDeps","ViteDevServer","PluginContainer.buildStart","Logger.warn","EnvironmentOptions","UserConfig.environments","ViteDevServer.ssrFixStacktrace","ResolvedConfig.server","ResolvedConfig.root","ResolvedConfig.logger","EnvironmentOptions.resolve","ResolvedServerOptions.watch","UserConfig.plugins","RunnableDevEnvironment.runner","isRunnableDevEnvironment","ManifestChunk.css","DevEnvironment.moduleGraph","ViteDevServer.hot","ViteDevServer.middlewares","ViteDevServer.environments","ResolvedConfig.mode","ViteDevServer.pluginContainer","PreviewServer","HotUpdatePluginContext.environment","version","ESBuildOptions","node"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.env","global.NodeJS.Process.cwd","global.NodeJS.Process.exit","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["path.join","relative","join","path.extname","path.normalize","resolve","dist"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","readdir","rename","rm","mkdir","cp"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.posix","path.PlatformPath.relative","path.PlatformPath.dirname","path.PlatformPath.resolve","path.PlatformPath.join","path.PlatformPath.basename"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.isFile","Dirent.path","Dirent.parentPath","Dirent.name"] |
| vite | http | 5 | 8 | 6 | 129 | 25 | 2150 | ["ServerResponse.statusCode","ServerResponse.setHeader","ServerResponse.end"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["Scope.generateUidIdentifier","NodePath.get","NodePath.node","NodePath.isExportDefaultDeclaration","NodePath.isFunctionDeclaration","NodePath.isExpression","NodePath.isIdentifier","NodePath.isVariableDeclaration","NodePath.scope","NodePath.isExportNamedDeclaration","NodePath.replaceWith"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["stringLiteral","callExpression","Program.body","importSpecifier","identifier","variableDeclaration","importDeclaration","variableDeclarator"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult","ParseResult.program"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.ssrLoadModule","Connect.Server.use","ResolvedServerOptions.middlewareMode","Plugin.name","ResolvedConfig.server","ConfigEnv.mode","UserConfig.root","ResolvedConfig.plugins","Plugin","EnvironmentResolveOptions.externalConditions","ViteDevServer.middlewares","EnvironmentOptions.resolve","ViteDevServer.config"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.ssrLoadModule","Connect.Server.use","ResolvedServerOptions.middlewareMode","Plugin.name","ResolvedConfig.server","ConfigEnv.mode","UserConfig.root","ResolvedConfig.plugins","Plugin","EnvironmentResolveOptions.externalConditions","ViteDevServer.middlewares","EnvironmentOptions.resolve","ViteDevServer.config"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.mode","ResolvedEnvironmentOptions.build","Logger.warn","ResolvedConfig.build","ResolvedConfig.logger","ResolvedBuildOptions.sourcemap","ConfigEnv.command","Plugin","ResolvedConfig.environments","ResolvedBuildEnvironmentOptions.sourcemap","ResolvedBuildOptions.ssr"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","ResolvedBuildOptions.emptyOutDir","ResolvedConfig.build","UserConfig.build","defaultServerConditions","UserConfig.environments","ResolvedBuildOptions.manifest","Plugin","resolveConfig","ViteDevServer","ModuleNode","ModuleNode.file","normalizePath","createServer","ViteDevServer.config","ManifestChunk.assets","ManifestChunk.file","DevEnvironment.name","Connect.Server.use","ConfigEnv.command","Logger.error","loadConfigFromFile","ResolvedBuildOptions.assetsDir","PreviewServer.middlewares","HotBroadcaster.send","Environment.name","DevEnvironment.reloadModule","Environment.config","ResolvedConfig.command","ConfigEnv.mode","Plugin.name","ViteBuilder.build","UserConfig.root","UserConfig.base","ResolvedConfig.configFile","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","defaultClientConditions","ViteDevServer.transformRequest","Logger.info","ModuleNode.url","ViteBuilder.environments","ConfigEnv.isSsrBuild","EnvironmentOptions.optimizeDeps","PluginContainer.buildStart","Logger.warn","Connect.IncomingMessage.url","EnvironmentOptions","ViteDevServer.ssrFixStacktrace","UserConfig.server","ResolvedConfig.server","ResolvedConfig.root","ResolvedConfig.logger","EnvironmentOptions.resolve","ResolvedServerOptions.watch","UserConfig.plugins","RunnableDevEnvironment.runner","isRunnableDevEnvironment","ManifestChunk.css","DevEnvironment.moduleGraph","createLogger","ViteDevServer.hot","ViteDevServer.middlewares","ViteDevServer.environments","ResolvedConfig.mode","ViteDevServer.pluginContainer","UserConfig.logLevel","PreviewServer","HotUpdatePluginContext.environment","ResolvedBuildEnvironmentOptions.outDir","transformWithEsbuild","ResolvedConfig.environments","ResolvedConfig.base","ResolvedEnvironmentOptions.build","PluginOption"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.relative","path.PlatformPath.isAbsolute","path.PlatformPath.join","path.PlatformPath.dirname","path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.basename"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["rm","readdir","rename","mkdir","readFile","cp"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.cwd","global.NodeJS.Process.exit","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["path.join","relative","join","path.extname","path.normalize","resolve","dist"] |
...
| plugin | node:fs | 5 | 10 | 18 | 135 | 26 | 750 | ["readFileSync","existsSync","rmSync","readdirSync"] |
...
| prompts-prompt-base | @types/process | 4 | 20 | 2 | 14 | 6 | 700 | ["global.NodeJS.Process.stdout","global.NodeJS.Process.stdin","global.NodeJS.WriteStream","global.NodeJS.ReadStream"] |
| prompts-prompt-base | node:readline | 3 | 20 | 2 | 14 | 6 | 700 | [".createInterface",".emitKeypressEvents","node:readline"] |
| prompts-prompt-base | sisteransi | 3 | 15 | 2 | 14 | 6 | 700 | ["beep","cursor","cursor.show"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["Logger","PluginContainer.buildStart","createServer","ResolvedConfig.root","ViteDevServer.config","ResolvedConfig.base","ViteDevServer.pluginContainer","ViteDevServer"] |
...
| resolve-file-url | @types/path | 4 | 6 | 1 | 5 | 2 | 500 | ["path.PlatformPath.relative","path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.isAbsolute"] |
| resolve-file-url | node | 1 | 3 | 1 | 5 | 2 | 500 | ["normalizePath"] |
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".readFile",".mkdir",".unlink",".writeFile"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["erase.line","cursor.move","cursor.restore","cursor.save","cursor.to","cursor.down","erase"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["Request.cf","EventContext.request","EventContext.passThroughOnException","EventContext.waitUntil","Request","EventContext","IncomingRequestCfProperties","CfProperties","CacheStorage","KVNamespace.put","Crypto.getRandomValues","KVNamespace.delete","KVNamespace.get","Response","Response.body","Console.error","Request.clone","Request.url","Request.headers","Headers.delete","Response.status","EventContext.env"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Response.body","Response","Console.error","Request.clone","Request.url","Request.headers","EventContext","Headers.delete","Response.status","EventContext.request","EventContext.env","Request","IncomingRequestCfProperties","CfProperties","CacheStorage","Request.cf","EventContext.passThroughOnException","EventContext.waitUntil"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["StringLiteral.value","VariableDeclaration.declarations","VariableDeclarator.init","Identifier.name","LVal.type","VariableDeclarator.id"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["ResolvedConfig.logger","ViteDevServer.printUrls","ViteDevServer.listen","ResolvedConfig.plugins","createServer","ViteDevServer.bindCLIShortcuts","Logger.info","Plugin.name","ViteDevServer.config"] |
...
| react-router-node | @types/stream | 7 | 8 | 7 | 16 | 8 | 228.57142857142858 | ["Stream.Readable","Stream.Writable.end","Stream.Writable","Stream.Writable.write"] |
| react-router-node | @types/buffer | 4 | 4 | 7 | 16 | 8 | 228.57142857142858 | ["global.Buffer.toString","global.BufferConstructor.concat","global.BufferConstructor.from"] |
| react-router-node | promises | 4 | 7 | 7 | 16 | 8 | 228.57142857142858 | [".readFile",".mkdir",".unlink",".writeFile"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["ViteNodeRunner.moduleCache","ModuleCacheMap.clear","path.relative","dist","path.normalize","path.resolve","path.join","path.dirname","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.unwatch","esm","_default.watch","FSWatcher.on","FSWatcher.add"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["ViteDevServer.moduleGraph","ViteDevServer.close","ModuleGraph.invalidateAll","ModuleGraph.getModuleById","createLogger"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["erase","cursor.hide","erase.line","cursor.to"] |
...
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.hide","erase","erase.line","cursor.to"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","array","ArraySchema","BaseIssue","BaseSchema","isAbsolute","relative","optional","ObjectSchema","boolean","CustomSchema","CustomIssue","OptionalSchema","SchemaWithPipe","NotValueAction","StringSchema","string","LazySchema","lazy","object","custom","notValue","BooleanSchema","pipe","safeParse","flatten"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| stream | @types/stream | 7 | 8 | 4 | 6 | 3 | 150 | ["Stream.Writable.end","Stream.Writable","Stream.Writable.write","Stream.Readable"] |
| stream | @types/buffer | 2 | 2 | 4 | 6 | 3 | 150 | ["global.Buffer.toString","global.BufferConstructor.concat"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["isExportDeclaration","ExportNamedDeclaration.declaration","ImportDeclaration.specifiers","isVariableDeclaration","isFunctionDeclaration","isImportDeclaration","isClassDeclaration","Identifier.name","isNodesEquivalent","isExportDefaultDeclaration","File.program","VariableDeclaration.declarations","Program.body","isExportNamedDeclaration","isExportAllDeclaration","ExportNamedDeclaration.specifiers","File"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.NextFunction","e.Request","e.Response","e.Response.end","e.Response.flushHeaders","e.Response.statusMessage","e.Response.status","e.Response.append","e.Request.app","e.Request.originalUrl","e.Request.get","e.Request.hostname","e.Request.protocol","e.Response.on","e.Request.headers","e.Request.method"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2.headers","APIGatewayEventRequestContextV2","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventV2.requestContext","APIGatewayEventRequestContextV2.http","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.extname","path.PlatformPath.dirname","path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.win32","path.PlatformPath.sep"] |
...
| utils | @types/process | 7 | 9 | 149 | 29 | 12 | 19.46308724832215 | ["global.NodeJS.Process.stdout","global.NodeJS.WriteStream","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.TERM","global.NodeJS.Process.stderr"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["erase.line","erase","cursor","erase.lines","cursor.to"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key.meta","Key","Key.ctrl","Key.name"] |
