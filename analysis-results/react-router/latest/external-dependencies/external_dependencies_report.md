...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 139 | 645 | ["<reactRouterRSCVitePlugin> of module <vite> imports <Connect.Server.use> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedConfig.environments> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <UserConfig.base> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Logger.error> from external module <node>"] |
...
| node:fs | 10 | 12 | 26 | 49 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <node:fs> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <.readdirSync> from external module <node:fs>","<flatRoutes> of module <flatRoutes> imports <.existsSync> from external module <node:fs>","<flatRoutes> of module <react-router-fs-routes> imports <.existsSync> from external module <node:fs>"] |
...
| fs | 6 | 6 | 17 | 27 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
...
| sisteransi | 6 | 6 | 27 | 116 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <ExpressionStatement.expression> from external module <lib>","<removeExports> of module <remove-exports> imports <FunctionDeclaration.id> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 139 | 645 | ["<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>"] |
...
| @types/stream | 2 | 3 | 18 | 20 | 139 | 645 | ["<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>"] |
...
| esm | 2 | 2 | 6 | 7 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <_default.watch> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.add> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.on> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.environment> from external module <rollup>"] |
...
| @babel | 5 | 7 | 68 | 148 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ExpressionStatement.expression> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <FunctionDeclaration.id> from external namespace <@babel>"] |
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external namespace <@cloudflare>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["ExpressionStatement.expression","FunctionDeclaration.id","VariableDeclaration.declarations","ExportDefaultDeclaration.declaration","Expression.type","AssignmentExpression.left","ExportNamedDeclaration.specifiers","ExportNamedDeclaration.declaration","ExportSpecifier.exported","ExportSpecifier.local","ClassDeclaration.id","LVal.type","MemberExpression.object","ExportDeclaration.type","VariableDeclarator.id","Identifier.name"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["Connect.Server.use","ResolvedConfig.environments","UserConfig.base","Logger.error","transformWithEsbuild","createLogger","ResolvedEnvironmentOptions.build","ResolvedBuildEnvironmentOptions.outDir","UserConfig.logLevel","Logger.info","Connect.IncomingMessage.url","PreviewServer.middlewares","PluginOption","normalizePath","UserConfig.server","ResolvedConfig.base","ResolvedConfig.build","ResolvedServerOptions.watch","ViteDevServer.transformRequest","ModuleNode.url","UserConfig.environments","ManifestChunk.file","Plugin","Environment.config","ViteDevServer.ssrFixStacktrace","ViteDevServer.config","ViteDevServer.hot","ResolvedConfig.root","PluginContainer.buildStart","ResolvedConfig.logger","ViteDevServer.environments","ViteDevServer.pluginContainer","loadConfigFromFile","UserConfig.root","DevEnvironment.name","ResolvedConfig.command","defaultClientConditions","ResolvedBuildOptions.assetsDir","DevEnvironment.moduleGraph","ResolvedConfig","DevEnvironment.reloadModule","ViteBuilder.environments","UserConfig.plugins","Logger.warn","EnvironmentOptions.optimizeDeps","ResolvedConfig.mode","isRunnableDevEnvironment","Plugin.name","HotBroadcaster.send","ManifestChunk.assets","ViteBuilder.build","createServer","ViteDevServer.middlewares","ConfigEnv.command","HotUpdatePluginContext.environment","ResolvedServerOptions.middlewareMode","ConfigEnv.mode","ManifestChunk.css","ResolvedConfig.configFile","EnvironmentOptions","Environment.name","ModuleNode.file","ViteDevServer","RunnableDevEnvironment.runner","ResolvedConfig.server","ConfigEnv.isSsrBuild","UserConfig.build","PreviewServer","EnvironmentOptions.resolve","ViteDevServer.ssrLoadModule","ESBuildOptions","version","node"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.Process.env","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.exit","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.cwd"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["path.normalize","path.join","resolve","dist","path.extname","relative","join"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","readdir","mkdir","rename","cp","rm"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.dirname","path.PlatformPath.basename","path.PlatformPath.posix","path.PlatformPath.resolve","path.PlatformPath.join","path.PlatformPath.relative"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.node","NodePath.isVariableDeclaration","NodePath.isExportDefaultDeclaration","NodePath.isFunctionDeclaration","NodePath.isIdentifier","NodePath.scope","NodePath.isExportNamedDeclaration","NodePath.replaceWith","NodePath.get","Scope.generateUidIdentifier","NodePath.isExpression"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["stringLiteral","callExpression","variableDeclarator","Program.body","importSpecifier","variableDeclaration","identifier","importDeclaration"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult.program","ParseResult"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ConfigEnv.mode","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","UserConfig.root","ResolvedConfig.server","Plugin","Connect.Server.use","ViteDevServer.config","EnvironmentResolveOptions.externalConditions","ResolvedConfig.plugins","Plugin.name","EnvironmentOptions.resolve","ViteDevServer.middlewares"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ConfigEnv.mode","ResolvedServerOptions.middlewareMode","ViteDevServer.ssrLoadModule","UserConfig.root","ResolvedConfig.server","Plugin","Connect.Server.use","ViteDevServer.config","EnvironmentResolveOptions.externalConditions","ResolvedConfig.plugins","Plugin.name","EnvironmentOptions.resolve","ViteDevServer.middlewares"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.logger","ResolvedConfig.build","ConfigEnv.command","ResolvedConfig.mode","Plugin","Logger.warn","ResolvedBuildOptions.sourcemap","ResolvedBuildEnvironmentOptions.sourcemap","ResolvedConfig.environments","ResolvedBuildOptions.ssr","ResolvedEnvironmentOptions.build"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","Plugin","resolveConfig","ResolvedConfig.build","ResolvedConfig","ResolvedBuildOptions.manifest","ModuleNode","ViteDevServer","UserConfig.logLevel","ResolvedServerOptions.watch","ViteDevServer.transformRequest","Logger.error","Logger.info","ModuleNode.url","UserConfig.environments","ManifestChunk.file","Environment.config","ViteDevServer.ssrFixStacktrace","ViteDevServer.config","ViteDevServer.hot","ResolvedConfig.root","PluginContainer.buildStart","ResolvedConfig.logger","ViteDevServer.environments","ViteDevServer.pluginContainer","loadConfigFromFile","UserConfig.root","DevEnvironment.name","ResolvedConfig.command","defaultClientConditions","ResolvedBuildOptions.assetsDir","DevEnvironment.moduleGraph","DevEnvironment.reloadModule","UserConfig.server","ViteBuilder.environments","UserConfig.plugins","Logger.warn","Connect.Server.use","EnvironmentOptions.optimizeDeps","ResolvedConfig.mode","isRunnableDevEnvironment","Plugin.name","normalizePath","HotBroadcaster.send","ManifestChunk.assets","ViteBuilder.build","createServer","ViteDevServer.middlewares","ConfigEnv.command","createLogger","HotUpdatePluginContext.environment","UserConfig.base","ResolvedServerOptions.middlewareMode","ConfigEnv.mode","ManifestChunk.css","Connect.IncomingMessage.url","ResolvedConfig.configFile","EnvironmentOptions","Environment.name","ModuleNode.file","RunnableDevEnvironment.runner","ResolvedConfig.server","ConfigEnv.isSsrBuild","UserConfig.build","PreviewServer","EnvironmentOptions.resolve","PreviewServer.middlewares","ViteDevServer.ssrLoadModule","defaultServerConditions","ResolvedBuildOptions.emptyOutDir","ResolvedConfig.environments","transformWithEsbuild","ResolvedEnvironmentOptions.build","ResolvedBuildEnvironmentOptions.outDir","PluginOption","ResolvedConfig.base"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.resolve","path.PlatformPath.dirname","path.PlatformPath.basename","path.PlatformPath.posix","path.PlatformPath.isAbsolute"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["readFile","readdir","mkdir","rename","cp","rm"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.Process.exit","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.cwd"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["path.normalize","path.join","resolve","dist","path.extname","relative","join"] |
...
| plugin | node:fs | 5 | 10 | 18 | 135 | 26 | 750 | ["readdirSync","rmSync","existsSync","readFileSync"] |
...
| prompts-prompt-base | node:readline | 3 | 20 | 2 | 14 | 6 | 700 | [".emitKeypressEvents","node:readline",".createInterface"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ViteDevServer","ViteDevServer.config","PluginContainer.buildStart","ResolvedConfig.base","ResolvedConfig.root","Logger","ViteDevServer.pluginContainer","createServer"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["path.dirname","dist","path.resolve","path.basename"] |
...
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".mkdir",".writeFile",".unlink",".readFile"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["cursor.to","cursor.restore","erase.line","cursor.down","cursor.save","erase","cursor.move"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["KVNamespace.delete","KVNamespace.put","Crypto.getRandomValues","KVNamespace.get","CfProperties","CacheStorage","EventContext","IncomingRequestCfProperties","Request","Request.clone","Request.url","Response.body","EventContext.request","Response.status","EventContext.env","Request.headers","Console.error","Response","Headers.delete","Request.cf","EventContext.waitUntil","EventContext.passThroughOnException"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["EventContext.request","Request.cf","EventContext.waitUntil","EventContext.passThroughOnException","Request.clone","Request.url","EventContext","Response.body","Response.status","EventContext.env","Request.headers","Console.error","Response","Headers.delete","CfProperties","CacheStorage","IncomingRequestCfProperties","Request"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["VariableDeclaration.declarations","Identifier.name","VariableDeclarator.init","LVal.type","VariableDeclarator.id","StringLiteral.value"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["Logger.info","ResolvedConfig.logger","Plugin.name","createServer","ViteDevServer.config","ViteDevServer.listen","ViteDevServer.printUrls","ViteDevServer.bindCLIShortcuts","ResolvedConfig.plugins"] |
...
| react-router-node | @types/stream | 9 | 10 | 7 | 17 | 8 | 242.85714285714286 | ["Stream.Writable.destroy","Stream.Writable","Stream.Writable.write","Stream.Writable.end","Stream.Readable"] |
...
| react-router-node | promises | 4 | 7 | 7 | 17 | 8 | 242.85714285714286 | [".mkdir",".writeFile",".unlink",".readFile"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["ViteNodeRunner.moduleCache","path.relative","dist","ModuleCacheMap.clear","path.normalize","path.resolve","path.join","path.dirname","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["_default.watch","FSWatcher.add","FSWatcher.on","FSWatcher.unwatch","esm"] |
...
| stream | @types/stream | 9 | 10 | 4 | 7 | 3 | 175 | ["Stream.Writable.end","Stream.Writable.write","Stream.Writable.destroy","Stream.Writable","Stream.Readable"] |
| stream | @types/buffer | 2 | 2 | 4 | 7 | 3 | 175 | ["global.BufferConstructor.concat","global.Buffer.toString"] |
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.to","cursor.hide","erase","erase.line"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BooleanSchema","OptionalSchema","optional","boolean","lazy","object","custom","array","ArraySchema","ObjectSchema","BaseSchema","BaseIssue","NotValueAction","string","notValue","CustomIssue","CustomSchema","StringSchema","pipe","SchemaWithPipe","LazySchema","isAbsolute","relative","flatten","safeParse"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["File","isFunctionDeclaration","isExportDefaultDeclaration","ExportNamedDeclaration.declaration","isImportDeclaration","Identifier.name","isExportNamedDeclaration","File.program","ExportNamedDeclaration.specifiers","isVariableDeclaration","isExportAllDeclaration","isNodesEquivalent","isExportDeclaration","Program.body","VariableDeclaration.declarations","ImportDeclaration.specifiers","isClassDeclaration"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Response.end","e.Response.append","e.Response.flushHeaders","e.Response","e.Response.status","e.Response.statusMessage","e.Request","e.Request.originalUrl","e.Request.method","e.Request.protocol","e.Request.app","e.Request.get","e.Request.headers","e.Request.hostname","e.Response.on","e.NextFunction"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2","APIGatewayProxyResultV2","APIGatewayEventRequestContextV2","APIGatewayProxyStructuredResultV2","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.headers","APIGatewayProxyEventHeaders.host","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventV2.rawPath","APIGatewayEventRequestContextV2.domainName"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.posix","path.PlatformPath.extname","path.PlatformPath.relative","path.PlatformPath.join","path.PlatformPath.dirname","path.PlatformPath.win32","path.PlatformPath.sep"] |
...
| utils | @types/process | 7 | 9 | 149 | 29 | 12 | 19.46308724832215 | ["global.NodeJS.WriteStream","global.NodeJS.Process.stderr","global.NodeJS.ProcessEnv.TERM","global.NodeJS.Process.env","global.NodeJS.Process.stdout"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["erase","erase.lines","cursor.to","erase.line","cursor"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key.ctrl","Key.meta","Key","Key.name"] |
...
| routeModules | @types/react | 12 | 170 | 21 | 3 | 1 | 14.285714285714285 | ["React.ComponentClass","React.ReactElement","React.FunctionComponent"] |
