...
| @types/buffer | 6 | 4 | 12 | 13 | 139 | 640 | ["<createReactRouterRequest> of module <server> imports <global.BufferConstructor.from> from external module <buffer>","<createReactRouterRequest> of module <server> imports <global.Buffer.toString> from external module <buffer>","<readableStreamToString> of module <react-router-node> imports <global.Buffer.toString> from external module <buffer>","<readableStreamToString> of module <react-router-node> imports <global.BufferConstructor.concat> from external module <buffer>"] |
...
| readline | 6 | 6 | 10 | 104 | 139 | 640 | ["<ConfirmPrompt> of module <prompts-confirm> imports <Key> from external module <readline>","<MultiSelectPrompt> of module <prompts-multi-select> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Interface.close> from external module <readline>"] |
| sisteransi | 6 | 6 | 27 | 292 | 139 | 640 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 640 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external module <workers-types>"] |
...
| @types/api-gateway-proxy | 2 | 5 | 23 | 30 | 139 | 640 | ["<RequestHandler> of module <server> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyEventV2> from external module <api-gateway-proxy>","<RequestHandler> of module <server> imports <APIGatewayProxyResultV2> from external module <api-gateway-proxy>","<RequestHandler> of module <react-router-architect> imports <APIGatewayEventRequestContextV2> from external module <api-gateway-proxy>"] |
| @types/express | 2 | 4 | 25 | 29 | 139 | 640 | ["<GetLoadContextFunction> of module <react-router-express> imports <e.Request> from external module <express>","<GetLoadContextFunction> of module <react-router-express> imports <e.Response> from external module <express>","<GetLoadContextFunction> of module <server> imports <e.Request> from external module <express>","<GetLoadContextFunction> of module <server> imports <e.Response> from external module <express>"] |
| @types/express-serve-static-core | 2 | 3 | 5 | 5 | 139 | 640 | ["<GetLoadContextFunction> of module <react-router-express> imports <ParamsDictionary> from external module <express-serve-static-core>","<GetLoadContextFunction> of module <server> imports <ParamsDictionary> from external module <express-serve-static-core>","<RequestHandler> of module <server> imports <ParamsDictionary> from external module <express-serve-static-core>","<RequestHandler> of module <react-router-express> imports <ParamsDictionary> from external module <express-serve-static-core>"] |
| @types/handler | 2 | 1 | 4 | 4 | 139 | 640 | ["<RequestHandler> of module <server> imports <Context> from external module <handler>","<RequestHandler> of module <server> imports <Callback> from external module <handler>","<RequestHandler> of module <react-router-architect> imports <Context> from external module <handler>","<RequestHandler> of module <react-router-architect> imports <Callback> from external module <handler>"] |
...
| @types/qs | 2 | 3 | 5 | 5 | 139 | 640 | ["<GetLoadContextFunction> of module <react-router-express> imports <QueryString.ParsedQs> from external module <qs>","<GetLoadContextFunction> of module <server> imports <QueryString.ParsedQs> from external module <qs>","<RequestHandler> of module <server> imports <QueryString.ParsedQs> from external module <qs>","<RequestHandler> of module <react-router-express> imports <QueryString.ParsedQs> from external module <qs>"] |
| @types/stream | 2 | 3 | 18 | 20 | 139 | 640 | ["<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>","<writeReadableStreamToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| no namespace | 53 | 97 | 593 | 1643 | 139 | 640 | ["<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external namespace <>","<copyTemplate> of module <copy-template> imports <node:url> from external namespace <>","<Context> of module <create-react-router> imports <node:process> from external namespace <>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external namespace <>"] |
...
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 640 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external namespace <@cloudflare>"] |
| @architect | 2 | 1 | 10 | 14 | 139 | 640 | ["<createArcTableSessionStorage> of module <react-router-architect> imports <tables> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <ArcTable.put> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <functions> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <ArcTable.delete> from external namespace <@architect>"] |
...
| @architect/functions | 2 | 4 | 2 | 2 | 2 | 2 | 0 | 2 | 1 | 1 | 1 | 1 | 0 | 0.15625 | 0.15625 | 0.15625 | 0.15625 | 0 | ["react-router-architect","arcTableSessionStorage"] |
| @architect/tables | 2 | 6 | 3 | 3 | 3 | 3 | 0 | 2 | 1 | 1 | 1 | 1 | 0 | 0.15625 | 0.15625 | 0.15625 | 0.15625 | 0 | ["react-router-architect","arcTableSessionStorage"] |
...
| @types/api-gateway-proxy | 2 | 17 | 3 | 14 | 8.5 | 8.5 | 7.7781745930520225 | 7 | 2 | 5 | 3.5 | 3.5 | 2.1213203435596424 | 0.3125 | 0.78125 | 0.546875 | 0.546875 | 0.33145630368119416 | ["server","react-router-architect"] |
| @types/express | 2 | 18 | 3 | 15 | 9 | 9 | 8.48528137423857 | 6 | 2 | 4 | 3 | 3 | 1.4142135623730951 | 0.3125 | 0.625 | 0.46875 | 0.46875 | 0.2209708691207961 | ["react-router-express","server"] |
| @types/express-serve-static-core | 2 | 2 | 1 | 1 | 1 | 1 | 0 | 5 | 2 | 3 | 2.5 | 2.5 | 0.7071067811865476 | 0.3125 | 0.46875 | 0.390625 | 0.390625 | 0.11048543456039805 | ["react-router-express","server"] |
| @types/handler | 2 | 4 | 2 | 2 | 2 | 2 | 0 | 2 | 1 | 1 | 1 | 1 | 0 | 0.15625 | 0.15625 | 0.15625 | 0.15625 | 0 | ["server","react-router-architect"] |
| @types/jsesc | 2 | 2 | 1 | 1 | 1 | 1 | 0 | 2 | 1 | 1 | 1 | 1 | 0 | 0.15625 | 0.15625 | 0.15625 | 0.15625 | 0 | ["plugin","vite"] |
| @types/qs | 2 | 2 | 1 | 1 | 1 | 1 | 0 | 5 | 2 | 3 | 2.5 | 2.5 | 0.7071067811865476 | 0.3125 | 0.46875 | 0.390625 | 0.390625 | 0.11048543456039805 | ["react-router-express","server"] |
...
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".unlink",".mkdir",".writeFile",".readFile"] |
...
| prompts-text | sisteransi | 7 | 91 | 2 | 8 | 2 | 400 | ["cursor.down","erase","erase.line","cursor.move","cursor.restore","cursor.save","cursor.to"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["KVNamespace.delete","KVNamespace.get","Crypto.getRandomValues","KVNamespace.put","EventContext","IncomingRequestCfProperties","Request","CfProperties","CacheStorage","Response","EventContext.request","Console.error","Request.clone","Request.headers","Response.status","EventContext.env","Headers.delete","Response.body","Request.url","EventContext.waitUntil","EventContext.passThroughOnException","Request.cf"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Response","EventContext","EventContext.waitUntil","EventContext.passThroughOnException","Request.cf","EventContext.request","Console.error","Request.clone","Request.headers","Response.status","EventContext.env","Headers.delete","Response.body","Request.url","IncomingRequestCfProperties","Request","CfProperties","CacheStorage"] |
...
| prompts-multi-select | sisteransi | 4 | 52 | 2 | 5 | 2 | 250 | ["erase","cursor.hide","cursor.to","erase.line"] |
...
| react-router-node | @types/stream | 9 | 10 | 7 | 17 | 8 | 242.85714285714286 | ["Stream.Writable.end","Stream.Writable.write","Stream.Writable.destroy","Stream.Writable","Stream.Readable"] |
...
| react-router-node | promises | 4 | 7 | 7 | 17 | 8 | 242.85714285714286 | [".unlink",".mkdir",".writeFile",".readFile"] |
...
| prompts-select | sisteransi | 4 | 52 | 3 | 6 | 3 | 200 | ["erase","cursor.hide","erase.line","cursor.to"] |
...
| stream | @types/stream | 9 | 10 | 4 | 7 | 3 | 175 | ["Stream.Readable","Stream.Writable.end","Stream.Writable.write","Stream.Writable.destroy","Stream.Writable"] |
| stream | @types/buffer | 2 | 2 | 4 | 7 | 3 | 175 | ["global.Buffer.toString","global.BufferConstructor.concat"] |
| prompts-confirm | sisteransi | 4 | 52 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.hide","erase","erase.line","cursor.to"] |
...
| server | @types/express | 20 | 24 | 41 | 50 | 14 | 121.95121951219512 | ["e.Request","e.Response","e.NextFunction","e.Request.headers","e.Request.protocol","e.Request.get","e.Request.hostname","e.Response.on","e.Request.originalUrl","e.Request.method","e.Response.statusMessage","e.Response.append","e.Response.status","e.Response.flushHeaders","e.Response.end"] |
| server | @types/api-gateway-proxy | 18 | 25 | 41 | 50 | 14 | 121.95121951219512 | ["APIGatewayEventRequestContextV2","APIGatewayProxyEventV2","APIGatewayProxyStructuredResultV2","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.headers","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventHeaders","APIGatewayProxyResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.win32","path.PlatformPath.sep","path.PlatformPath.join","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.relative","path.PlatformPath.extname"] |
...
| cookies | dist | 7 | 19 | 6 | 6 | 2 | 100 | ["Cookies.name","serialize","parse","SerializeOptions","ParseOptions","StringifyOptions"] |
...
| sessions | dist | 6 | 32 | 11 | 5 | 1 | 45.45454545454546 | ["SerializeOptions.maxAge","SerializeOptions.expires","SerializeOptions","ParseOptions","StringifyOptions"] |
| context | @types/react | 27 | 51 | 21 | 9 | 1 | 42.857142857142854 | ["React.createContext","React.Context","React.ProviderProps","React.FunctionComponentElement","React.createElement","React.Context.Provider","React.ReactNode","React.ReactElement","React.useContext"] |
