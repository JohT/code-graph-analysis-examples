...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 139 | 645 | ["<reactRouterRSCVitePlugin> of module <vite> imports <PreviewServer.middlewares> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <PluginOption> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <UserConfig.logLevel> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Connect.IncomingMessage.url> from external module <node>"] |
| @types/process | 19 | 21 | 48 | 97 | 139 | 645 | ["<getBuildTimeHeader> of module <dev> imports <global.NodeJS.ProcessEnv.hasOwnProperty> from external module <process>","<getBuildTimeHeader> of module <dev> imports <global.NodeJS.Process.env> from external module <process>","<getBuildTimeHeader> of module <dev> imports <global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST> from external module <process>","<Context> of module <create-react-router> imports <global.NodeJS.WriteStream> from external module <process>"] |
...
| @types/babel__generator | 6 | 8 | 13 | 15 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult.code> from external module <babel__generator>","<reactRouterVitePlugin> of module <plugin> imports <GeneratorResult> from external module <babel__generator>","<reactRouterVitePlugin> of module <vite> imports <GeneratorResult.code> from external module <babel__generator>","<reactRouterVitePlugin> of module <vite> imports <GeneratorResult> from external module <babel__generator>"] |
| @types/buffer | 6 | 4 | 12 | 13 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <global.NonSharedBuffer.toString> from external module <buffer>","<reactRouterVitePlugin> of module <vite> imports <global.NonSharedBuffer.toString> from external module <buffer>","<createReactRouterRequest> of module <server> imports <global.Buffer.toString> from external module <buffer>","<createReactRouterRequest> of module <server> imports <global.BufferConstructor.from> from external module <buffer>"] |
| fs | 6 | 6 | 17 | 27 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isDirectory> from external module <fs>","<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>"] |
...
| sisteransi | 6 | 6 | 27 | 116 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <Identifier.name> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportDeclaration.type> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external module <workers-types>"] |
| @types/babel__core | 3 | 2 | 8 | 9 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.map> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <BabelFileResult.code> from external module <babel__core>","<reactRouterVitePlugin> of module <plugin> imports <transformAsync> from external module <babel__core>","<reactRouterVitePlugin> of module <vite> imports <BabelFileResult.map> from external module <babel__core>"] |
| @types/babel__traverse | 3 | 3 | 17 | 49 | 139 | 645 | ["<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>"] |
...
| node:url | 3 | 2 | 4 | 6 | 139 | 645 | ["<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external module <node:url>","<copyTemplate> of module <copy-template> imports <node:url> from external module <node:url>","<reactRouterVitePlugin> of module <plugin> imports <.pathToFileURL> from external module <node:url>","<reactRouterVitePlugin> of module <vite> imports <.pathToFileURL> from external module <node:url>"] |
...
| @types/stream | 2 | 3 | 18 | 20 | 139 | 645 | ["<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>"] |
...
| crypto | 2 | 1 | 4 | 4 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <Hash.update> from external module <crypto>","<reactRouterVitePlugin> of module <plugin> imports <Hash.digest> from external module <crypto>","<reactRouterVitePlugin> of module <vite> imports <Hash.update> from external module <crypto>","<reactRouterVitePlugin> of module <vite> imports <Hash.digest> from external module <crypto>"] |
| esm | 2 | 2 | 6 | 7 | 139 | 645 | ["<flatRoutes> of module <flatRoutes> imports <makeRe> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.unwatch> from external module <esm>","<createConfigLoader> of module <config> imports <esm> from external module <esm>","<createConfigLoader> of module <config> imports <FSWatcher.add> from external module <esm>"] |
...
| rollup | 2 | 1 | 6 | 10 | 139 | 645 | ["<reactRouterVitePlugin> of module <plugin> imports <PluginContext.resolve> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <PluginContext.environment> from external module <rollup>","<reactRouterVitePlugin> of module <plugin> imports <ResolvedId.id> from external module <rollup>","<reactRouterVitePlugin> of module <vite> imports <PluginContext.resolve> from external module <rollup>"] |
...
| @babel | 5 | 7 | 68 | 148 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <Identifier.name> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ExportDeclaration.type> from external namespace <@babel>"] |
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external namespace <@cloudflare>"] |
| @architect | 2 | 1 | 10 | 14 | 139 | 645 | ["<createArcTableSessionStorage> of module <react-router-architect> imports <tables> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <ArcTable.get> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <ArcTable.put> from external namespace <@architect>","<createArcTableSessionStorage> of module <react-router-architect> imports <functions> from external namespace <@architect>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["Identifier.name","ExportDeclaration.type","VariableDeclarator.id","MemberExpression.object","LVal.type","ExportNamedDeclaration.specifiers","ExpressionStatement.expression","ExportNamedDeclaration.declaration","ExportSpecifier.exported","ExportDefaultDeclaration.declaration","ExportSpecifier.local","AssignmentExpression.left","FunctionDeclaration.id","ClassDeclaration.id","VariableDeclaration.declarations","Expression.type"] |
| remove-exports | @types/babel__traverse | 4 | 24 | 1 | 23 | 4 | 2300 | ["NodePath.remove","NodePath.node","NodePath.isProgram","NodePath.parentPath"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["PreviewServer.middlewares","PluginOption","UserConfig.logLevel","Connect.IncomingMessage.url","Logger.error","Logger.info","UserConfig.server","transformWithEsbuild","createLogger","ResolvedConfig.environments","ResolvedConfig.base","normalizePath","ResolvedEnvironmentOptions.build","UserConfig.base","Connect.Server.use","ResolvedBuildEnvironmentOptions.outDir","ManifestChunk.file","defaultClientConditions","RunnableDevEnvironment.runner","ResolvedBuildOptions.assetsDir","ResolvedConfig.build","ConfigEnv.isSsrBuild","ViteBuilder.environments","EnvironmentOptions.optimizeDeps","HotUpdatePluginContext.environment","DevEnvironment.reloadModule","UserConfig.environments","DevEnvironment.moduleGraph","ResolvedConfig.logger","UserConfig.root","ViteDevServer.environments","ResolvedConfig.mode","ViteDevServer.transformRequest","UserConfig.build","ResolvedConfig.root","Logger.warn","DevEnvironment.name","ModuleNode.url","Environment.config","ManifestChunk.css","EnvironmentOptions","HotBroadcaster.send","ResolvedConfig","Plugin.name","Plugin","ResolvedServerOptions.watch","ViteDevServer.ssrFixStacktrace","isRunnableDevEnvironment","UserConfig.plugins","ViteDevServer.middlewares","ManifestChunk.assets","ConfigEnv.mode","ViteDevServer.config","ResolvedConfig.configFile","ViteDevServer.hot","ViteBuilder.build","Environment.name","ViteDevServer.pluginContainer","ConfigEnv.command","EnvironmentOptions.resolve","ResolvedServerOptions.middlewareMode","ResolvedConfig.command","ResolvedConfig.server","PreviewServer","createServer","PluginContainer.buildStart","ViteDevServer.ssrLoadModule","loadConfigFromFile","ViteDevServer","ModuleNode.file","version","ESBuildOptions","node"] |
| vite | @types/process | 7 | 15 | 6 | 129 | 25 | 2150 | ["global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.Process.cwd","global.NodeJS.Process.exit"] |
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["resolve","path.normalize","dist","relative","join","path.join","path.extname"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","cp","rm","mkdir","readdir","rename"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.resolve","path.PlatformPath.relative","path.PlatformPath.join","path.PlatformPath.basename"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.scope","NodePath.get","Scope.generateUidIdentifier","NodePath.replaceWith","NodePath.isFunctionDeclaration","NodePath.isExportNamedDeclaration","NodePath.isIdentifier","NodePath.isVariableDeclaration","NodePath.isExpression","NodePath.node","NodePath.isExportDefaultDeclaration"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["identifier","Program.body","variableDeclarator","stringLiteral","callExpression","importSpecifier","importDeclaration","variableDeclaration"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult.program","ParseResult"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.config","ResolvedConfig.server","ViteDevServer.ssrLoadModule","Connect.Server.use","ViteDevServer.middlewares","EnvironmentOptions.resolve","Plugin.name","UserConfig.root","ConfigEnv.mode","ResolvedServerOptions.middlewareMode","EnvironmentResolveOptions.externalConditions","Plugin","ResolvedConfig.plugins"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["ViteDevServer.config","ResolvedConfig.server","ViteDevServer.ssrLoadModule","Connect.Server.use","ViteDevServer.middlewares","EnvironmentOptions.resolve","Plugin.name","UserConfig.root","ConfigEnv.mode","ResolvedServerOptions.middlewareMode","EnvironmentResolveOptions.externalConditions","Plugin","ResolvedConfig.plugins"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedConfig.environments","ResolvedConfig.mode","ResolvedConfig.logger","ResolvedConfig.build","Logger.warn","ResolvedBuildOptions.ssr","ResolvedBuildEnvironmentOptions.sourcemap","ResolvedEnvironmentOptions.build","ConfigEnv.command","Plugin","ResolvedBuildOptions.sourcemap"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig","resolveConfig","ResolvedConfig.build","Plugin","ResolvedBuildOptions.manifest","ModuleNode","ViteDevServer","UserConfig.base","ManifestChunk.file","Logger.info","defaultClientConditions","RunnableDevEnvironment.runner","ResolvedBuildOptions.assetsDir","ConfigEnv.isSsrBuild","ViteBuilder.environments","EnvironmentOptions.optimizeDeps","HotUpdatePluginContext.environment","DevEnvironment.reloadModule","UserConfig.environments","createLogger","DevEnvironment.moduleGraph","ResolvedConfig.logger","Connect.Server.use","UserConfig.root","ViteDevServer.environments","ResolvedConfig.mode","ViteDevServer.transformRequest","UserConfig.build","ResolvedConfig.root","PreviewServer.middlewares","Logger.warn","DevEnvironment.name","ModuleNode.url","Environment.config","ManifestChunk.css","EnvironmentOptions","HotBroadcaster.send","Plugin.name","normalizePath","Logger.error","ResolvedServerOptions.watch","ViteDevServer.ssrFixStacktrace","isRunnableDevEnvironment","UserConfig.plugins","ViteDevServer.middlewares","ManifestChunk.assets","ConfigEnv.mode","ViteDevServer.config","ResolvedConfig.configFile","ViteDevServer.hot","ViteBuilder.build","UserConfig.logLevel","Connect.IncomingMessage.url","UserConfig.server","Environment.name","ViteDevServer.pluginContainer","ConfigEnv.command","EnvironmentOptions.resolve","ResolvedServerOptions.middlewareMode","ResolvedConfig.command","ResolvedConfig.server","PreviewServer","createServer","PluginContainer.buildStart","ViteDevServer.ssrLoadModule","loadConfigFromFile","ModuleNode.file","defaultServerConditions","ResolvedBuildOptions.emptyOutDir","PluginOption","transformWithEsbuild","ResolvedConfig.environments","ResolvedConfig.base","ResolvedEnvironmentOptions.build","ResolvedBuildEnvironmentOptions.outDir"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.basename","path.PlatformPath.isAbsolute"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["cp","rm","readFile","mkdir","readdir","rename"] |
| plugin | @types/process | 7 | 15 | 18 | 135 | 26 | 750 | ["global.NodeJS.ProcessEnv.REACT_ROUTER_ROOT","global.NodeJS.ProcessEnv.IS_RR_BUILD_REQUEST","global.NodeJS.Process.cwd","global.NodeJS.Process.exit","global.NodeJS.Process.env"] |
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["resolve","path.normalize","dist","relative","join","path.join","path.extname"] |
...
| plugin | node:fs | 5 | 10 | 18 | 135 | 26 | 750 | ["readdirSync","existsSync","rmSync","readFileSync"] |
...
| prompts-prompt-base | @types/process | 4 | 20 | 2 | 14 | 6 | 700 | ["global.NodeJS.WriteStream","global.NodeJS.ReadStream","global.NodeJS.Process.stdout","global.NodeJS.Process.stdin"] |
| prompts-prompt-base | node:readline | 3 | 20 | 2 | 14 | 6 | 700 | [".createInterface","node:readline",".emitKeypressEvents"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ViteDevServer","Logger","ViteDevServer.config","ViteDevServer.pluginContainer","createServer","ResolvedConfig.base","ResolvedConfig.root","PluginContainer.buildStart"] |
| vite-node | server | 4 | 4 | 2 | 13 | 4 | 650 | ["ViteNodeServer","ViteNodeServer.getSourceMap","ViteNodeServer.fetchModule","ViteNodeServer.resolveId"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["cursor.down","erase","cursor.to","erase.line","cursor.restore","cursor.move","cursor.save"] |
...
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["KVNamespace.delete","Crypto.getRandomValues","KVNamespace.put","KVNamespace.get","CfProperties","CacheStorage","EventContext","IncomingRequestCfProperties","Request","Request.url","Response","Response.status","Request.clone","EventContext.request","Response.body","Headers.delete","EventContext.env","Console.error","Request.headers","EventContext.passThroughOnException","Request.cf","EventContext.waitUntil"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["EventContext.passThroughOnException","EventContext.request","Request.cf","EventContext.waitUntil","Request.url","Response","EventContext","Response.status","Request.clone","Response.body","Headers.delete","EventContext.env","Console.error","Request.headers","CfProperties","CacheStorage","IncomingRequestCfProperties","Request"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["StringLiteral.value","VariableDeclaration.declarations","VariableDeclarator.id","Identifier.name","LVal.type","VariableDeclarator.init"] |
...
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["Plugin.name","ResolvedConfig.plugins","createServer","ViteDevServer.bindCLIShortcuts","ViteDevServer.printUrls","ResolvedConfig.logger","ViteDevServer.listen","ViteDevServer.config","Logger.info"] |
...
| prompts-multi-select | sisteransi | 4 | 20 | 2 | 5 | 2 | 250 | ["erase","erase.line","cursor.to","cursor.hide"] |
...
| react-router-node | @types/stream | 9 | 10 | 7 | 17 | 8 | 242.85714285714286 | ["Stream.Writable","Stream.Writable.end","Stream.Writable.write","Stream.Writable.destroy","Stream.Readable"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["ModuleCacheMap.clear","ViteNodeRunner.moduleCache","path.normalize","dist","path.relative","path.resolve","path.dirname","path.join","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.unwatch","esm","FSWatcher.add","FSWatcher.on","_default.watch"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["createLogger","ViteDevServer.moduleGraph","ViteDevServer.close","ModuleGraph.getModuleById","ModuleGraph.invalidateAll"] |
...
| prompts-select | sisteransi | 4 | 20 | 3 | 6 | 3 | 200 | ["erase","cursor.to","erase.line","cursor.hide"] |
...
| stream | @types/stream | 9 | 10 | 4 | 7 | 3 | 175 | ["Stream.Writable.end","Stream.Writable.destroy","Stream.Writable","Stream.Writable.write","Stream.Readable"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BaseSchema","notValue","LazySchema","custom","SchemaWithPipe","optional","CustomSchema","object","NotValueAction","CustomIssue","ObjectSchema","ArraySchema","OptionalSchema","StringSchema","BooleanSchema","lazy","string","boolean","pipe","BaseIssue","array","isAbsolute","relative","safeParse","flatten"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["File","isExportDeclaration","isExportNamedDeclaration","ExportNamedDeclaration.declaration","Program.body","ExportNamedDeclaration.specifiers","isFunctionDeclaration","Identifier.name","isExportDefaultDeclaration","isClassDeclaration","VariableDeclaration.declarations","File.program","isNodesEquivalent","isImportDeclaration","ImportDeclaration.specifiers","isExportAllDeclaration","isVariableDeclaration"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Response.end","e.Response.statusMessage","e.Response","e.Response.flushHeaders","e.Response.append","e.Response.status","e.Request","e.Request.hostname","e.Request.headers","e.Request.method","e.Request.app","e.Request.protocol","e.Response.on","e.Request.originalUrl","e.Request.get","e.NextFunction"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2","APIGatewayProxyResultV2","APIGatewayEventRequestContextV2","APIGatewayProxyStructuredResultV2","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventHeaders.host","APIGatewayProxyEventV2.requestContext","APIGatewayEventRequestContextV2.http","APIGatewayEventRequestContextV2.domainName"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.posix","path.PlatformPath.join","path.PlatformPath.dirname","path.PlatformPath.relative","path.PlatformPath.extname","path.PlatformPath.sep","path.PlatformPath.win32"] |
...
| utils | @types/process | 7 | 9 | 149 | 29 | 12 | 19.46308724832215 | ["global.NodeJS.WriteStream","global.NodeJS.Process.stderr","global.NodeJS.Process.env","global.NodeJS.ProcessEnv.TERM","global.NodeJS.Process.stdout"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["erase","erase.lines","erase.line","cursor.to","cursor"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key.name","Key.meta","Key.ctrl","Key"] |
...
| routeModules | @types/react | 12 | 170 | 21 | 3 | 1 | 14.285714285714285 | ["React.ReactElement","React.ComponentClass","React.FunctionComponent"] |
