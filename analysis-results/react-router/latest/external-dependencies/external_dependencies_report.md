...
| --- | --- | --- | --- | --- | --- | --- | --- |
| node | 22 | 30 | 263 | 422 | 139 | 645 | ["<reactRouterRSCVitePlugin> of module <vite> imports <Connect.IncomingMessage.url> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <Logger.error> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <PreviewServer.middlewares> from external module <node>","<reactRouterRSCVitePlugin> of module <vite> imports <ResolvedBuildEnvironmentOptions.outDir> from external module <node>"] |
...
| readline | 6 | 6 | 10 | 56 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <Key> from external module <readline>","<MultiSelectPrompt> of module <prompts-multi-select> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Interface.close> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Key> from external module <readline>"] |
| sisteransi | 6 | 6 | 27 | 116 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>"] |
| @babel/lib | 5 | 7 | 65 | 143 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external module <lib>","<transpile> of module <useJavascript> imports <lib> from external module <lib>","<removeExports> of module <remove-exports> imports <ExportNamedDeclaration.declaration> from external module <lib>","<removeExports> of module <remove-exports> imports <ClassDeclaration.id> from external module <lib>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external module <workers-types>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external module <workers-types>"] |
...
| @types/babel__traverse | 3 | 3 | 17 | 49 | 139 | 645 | ["<removeExports> of module <remove-exports> imports <NodePath.node> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.parentPath> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.isProgram> from external module <babel__traverse>","<removeExports> of module <remove-exports> imports <NodePath.remove> from external module <babel__traverse>"] |
...
| @types/stream | 2 | 3 | 18 | 20 | 139 | 645 | ["<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.destroy> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.write> from external module <stream>","<writeAsyncIterableToWritable> of module <react-router-node> imports <Stream.Writable.end> from external module <stream>"] |
...
| @babel | 5 | 7 | 68 | 148 | 139 | 645 | ["<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<transpile> of module <useJavascript> imports <lib> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ExportNamedDeclaration.declaration> from external namespace <@babel>","<removeExports> of module <remove-exports> imports <ClassDeclaration.id> from external namespace <@babel>"] |
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 645 | ["<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.put> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.delete> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <KVNamespace.get> from external namespace <@cloudflare>","<createWorkersKVSessionStorage> of module <react-router-cloudflare> imports <Crypto.getRandomValues> from external namespace <@cloudflare>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| remove-exports | @babel/lib | 16 | 56 | 1 | 23 | 4 | 2300 | ["ExportNamedDeclaration.declaration","ClassDeclaration.id","ExportSpecifier.local","FunctionDeclaration.id","VariableDeclaration.declarations","ExportDefaultDeclaration.declaration","ExportNamedDeclaration.specifiers","Expression.type","VariableDeclarator.id","AssignmentExpression.left","MemberExpression.object","ExpressionStatement.expression","ExportSpecifier.exported","ExportDeclaration.type","Identifier.name","LVal.type"] |
| remove-exports | @types/babel__traverse | 4 | 24 | 1 | 23 | 4 | 2300 | ["NodePath.node","NodePath.parentPath","NodePath.isProgram","NodePath.remove"] |
...
| vite | node | 84 | 148 | 6 | 129 | 25 | 2150 | ["Connect.IncomingMessage.url","Logger.error","PreviewServer.middlewares","ResolvedBuildEnvironmentOptions.outDir","ResolvedConfig.environments","transformWithEsbuild","ResolvedConfig.base","Logger.info","UserConfig.logLevel","UserConfig.server","Connect.Server.use","PluginOption","createLogger","normalizePath","ResolvedEnvironmentOptions.build","UserConfig.base","isRunnableDevEnvironment","HotBroadcaster.send","ResolvedConfig.root","ViteBuilder.build","ViteDevServer","EnvironmentOptions.resolve","DevEnvironment.moduleGraph","ViteBuilder.environments","ResolvedConfig.logger","ResolvedConfig.command","UserConfig.plugins","ResolvedServerOptions.watch","RunnableDevEnvironment.runner","Environment.config","ResolvedConfig.mode","Environment.name","ViteDevServer.ssrFixStacktrace","EnvironmentOptions.optimizeDeps","Plugin.name","ResolvedServerOptions.middlewareMode","defaultClientConditions","ResolvedConfig","ViteDevServer.ssrLoadModule","DevEnvironment.name","UserConfig.build","ResolvedBuildOptions.assetsDir","ResolvedConfig.configFile","ResolvedConfig.server","PluginContainer.buildStart","UserConfig.environments","PreviewServer","ManifestChunk.assets","ViteDevServer.hot","ManifestChunk.css","ViteDevServer.pluginContainer","ViteDevServer.environments","ViteDevServer.middlewares","ViteDevServer.config","ManifestChunk.file","loadConfigFromFile","DevEnvironment.reloadModule","ConfigEnv.isSsrBuild","HotUpdatePluginContext.environment","ModuleNode.url","Logger.warn","ModuleNode.file","ViteDevServer.transformRequest","ConfigEnv.command","ConfigEnv.mode","EnvironmentOptions","createServer","ResolvedConfig.build","Plugin","UserConfig.root","version","ESBuildOptions","node"] |
...
| vite | dist | 7 | 23 | 6 | 129 | 25 | 2150 | ["dist","join","relative","resolve","path.join","path.extname","path.normalize"] |
| vite | promises | 7 | 14 | 6 | 129 | 25 | 2150 | ["readFile","rename","cp","rm","mkdir","readdir"] |
| vite | @types/path | 6 | 25 | 6 | 129 | 25 | 2150 | ["path.PlatformPath.basename","path.PlatformPath.resolve","path.PlatformPath.posix","path.PlatformPath.relative","path.PlatformPath.join","path.PlatformPath.dirname"] |
| vite | fs | 5 | 10 | 6 | 129 | 25 | 2150 | ["existsSync","Dirent.isFile","Dirent.parentPath","Dirent.name","Dirent.path"] |
...
| with-props | @types/babel__traverse | 11 | 23 | 1 | 21 | 4 | 2100 | ["NodePath.isExpression","NodePath.isExportNamedDeclaration","NodePath.isExportDefaultDeclaration","NodePath.scope","NodePath.get","NodePath.node","NodePath.isIdentifier","NodePath.replaceWith","NodePath.isVariableDeclaration","Scope.generateUidIdentifier","NodePath.isFunctionDeclaration"] |
| with-props | @babel/lib | 8 | 11 | 1 | 21 | 4 | 2100 | ["variableDeclaration","importSpecifier","identifier","variableDeclarator","Program.body","callExpression","importDeclaration","stringLiteral"] |
| with-props | @babel/babel-parser | 2 | 3 | 1 | 21 | 4 | 2100 | ["ParseResult.program","ParseResult"] |
| cloudflare | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["EnvironmentResolveOptions.externalConditions","ResolvedConfig.server","EnvironmentOptions.resolve","ConfigEnv.mode","ViteDevServer.middlewares","ViteDevServer.ssrLoadModule","Connect.Server.use","ResolvedConfig.plugins","Plugin","Plugin.name","ResolvedServerOptions.middlewareMode","ViteDevServer.config","UserConfig.root"] |
| cloudflare | @types/process | 1 | 1 | 1 | 15 | 4 | 1500 | ["global.NodeJS.Process.cwd"] |
| cloudflare | cli | 1 | 2 | 1 | 15 | 4 | 1500 | ["GetPlatformProxyOptions"] |
| cloudflare-dev-proxy | node | 13 | 18 | 1 | 15 | 4 | 1500 | ["EnvironmentResolveOptions.externalConditions","ResolvedConfig.server","EnvironmentOptions.resolve","ConfigEnv.mode","ViteDevServer.middlewares","ViteDevServer.ssrLoadModule","Connect.Server.use","ResolvedConfig.plugins","Plugin","Plugin.name","ResolvedServerOptions.middlewareMode","ViteDevServer.config","UserConfig.root"] |
...
| warn-on-client-source-maps | node | 11 | 12 | 1 | 12 | 2 | 1200 | ["ResolvedBuildEnvironmentOptions.sourcemap","ResolvedBuildOptions.sourcemap","ResolvedBuildOptions.ssr","ResolvedConfig.environments","ResolvedEnvironmentOptions.build","ResolvedConfig.mode","Plugin","Logger.warn","ResolvedConfig.build","ConfigEnv.command","ResolvedConfig.logger"] |
...
| plugin | node | 96 | 165 | 18 | 135 | 26 | 750 | ["UserConfig","ResolvedConfig.build","resolveConfig","Plugin","ResolvedBuildOptions.manifest","ResolvedConfig","ViteDevServer","ModuleNode","isRunnableDevEnvironment","HotBroadcaster.send","ResolvedConfig.root","ViteBuilder.build","EnvironmentOptions.resolve","DevEnvironment.moduleGraph","ViteBuilder.environments","ResolvedConfig.logger","ResolvedConfig.command","UserConfig.plugins","ResolvedServerOptions.watch","Logger.info","RunnableDevEnvironment.runner","Environment.config","ResolvedConfig.mode","Environment.name","ViteDevServer.ssrFixStacktrace","EnvironmentOptions.optimizeDeps","Plugin.name","ResolvedServerOptions.middlewareMode","defaultClientConditions","ViteDevServer.ssrLoadModule","DevEnvironment.name","UserConfig.build","ResolvedBuildOptions.assetsDir","UserConfig.server","ResolvedConfig.configFile","ResolvedConfig.server","PluginContainer.buildStart","UserConfig.environments","Connect.IncomingMessage.url","PreviewServer","UserConfig.logLevel","PreviewServer.middlewares","ManifestChunk.assets","ViteDevServer.hot","ManifestChunk.css","ViteDevServer.pluginContainer","ViteDevServer.environments","createLogger","ViteDevServer.middlewares","UserConfig.base","ViteDevServer.config","ManifestChunk.file","loadConfigFromFile","Logger.error","DevEnvironment.reloadModule","ConfigEnv.isSsrBuild","Connect.Server.use","HotUpdatePluginContext.environment","ModuleNode.url","Logger.warn","ModuleNode.file","ViteDevServer.transformRequest","ConfigEnv.command","ConfigEnv.mode","EnvironmentOptions","createServer","normalizePath","UserConfig.root","defaultServerConditions","ResolvedBuildOptions.emptyOutDir","ResolvedBuildEnvironmentOptions.outDir","ResolvedConfig.environments","transformWithEsbuild","ResolvedConfig.base","PluginOption","ResolvedEnvironmentOptions.build"] |
| plugin | @types/path | 17 | 41 | 18 | 135 | 26 | 750 | ["path.PlatformPath.resolve","path.PlatformPath.relative","path.PlatformPath.join","path.PlatformPath.basename","path.PlatformPath.posix","path.PlatformPath.dirname","path.PlatformPath.isAbsolute"] |
| plugin | promises | 10 | 18 | 18 | 135 | 26 | 750 | ["readFile","rename","cp","rm","mkdir","readdir"] |
...
| plugin | dist | 7 | 23 | 18 | 135 | 26 | 750 | ["dist","join","relative","resolve","path.join","path.extname","path.normalize"] |
| plugin | fs | 5 | 10 | 18 | 135 | 26 | 750 | ["Dirent.isFile","Dirent.parentPath","Dirent.name","Dirent.path","existsSync"] |
| plugin | http | 5 | 8 | 18 | 135 | 26 | 750 | ["ServerResponse.setHeader","ServerResponse.end","ServerResponse.statusCode"] |
| plugin | node:fs | 5 | 10 | 18 | 135 | 26 | 750 | ["existsSync","readdirSync","rmSync","readFileSync"] |
...
| vite-node | node | 8 | 9 | 2 | 13 | 4 | 650 | ["ViteDevServer","ViteDevServer.pluginContainer","createServer","ViteDevServer.config","ResolvedConfig.base","Logger","PluginContainer.buildStart","ResolvedConfig.root"] |
| vite-node | server | 4 | 4 | 2 | 13 | 4 | 650 | ["ViteNodeServer","ViteNodeServer.getSourceMap","ViteNodeServer.resolveId","ViteNodeServer.fetchModule"] |
...
| is-react-router-repo | dist | 4 | 6 | 1 | 5 | 2 | 500 | ["dist","path.dirname","path.resolve","path.basename"] |
...
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".unlink",".writeFile",".readFile",".mkdir"] |
...
| prompts-text | sisteransi | 7 | 35 | 2 | 8 | 2 | 400 | ["erase","cursor.save","cursor.to","erase.line","cursor.down","cursor.restore","cursor.move"] |
| prompts-text | readline | 1 | 5 | 2 | 8 | 2 | 400 | ["Key"] |
| workersKVStorage | @cloudflare/workers-types | 4 | 6 | 1 | 4 | 1 | 400 | ["KVNamespace.put","KVNamespace.delete","KVNamespace.get","Crypto.getRandomValues"] |
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["KVNamespace.put","KVNamespace.delete","KVNamespace.get","Crypto.getRandomValues","CfProperties","EventContext","CacheStorage","IncomingRequestCfProperties","Request","EventContext.request","Request.headers","Request.clone","Console.error","Response.body","Response.status","EventContext.env","Headers.delete","Request.url","Response","Request.cf","EventContext.waitUntil","EventContext.passThroughOnException"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["Request.cf","EventContext.waitUntil","EventContext.passThroughOnException","EventContext.request","Request.headers","Request.clone","Console.error","Response.body","Response.status","EventContext.env","Headers.delete","Request.url","EventContext","Response","CfProperties","CacheStorage","IncomingRequestCfProperties","Request"] |
...
| styles | @babel/lib | 6 | 8 | 4 | 12 | 5 | 300 | ["Identifier.name","VariableDeclarator.id","VariableDeclaration.declarations","VariableDeclarator.init","StringLiteral.value","LVal.type"] |
...
| validate-plugin-order | node | 3 | 3 | 1 | 3 | 1 | 300 | ["Plugin.name","ResolvedConfig.plugins","Plugin"] |
| dev | node | 9 | 14 | 5 | 14 | 5 | 280 | ["Logger.info","Plugin.name","ResolvedConfig.logger","ViteDevServer.printUrls","ResolvedConfig.plugins","createServer","ViteDevServer.config","ViteDevServer.bindCLIShortcuts","ViteDevServer.listen"] |
...
| react-router-node | promises | 4 | 7 | 7 | 17 | 8 | 242.85714285714286 | [".unlink",".writeFile",".readFile",".mkdir"] |
...
| config | dist | 15 | 43 | 14 | 31 | 15 | 221.42857142857144 | ["path.relative","ViteNodeRunner.moduleCache","path.normalize","ModuleCacheMap.clear","dist","path.join","path.resolve","path.dirname","PackageJson.dependencies"] |
| config | esm | 5 | 6 | 14 | 31 | 15 | 221.42857142857144 | ["FSWatcher.unwatch","esm","_default.watch","FSWatcher.add","FSWatcher.on"] |
| config | node | 5 | 8 | 14 | 31 | 15 | 221.42857142857144 | ["createLogger","ModuleGraph.invalidateAll","ViteDevServer.moduleGraph","ViteDevServer.close","ModuleGraph.getModuleById"] |
...
| prompts-confirm | sisteransi | 4 | 20 | 3 | 5 | 2 | 166.66666666666669 | ["erase.line","erase","cursor.to","cursor.hide"] |
...
| routes | dist | 30 | 96 | 18 | 27 | 4 | 150 | ["resolve","BaseSchema","optional","StringSchema","BooleanSchema","LazySchema","SchemaWithPipe","custom","CustomSchema","ObjectSchema","BaseIssue","ArraySchema","notValue","pipe","lazy","NotValueAction","object","string","CustomIssue","boolean","OptionalSchema","array","relative","isAbsolute","flatten","safeParse"] |
| routes | @types/pick | 3 | 3 | 18 | 27 | 4 | 150 | ["pick"] |
| route-chunks | @babel/lib | 33 | 66 | 13 | 19 | 3 | 146.15384615384616 | ["File","File.program","Program.body","Identifier.name","isImportDeclaration","ExportNamedDeclaration.specifiers","isNodesEquivalent","isExportNamedDeclaration","isClassDeclaration","isExportDefaultDeclaration","ImportDeclaration.specifiers","ExportNamedDeclaration.declaration","isExportAllDeclaration","VariableDeclaration.declarations","isFunctionDeclaration","isExportDeclaration","isVariableDeclaration"] |
| route-chunks | @types/babel__generator | 5 | 5 | 13 | 19 | 3 | 146.15384615384616 | ["GeneratorResult","GeneratorOptions"] |
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Response.statusMessage","e.Response","e.Response.flushHeaders","e.Response.end","e.Response.status","e.Response.append","e.Request","e.Request.originalUrl","e.Request.get","e.Request.protocol","e.Request.hostname","e.Request.method","e.Request.headers","e.Response.on","e.Request.app","e.NextFunction"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyResultV2","APIGatewayEventRequestContextV2","APIGatewayProxyEventV2","APIGatewayProxyStructuredResultV2","APIGatewayEventRequestContextV2.http","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2.body","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.cookies","APIGatewayProxyEventHeaders.host"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.dirname","path.PlatformPath.posix","path.PlatformPath.extname","path.PlatformPath.join","path.PlatformPath.relative","path.PlatformPath.sep","path.PlatformPath.win32"] |
...
| context | @types/react | 27 | 65 | 21 | 9 | 1 | 42.857142857142854 | ["React.Context","React.createContext","React.useContext","React.ReactElement","React.ReactNode","React.FunctionComponentElement","React.Context.Provider","React.createElement","React.ProviderProps"] |
...
| utils | sisteransi | 5 | 6 | 149 | 29 | 12 | 19.46308724832215 | ["cursor.to","erase.line","erase.lines","erase","cursor"] |
...
| utils | readline | 4 | 26 | 149 | 29 | 12 | 19.46308724832215 | ["Key.name","Key.meta","Key","Key.ctrl"] |
...
| routeModules | @types/react | 12 | 170 | 21 | 3 | 1 | 14.285714285714285 | ["React.ReactElement","React.FunctionComponent","React.ComponentClass"] |
