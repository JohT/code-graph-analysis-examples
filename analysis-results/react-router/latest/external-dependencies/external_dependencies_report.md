...
| fs | 6 | 6 | 17 | 27 | 139 | 645 | ["<fileExists> of module <utils> imports <Stats.isFile> from external module <fs>","<directoryExists> of module <utils> imports <Stats.isDirectory> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.name> from external module <fs>","<flatRoutes> of module <flatRoutes> imports <Dirent.isFile> from external module <fs>"] |
| readline | 6 | 6 | 10 | 98 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <Key> from external module <readline>","<MultiSelectPrompt> of module <prompts-multi-select> imports <Key> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Interface.close> from external module <readline>","<Prompt> of module <prompts-prompt-base> imports <Key> from external module <readline>"] |
| sisteransi | 6 | 6 | 27 | 270 | 139 | 645 | ["<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.to> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase> from external module <sisteransi>","<ConfirmPrompt> of module <prompts-confirm> imports <erase.line> from external module <sisteransi>"] |
...
| @cloudflare/workers-types | 3 | 5 | 52 | 68 | 139 | 645 | ["<createPagesFunctionHandler> of module <react-router-cloudflare> imports <EventContext> from external module <workers-types>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <Request.clone> from external module <workers-types>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <EventContext.request> from external module <workers-types>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <Response.body> from external module <workers-types>"] |
...
| @types/stream | 2 | 3 | 18 | 20 | 139 | 645 | ["<writeAsyncIterableToWritable> of module <stream> imports <Stream.Writable.destroy> from external module <stream>","<writeAsyncIterableToWritable> of module <stream> imports <Stream.Writable.write> from external module <stream>","<writeAsyncIterableToWritable> of module <stream> imports <Stream.Writable> from external module <stream>","<writeAsyncIterableToWritable> of module <stream> imports <Stream.Writable.end> from external module <stream>"] |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| no namespace | 53 | 97 | 595 | 1574 | 139 | 645 | ["<copyTemplate> of module <copy-template> imports <node:url> from external namespace <>","<copyTemplate> of module <copy-template> imports <.fileURLToPath> from external namespace <>","<Context> of module <create-react-router> imports <node:process> from external namespace <>","<ConfirmPrompt> of module <prompts-confirm> imports <cursor.hide> from external namespace <>"] |
...
| @cloudflare | 3 | 5 | 52 | 68 | 139 | 645 | ["<createPagesFunctionHandler> of module <react-router-cloudflare> imports <EventContext> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <Request.clone> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <EventContext.request> from external namespace <@cloudflare>","<createPagesFunctionHandler> of module <react-router-cloudflare> imports <Response.body> from external namespace <@cloudflare>"] |
...
| prompts-prompt-base | node:readline | 3 | 48 | 2 | 14 | 6 | 700 | [".emitKeypressEvents","node:readline",".createInterface"] |
| prompts-prompt-base | sisteransi | 3 | 36 | 2 | 14 | 6 | 700 | ["beep","cursor","cursor.show"] |
...
| fileStorage | promises | 4 | 7 | 2 | 9 | 5 | 450 | [".readFile",".unlink",".mkdir",".writeFile"] |
...
| prompts-text | sisteransi | 7 | 84 | 2 | 8 | 2 | 400 | ["cursor.down","erase","cursor.save","cursor.restore","cursor.to","erase.line","cursor.move"] |
| prompts-text | readline | 1 | 12 | 2 | 8 | 2 | 400 | ["Key"] |
| workersKVStorage | @cloudflare/workers-types | 4 | 6 | 1 | 4 | 1 | 400 | ["KVNamespace.delete","KVNamespace.put","Crypto.getRandomValues","KVNamespace.get"] |
| react-router-cloudflare | @cloudflare/workers-types | 26 | 34 | 6 | 22 | 2 | 366.6666666666667 | ["EventContext","Request.clone","EventContext.request","Response.body","Request.headers","EventContext.env","Console.error","Response","Response.status","Request.url","Headers.delete","Request.cf","EventContext.passThroughOnException","EventContext.waitUntil","KVNamespace.delete","KVNamespace.put","Crypto.getRandomValues","KVNamespace.get","CfProperties","IncomingRequestCfProperties","CacheStorage","Request"] |
| worker | @cloudflare/workers-types | 22 | 28 | 5 | 18 | 2 | 360 | ["EventContext","Response","Request.clone","EventContext.request","Response.body","Request.headers","EventContext.env","Console.error","Response.status","Request.url","Headers.delete","Request.cf","EventContext.passThroughOnException","EventContext.waitUntil","CfProperties","IncomingRequestCfProperties","CacheStorage","Request"] |
...
| prompts-multi-select | sisteransi | 4 | 48 | 2 | 5 | 2 | 250 | ["erase","erase.line","cursor.hide","cursor.to"] |
...
| react-router-node | promises | 4 | 7 | 7 | 17 | 8 | 242.85714285714286 | [".readFile",".unlink",".mkdir",".writeFile"] |
...
| prompts-select | sisteransi | 4 | 48 | 3 | 6 | 3 | 200 | ["erase.line","cursor.hide","cursor.to","erase"] |
...
| prompts-confirm | sisteransi | 4 | 48 | 3 | 5 | 2 | 166.66666666666669 | ["cursor.hide","cursor.to","erase","erase.line"] |
...
| server | @types/express | 21 | 25 | 41 | 53 | 14 | 129.2682926829268 | ["e.Request","e.Response","e.NextFunction","e.Response.append","e.Response.end","e.Response.statusMessage","e.Response.status","e.Response.flushHeaders","e.Request.method","e.Request.headers","e.Response.on","e.Request.hostname","e.Request.originalUrl","e.Request.get","e.Request.protocol","e.Request.app"] |
| server | @types/api-gateway-proxy | 19 | 29 | 41 | 53 | 14 | 129.2682926829268 | ["APIGatewayProxyEventHeaders","APIGatewayProxyEventV2.isBase64Encoded","APIGatewayProxyEventV2.rawPath","APIGatewayProxyEventV2.headers","APIGatewayProxyEventV2","APIGatewayEventRequestContextV2.http","APIGatewayProxyEventV2.rawQueryString","APIGatewayProxyEventV2.requestContext","APIGatewayProxyEventV2.cookies","APIGatewayEventRequestContextV2.domainName","APIGatewayProxyEventV2.body","APIGatewayProxyEventHeaders.host","APIGatewayEventRequestContextV2","APIGatewayProxyResultV2","APIGatewayProxyStructuredResultV2"] |
...
| flatRoutes | @types/path | 8 | 18 | 13 | 15 | 5 | 115.38461538461539 | ["path.PlatformPath.posix","path.PlatformPath.relative","path.PlatformPath.extname","path.PlatformPath.dirname","path.PlatformPath.join","path.PlatformPath.win32","path.PlatformPath.sep"] |
| flatRoutes | fs | 3 | 3 | 13 | 15 | 5 | 115.38461538461539 | ["Dirent.name","Dirent.isFile","Dirent.isDirectory"] |
| flatRoutes | node:fs | 3 | 4 | 13 | 15 | 5 | 115.38461538461539 | ["node:fs",".readdirSync",".existsSync"] |
...
| --- | --- | --- | --- | --- | --- |
| react-router | 29 | 0 | ["@playground/vite-plugin-cloudflare","@playground/framework-vite-6","@playground/framework-express","@playground/data","@playground/perf-routes","@playground/split-route-modules-spa","@playground/middleware","react-router-dom","@playground/rsc-vite"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/vite-plugin-cloudflare","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-vite-6","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/data"] |
| react | 26 | 0 | ["@playground/vite-plugin-cloudflare","@playground/framework-vite-6","@playground/framework-express","@playground/data","@playground/perf-routes","@playground/split-route-modules-spa","@playground/middleware","@playground/rsc-vite","integration-vite-6-template"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/vite-plugin-cloudflare","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-vite-6","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/data"] |
...
| @react-router/node | 21 | 0 | ["@playground/framework-vite-6","@playground/framework-express","@playground/perf-routes","@playground/split-route-modules-spa","@react-router/serve","@playground/middleware","@react-router/dev","@react-router/express","integration-vite-6-template"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-vite-6","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/performance","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/split-route-modules-spa"] |
| express | 15 | 0 | ["@playground/vite-plugin-cloudflare","@playground/framework-express","@react-router/serve","@playground/middleware","@playground/rsc-vite","integration-vite-6-template","integration-rsc-vite","integration-rsc-vite-framework","integration-vite-8-template"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/vite-plugin-cloudflare","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/middleware"] |
| @react-router/serve | 13 | 0 | ["@playground/framework-vite-6","@playground/perf-routes","integration-vite-6-template","integration-rsc-vite-framework","integration-vite-8-template","integration-vite-7-beta-template","integration-vite-5-template","@playground/framework-vite-7-beta","@playground/split-route-modules"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-vite-6","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/performance","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-dev/__tests__/fixtures/basic","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-6-template"] |
| @react-router/express | 8 | 0 | ["@playground/framework-express","@react-router/serve","@playground/middleware","integration-vite-6-template","integration-vite-8-template","integration-vite-7-beta-template","integration-vite-5-template","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/middleware","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-6-template"] |
| compression | 8 | 0 | ["@playground/framework-express","@react-router/serve","@playground/middleware","@playground/rsc-vite","integration-rsc-vite","integration-rsc-vite-framework","@playground/rsc-vite-framework","@playground/rsc-vite-7-framework"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/middleware","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/rsc-vite"] |
| serialize-javascript | 7 | 0 | ["@playground/vite-plugin-cloudflare","integration-vite-6-template","integration-vite-8-template","integration-vite-7-beta-template","integration-vite-plugin-cloudflare-template","integration-vite-5-template","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/vite-plugin-cloudflare","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-6-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-8-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-7-beta-template"] |
| @mjackson/node-fetch-server | 7 | 0 | ["@react-router/serve","@playground/rsc-vite","@react-router/node","integration-rsc-vite","integration-rsc-vite-framework","@playground/rsc-vite-framework","@playground/rsc-vite-7-framework"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/rsc-vite","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-node","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/rsc-vite"] |
| react-server-dom-webpack | 6 | 0 | ["@playground/rsc-vite","integration-rsc-vite","integration-rsc-vite-framework","integration","@playground/rsc-vite-framework","@playground/rsc-vite-7-framework"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/rsc-vite","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/rsc-vite","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/rsc-vite-framework","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
| semver | 5 | 0 | ["create-react-router","@react-router/dev","react-router-scripts","integration","@remix-run/react-router"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/create-react-router","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-dev","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/scripts","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
| @vanilla-extract/css | 5 | 0 | ["integration-vite-6-template","integration-vite-8-template","integration-vite-7-beta-template","integration-vite-5-template","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-6-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-8-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-7-beta-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-5-template"] |
| @vanilla-extract/vite-plugin | 5 | 0 | ["integration-vite-6-template","integration-vite-8-template","integration-vite-7-beta-template","integration-vite-5-template","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-6-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-8-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-7-beta-template","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration/helpers/vite-5-template"] |
| morgan | 3 | 0 | ["@playground/framework-express","@react-router/serve","@playground/middleware"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/framework-express","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/middleware"] |
...
| prettier | 3 | 0 | ["@react-router/dev","integration","@remix-run/react-router"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-dev","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1"] |
| get-port | 2 | 0 | ["@react-router/serve","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-serve","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
...
| execa | 2 | 0 | ["create-react-router","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/create-react-router","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
...
| strip-ansi | 2 | 0 | ["create-react-router","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/create-react-router","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
| dedent | 2 | 0 | ["@react-router/dev","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-dev","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
...
| pathe | 2 | 0 | ["@react-router/dev","integration"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/packages/react-router-dev","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/integration"] |
...
| remix-utils | 2 | 0 | ["@playground/rsc-vite-framework","@playground/rsc-vite-7-framework"] | [] | ["/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/rsc-vite-framework","/home/runner/work/code-graph-analysis-examples/code-graph-analysis-examples/temp/react-router-7.18.1/./source/react-router-7.18.1/playground/rsc-vite-7-framework"] |
