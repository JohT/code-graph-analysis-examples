...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>16</td>
      <td>1</td>
      <td>[StreamingQueryMessage-&gt;ResponseType, GenericStreamingQueryMessage-&gt;ResponseType, GenericStreamingQueryMessage-&gt;PublisherResponseType, QueryGateway-&gt;ResponseTypes, QueryGateway-&gt;ResponseType, SimpleQueryUpdateEmitter-&gt;OptionalResponseType, SimpleQueryUpdateEmitter-&gt;PublisherResponseType, SimpleQ...</td>
    ...
    <tr>
      ...
      <td>[ReadEventDataWithoutGapsStatementBuilder-&gt;EventSchema, CreateTokenAtStatementBuilder-&gt;EventSchema, ReadEventDataForAggregateStatementBuilder-&gt;EventSchema, DeleteSnapshotsStatementBuilder-&gt;EventSchema, LastSequenceNumberForStatementBuilder-&gt;EventSchema, AppendSnapshotStatementBuilder-&gt;EventSchem...</td>
    </tr>
    <tr>
      <th>20</th>
      <td>axon-messaging-4.10.3</td>
      ...
      <td>[TokenStore-&gt;Segment, TokenStore-&gt;TrackingToken, ConfigToken-&gt;TrackingToken, AbstractTokenEntry-&gt;TrackingToken, GenericTokenEntry-&gt;TrackingToken]</td>
    </tr>
    <tr>
      <th>21</th>
      ...
      <td>[GenericJpaRepository-&gt;AnnotatedAggregate, ForwardingMode-&gt;EntityModel, ForwardMatchingInstances-&gt;EntityModel, LockingRepository$Builder-&gt;AggregateModel, GenericJpaRepository$Builder-&gt;AggregateModel, AbstractRepository-&gt;AggregateModel, AbstractRepository$Builder-&gt;AggregateModel, AggregateAnnotat...</td>
    </tr>
    <tr>
      <th>22</th>
      <td>axon-messaging-4.10.3</td>
    ...
    <tr>
      ...
      <td>[CommandMessageFilter-&gt;AndCommandMessageFilter, CommandMessageFilter-&gt;NegateCommandMessageFilter, DistributedCommandBus-&gt;DenyAll, DistributedCommandBus-&gt;DenyCommandNameFilter, CommandMessageFilter-&gt;OrCommandMessageFilter, DistributedCommandBus-&gt;CommandNameFilter]</td>
    </tr>
  </tbody>
</table>
</div>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.140625</td>
      <td>[org.axonframework.common.transaction, org.axonframework.common, org.axonframework.monitoring, org.axonframework.messaging, org.axonframework.commandhandling.callbacks, org.axonframework.messaging.annotation, org.axonframework.commandhandling, org.axonframework.messaging.unitofwork, org.axonfram...</td>
      <td>[transaction, common, monitoring, messaging, callbacks, annotation, commandhandling, unitofwork, caching]</td>
    </tr>
    <tr>
      <th>4</th>
      <td>axon-test-4.10.3</td>
      ...
      <td>64</td>
      <td>0.156250</td>
      <td>[org.axonframework.eventhandling, org.axonframework.messaging, org.axonframework.commandhandling, org.axonframework.common, org.axonframework.messaging.annotation, org.axonframework.eventhandling.scheduling, org.axonframework.common.stream, org.axonframework.deadline, org.axonframework.messaging...</td>
      <td>[eventhandling, messaging, commandhandling, common, annotation, scheduling, stream, deadline, unitofwork, gateway]</td>
    </tr>
    <tr>
      <th>5</th>
      <td>axon-eventsourcing-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.281250</td>
      <td>[org.axonframework.common.annotation, org.axonframework.tracing, org.axonframework.common, org.axonframework.eventhandling, org.axonframework.common.property, org.axonframework.commandhandling, org.axonframework.messaging.interceptors, org.axonframework.common.lock, org.axonframework.messaging.a...</td>
      <td>[annotation, tracing, common, eventhandling, property, commandhandling, interceptors, lock, unitofwork, jpa, deadline, messaging, caching, xml, serialization, jdbc, legacyjpa]</td>
    </tr>
    <tr>
      <th>10</th>
      <td>axon-eventsourcing-4.10.3</td>
      ...
      <td>64</td>
      <td>0.312500</td>
      <td>[org.axonframework.serialization.upcasting.event, org.axonframework.common, org.axonframework.common.jpa, org.axonframework.common.transaction, org.axonframework.common.io, org.axonframework.common.jdbc, org.axonframework.eventhandling, org.axonframework.serialization, org.axonframework.messagin...</td>
      <td>[event, common, jpa, transaction, io, jdbc, eventhandling, serialization, unitofwork, caching, messaging, lock, tracing, annotation, xml, stream, monitoring, lifecycle, commandhandling, legacyjpa]</td>
    </tr>
    <tr>
      <th>11</th>
      <td>axon-server-connector-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.390625</td>
      <td>[org.axonframework.eventhandling, org.axonframework.messaging, org.axonframework.eventhandling.scheduling.java, org.axonframework.common.jdbc, org.axonframework.serialization.xml, org.axonframework.monitoring, org.axonframework.common, org.axonframework.messaging.unitofwork, org.axonframework.se...</td>
      <td>[eventhandling, messaging, java, jdbc, xml, monitoring, common, unitofwork, event, scheduling, async, lifecycle, tracing, stream, serialization, responsetypes, queryhandling, tokenstore, pooled, transaction, distributed, commandhandling, callbacks, util, inmemory]</td>
    </tr>
    <tr>
      <th>14</th>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.531250</td>
      <td>[org.axonframework.eventhandling.deadletter, org.axonframework.messaging.deadletter, org.axonframework.eventhandling, org.axonframework.common.jdbc, org.axonframework.common, org.axonframework.messaging.unitofwork, org.axonframework.serialization.xml, org.axonframework.serialization.upcasting.ev...</td>
      <td>[deadletter, eventhandling, jdbc, common, unitofwork, xml, event, inmemory, pooled, lock, jpa, interceptors, tokenstore, async, tracing, transaction, scheduling, commandhandling, gateway, monitoring, deadline, annotation, queryhandling, messaging, caching, serialization, util, lifecycle, correla...</td>
    </tr>
    <tr>
      <th>17</th>
      <td>axon-spring-boot-autoconfigure-4.10.3</td>
      ...
      <td>9</td>
      <td>0.555556</td>
      <td>[org.axonframework.eventsourcing, org.axonframework.eventsourcing.eventstore.jdbc, org.axonframework.eventsourcing.eventstore, org.axonframework.eventsourcing.eventstore.jpa, org.axonframework.eventsourcing.eventstore.legacyjpa]</td>
    ...
    <tr>
      ...
      <td>10</td>
      <td>0.600000</td>
      <td>[org.axonframework.modelling.saga.repository.jdbc, org.axonframework.modelling.saga.repository, org.axonframework.modelling.saga, org.axonframework.modelling.saga.repository.jpa, org.axonframework.modelling.command, org.axonframework.modelling.saga.repository.legacyjpa]</td>
      <td>[jdbc, repository, saga, jpa, command, legacyjpa]</td>
    </tr>
    <tr>
      <th>19</th>
      <td>axon-modelling-4.10.3</td>
    ...
    <tr>
      ...
      <td>10</td>
      <td>0.600000</td>
      <td>[org.axonframework.modelling.saga.repository.jpa, org.axonframework.modelling.command.inspection, org.axonframework.modelling.saga.repository, org.axonframework.modelling.saga.repository.inmemory, org.axonframework.modelling.command, org.axonframework.modelling.saga]</td>
      <td>[jpa, inspection, repository, inmemory, command, saga]</td>
    </tr>
    <tr>
      <th>21</th>
      <td>axon-spring-boot-autoconfigure-4.10.3</td>
      ...
      <td>64</td>
      <td>0.609375</td>
      <td>[org.axonframework.commandhandling.gateway, org.axonframework.eventhandling, org.axonframework.deadline.jobrunr, org.axonframework.common.jpa, org.axonframework.eventhandling.tokenstore.jdbc, org.axonframework.lifecycle, org.axonframework.commandhandling.distributed, org.axonframework.eventhandl...</td>
      <td>[gateway, eventhandling, jobrunr, jpa, jdbc, lifecycle, distributed, dbscheduler, transaction, interceptors, serialization, event, deadletter, pooled, scheduling, tracing, xml, deadline, messaging, annotation, async, attributes, tokenstore, json, commandhandling, common, correlation, queryhandli...</td>
    </tr>
    <tr>
      <th>22</th>
      <td>axon-test-4.10.3</td>
    ...
    <tr>
      ...
      <td>64</td>
      <td>0.640625</td>
      <td>[org.axonframework.messaging, org.axonframework.common, org.axonframework.messaging.unitofwork, org.axonframework.messaging.annotation, org.axonframework.common.transaction, org.axonframework.messaging.correlation, org.axonframework.eventhandling, org.axonframework.monitoring, org.axonframework....</td>
      <td>[messaging, common, unitofwork, annotation, transaction, correlation, eventhandling, monitoring, responsetypes, interceptors, registration, tracing, legacyjpa, serialization, tokenstore, jpa, lifecycle, stream, io, deadline, deadletter, jdbc, replay, event, async, upcasting, xml, scheduling, pro...</td>
    </tr>
    <tr>
      <th>24</th>
      <td>axon-eventsourcing-4.10.3</td>
    ...
    <tr>
      ...
      <td>11</td>
      <td>0.818182</td>
      <td>[org.axonframework.axonserver.connector.processor, org.axonframework.axonserver.connector, org.axonframework.axonserver.connector.event.util, org.axonframework.axonserver.connector.util, org.axonframework.axonserver.connector.query, org.axonframework.axonserver.connector.command, org.axonframewo...</td>
    ...
    <tr>
      ...
      <td>9</td>
      <td>0.888889</td>
      <td>[org.axonframework.springboot, org.axonframework.springboot.util.jpa, org.axonframework.springboot.util, org.axonframework.actuator.axonserver, org.axonframework.springboot.service.connection, org.axonframework.actuator, org.axonframework.springboot.util.legacyjpa, org.axonframework.springboot.a...</td>
      <td>[springboot, jpa, util, axonserver, connection, actuator, legacyjpa, autoconfig]</td>
    </tr>
    <tr>
      <th>27</th>
      <td>axon-server-connector-4.10.3</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Class</td>
      <td>22</td>
      <td>[org.axonframework.springboot.autoconfig.AxonServerBusAutoConfiguration, org.axonframework.springboot.autoconfig.InfraConfiguration, org.axonframework.springboot.autoconfig.legacyjpa.JpaJavaxAutoConfiguration, org.axonframework.springboot.autoconfig.JpaAutoConfiguration, org.axonframework.spring...</td>
    </tr>
    <tr>
      <th>15</th>
    ...
    <tr>
      ...
      <td>Class</td>
      <td>12</td>
      <td>[org.axonframework.springboot.autoconfig.AxonServerBusAutoConfiguration, org.axonframework.springboot.autoconfig.InfraConfiguration, org.axonframework.springboot.autoconfig.AxonServerAutoConfiguration$ConnectionDetailsConnectionManagerConfiguration, org.axonframework.springboot.autoconfig.Microm...</td>
    </tr>
    <tr>
      <th>23</th>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>82</td>
      <td>38</td>
      <td>[/org/axonframework/axonserver/connector/heartbeat uses /org/axonframework/axonserver/connector, /org/axonframework/axonserver/connector/query uses /org/axonframework/axonserver/connector, /org/axonframework/axonserver/connector/command uses /org/axonframework/axonserver/connector, /org/axonfram...</td>
    </tr>
    <tr>
      <th>2</th>
      <td>2</td>
      ...
      <td>760</td>
      <td>472</td>
      <td>[/org/axonframework/axonserver/connector/heartbeat/source uses /org/axonframework/axonserver/connector, /org/axonframework/axonserver/connector/event/axon uses /org/axonframework/axonserver/connector, /org/axonframework/axonserver/connector/query/subscription uses /org/axonframework/axonserver/c...</td>
    </tr>
    <tr>
      <th>3</th>
      <td>4</td>
