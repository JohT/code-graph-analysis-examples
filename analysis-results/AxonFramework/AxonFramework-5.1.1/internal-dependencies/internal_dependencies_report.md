...
| axoniq-spring-boot-autoconfigure-5.1.1 | axon-messaging-5.1.1 | 4 | 57 | 0.07017543859649122 | ["org.axonframework.messaging.core.unitofwork.transaction.jdbc","org.axonframework.messaging.eventhandling.processing.streaming.pooled","org.axonframework.messaging.core.unitofwork.transaction.jpa","org.axonframework.messaging.eventhandling.conversion"] | ["jdbc","pooled","jpa","conversion"] |
| axon-test-5.1.1 | axon-eventsourcing-5.1.1 | 1 | 11 | 0.09090909090909091 | ["org.axonframework.eventsourcing.eventstore"] | ["eventstore"] |
| axon-metrics-micrometer-5.1.1 | axon-messaging-5.1.1 | 7 | 57 | 0.12280701754385964 | ["org.axonframework.messaging.eventhandling.processing","org.axonframework.messaging.monitoring","org.axonframework.messaging.monitoring.configuration","org.axonframework.messaging.queryhandling","org.axonframework.messaging.commandhandling","org.axonframework.messaging.eventhandling","org.axonframework.messaging.core"] | ["processing","monitoring","configuration","queryhandling","commandhandling","eventhandling","core"] |
...
| axon-test-5.1.1 | axon-messaging-5.1.1 | 9 | 57 | 0.15789473684210525 | ["org.axonframework.messaging.core.annotation","org.axonframework.messaging.core.unitofwork","org.axonframework.messaging.core","org.axonframework.messaging.monitoring","org.axonframework.messaging.commandhandling","org.axonframework.messaging.core.conversion","org.axonframework.messaging.eventhandling","org.axonframework.messaging.eventhandling.processing.streaming.token","org.axonframework.messaging.eventstreaming"] | ["annotation","unitofwork","core","monitoring","commandhandling","conversion","eventhandling","token","eventstreaming"] |
| axon-update-5.1.1 | axon-common-5.1.1 | 3 | 15 | 0.2 | ["org.axonframework.common.annotation","org.axonframework.common","org.axonframework.common.configuration"] | ["annotation","common","configuration"] |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 2130 | 32.83 | 868 | 900 | ["/axon-test-5.1.1.jar uses /axon-messaging-5.1.1.jar","/axon-server-connector-5.1.1.jar uses /axon-messaging-5.1.1.jar","/axon-metrics-micrometer-5.1.1.jar uses /axon-messaging-5.1.1.jar","/axoniq-spring-boot-autoconfigure-5.1.1.jar uses /axon-messaging-5.1.1.jar"] |
| 1 | 94 | 1.45 | 82 | 37 | ["/org/axonframework/messaging/commandhandling/configuration uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/commandhandling/retry uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/commandhandling/gateway uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/commandhandling/tracing uses /org/axonframework/messaging/commandhandling"] |
| 2 | 2200 | 33.91 | 624 | 450 | ["/org/axonframework/messaging/core/configuration uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/core/timeout uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/monitoring/configuration uses /org/axonframework/messaging/commandhandling","/org/axonframework/messaging/core/interception uses /org/axonframework/messaging/commandhandling"] |
| 4 | 2064 | 31.81 | 670 | 283 | ["/org/axonframework/test/fixture uses /org/axonframework/messaging/commandhandling","/io/axoniq/framework/axonserver/connector/shared uses /org/axonframework/messaging/commandhandling","/org/axonframework/test/matchers uses /org/axonframework/messaging/commandhandling","/org/axonframework/extension/metrics/micrometer uses /org/axonframework/messaging/commandhandling"] |
...
| 5 | 90 | 35 | 22 | ["/io/axoniq/framework/axonserver/connector/configuration ->/org/axonframework/messaging/commandhandling/interception","/io/axoniq/framework/axonserver/connector/configuration ->/org/axonframework/messaging/commandhandling/gateway"] |
