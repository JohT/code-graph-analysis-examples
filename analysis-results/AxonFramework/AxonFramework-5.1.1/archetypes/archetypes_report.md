...
| Type,Java,Interface | 391 | 3 | 4 | 0 |
| Type,Java,Record | 62 | 1 | 2 | 0 |
...
| --- | --- | --- | --- |
| Authority | 7 | 7 | /axon-common-5.1.1.jar, /axon-server-connector-5.1.1.jar, /axon-update-5.1.1.jar |
| Bottleneck | 3 | 3 | /axon-conversion-5.1.1.jar, /axon-eventsourcing-5.1.1.jar, /axon-modelling-5.1.1.jar |
| Hub | 1 | 1 | /axon-common-5.1.1.jar |
