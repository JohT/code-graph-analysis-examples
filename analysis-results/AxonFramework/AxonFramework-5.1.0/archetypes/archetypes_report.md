...
| Type,Java,Class | 757 | 6 | 4 | 1 |
| Type,Java,Interface | 390 | 3 | 4 | 0 |
| Type,Java,Record | 60 | 1 | 2 | 0 |
...
| --- | --- | --- | --- |
| Authority | 7 | 7 | /axon-common-5.1.0.jar, /axon-server-connector-5.1.0.jar, /axon-update-5.1.0.jar |
| Bottleneck | 3 | 3 | /axon-conversion-5.1.0.jar, /axon-eventsourcing-5.1.0.jar, /axon-modelling-5.1.0.jar |
| Hub | 1 | 1 | /axon-common-5.1.0.jar |
...
| Archetype | Count | Max. Rank | Examples |
| --- | --- | --- | --- |
| Authority | 10 | 10 | org.axonframework.common, org.axonframework.common.io, org.axonframework.extension.metrics.micrometer |
