...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type,Java,Interface | 257 | 35 | 3 | 5 | 5 | 6 | 1 |
| Type,Java,Class | 793 | 19 | 6 | 3 | 4 | 3 | 8 |
...
| Feature | Mean absolute SHAP value |
| --- | --- |
| *Node embeddings aggregated* | 0.034774 |
| articleRank | 0.021679 |
| pageRank | 0.014470 |
| incomingDependencies | 0.012250 |
| pageToArticleRankDifference | 0.011499 |
| degree | 0.008641 |
| betweenness | 0.005014 |
| localClusteringCoefficient | 0.004027 |
| nodeEmbeddingPCA_25 | 0.002504 |
| nodeEmbeddingPCA_29 | 0.002390 |
| nodeEmbeddingPCA_12 | 0.001485 |

#### Archetype Distribution

| Archetype | Count | Max. Score | Model Status | Examples |
| --- | --- | --- | --- | --- |
|  | 61 | 0.1098 | Anomalous | org.axonframework.messaging.core.unitofwork.ProcessingContext, org.axonframework.messaging.core.Message, org.axonframework.common.TypeReference |
| Authority | 8 | 0.0814 | Anomalous | org.axonframework.common.TypeReference, org.axonframework.common.infra.DescribableComponent, org.axonframework.common.infra.ComponentDescriptor |
| Bottleneck | 8 | 0.1098 | Anomalous | org.axonframework.messaging.core.unitofwork.ProcessingContext, org.axonframework.messaging.core.Message, org.axonframework.messaging.core.QualifiedName |
| Bridge | 10 | 0.0187 | Anomalous | org.axonframework.common.caching.EhCacheAdapter, org.axonframework.test.fixture.AxonTestPhase$When, org.axonframework.common.caching.JCacheAdapter |
| Hub | 9 | 0.1098 | Anomalous | org.axonframework.messaging.core.unitofwork.ProcessingContext, org.axonframework.messaging.core.Message, org.axonframework.messaging.core.MessageStream |
|  | 1145 | -0.0001 | Typical | org.axonframework.update.api.UpdateCheckResponse, org.axonframework.modelling.entity.EntityMetamodel, org.axonframework.test.util.MessageMonitorReport$Report |
...
| Bottleneck | 2 | -0.0127 | Typical | org.axonframework.modelling.entity.annotation.AnnotatedEntityMetamodel, org.axonframework.common.TypeReflectionUtils |
| Hub | 1 | -0.023 | Typical | org.axonframework.axonserver.connector.ErrorCode |
| Outlier | 10 | -0.0027 | Typical | org.axonframework.messaging.commandhandling.distributed.CommandBusConnector$Handler, org.axonframework.axonserver.connector.query.QueryResponseMessageStream, org.axonframework.messaging.core.conversion.DelegatingMessageConverter |

#### Top anomalies with their local contributing features (via SHAP)

| Name | Contained in | Anomaly Score | Archetypes | Top Feature 1 | Top Feature 1 SHAP | Top Feature 2 | Top Feature 2 SHAP | Top Feature 3 | Top Feature 3 SHAP | Model Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| org.axonframework.messaging.core.unitofwork.ProcessingContext | axon-messaging-5.0.3 | 0.1098 | , Hub, Bottleneck | articleRank | -0.2842 | pageRank | -0.1705 | incomingDependencies | -0.1413 | Anomalous |
| org.axonframework.messaging.core.Message | axon-messaging-5.0.3 | 0.0975 | , Bottleneck, Hub | articleRank | -0.2905 | pageRank | -0.1678 | incomingDependencies | -0.1507 | Anomalous |
| org.axonframework.common.TypeReference | axon-common-5.0.3 | 0.0814 | Authority,  | articleRank | -0.2889 | pageRank | -0.1795 | incomingDependencies | -0.13 | Anomalous |
| org.axonframework.messaging.core.QualifiedName | axon-messaging-5.0.3 | 0.0779 | , Bottleneck | articleRank | -0.2848 | pageRank | -0.1454 | incomingDependencies | -0.142 | Anomalous |
| org.axonframework.messaging.core.MessageStream | axon-messaging-5.0.3 | 0.075 | Bottleneck, , Hub | articleRank | -0.2905 | pageRank | -0.1527 | incomingDependencies | -0.1446 | Anomalous |
| org.axonframework.common.infra.DescribableComponent | axon-common-5.0.3 | 0.072 | Authority, , Hub | articleRank | -0.2902 | pageRank | -0.1723 | incomingDependencies | -0.157 | Anomalous |
| org.axonframework.messaging.core.Context$ResourceKey | axon-messaging-5.0.3 | 0.069 |  | articleRank | -0.2964 | pageRank | -0.1752 | incomingDependencies | -0.1435 | Anomalous |
| org.axonframework.conversion.Converter | axon-conversion-5.0.3 | 0.0641 |  | articleRank | -0.3018 | pageRank | -0.1774 | incomingDependencies | -0.1476 | Anomalous |
| org.axonframework.messaging.eventstreaming.EventCriteria | axon-messaging-5.0.3 | 0.0611 |  | articleRank | -0.2818 | pageRank | -0.1701 | pageToArticleRankDifference | -0.1246 | Anomalous |
| org.axonframework.common.infra.ComponentDescriptor | axon-common-5.0.3 | 0.0563 | Authority,  | articleRank | -0.2974 | pageRank | -0.1736 | incomingDependencies | -0.1494 | Anomalous |
| org.axonframework.common.annotation.Internal | axon-common-5.0.3 | 0.0555 |  | articleRank | -0.3017 | pageRank | -0.164 | incomingDependencies | -0.1502 | Anomalous |
| org.axonframework.messaging.eventhandling.EventMessage | axon-messaging-5.0.3 | 0.0538 | Hub,  | articleRank | -0.2818 | incomingDependencies | -0.1627 | pageRank | -0.1524 | Anomalous |
| org.axonframework.messaging.core.MessageType | axon-messaging-5.0.3 | 0.0478 | Bottleneck,  | articleRank | -0.2978 | incomingDependencies | -0.1525 | pageRank | -0.1493 | Anomalous |
| org.axonframework.common.AxonException | axon-common-5.0.3 | 0.047 | Authority,  | articleRank | -0.3351 | pageRank | -0.2062 | pageToArticleRankDifference | -0.1563 | Anomalous |
| org.axonframework.messaging.core.Metadata | axon-messaging-5.0.3 | 0.039 | Authority,  | articleRank | -0.3076 | pageRank | -0.1801 | incomingDependencies | -0.1561 | Anomalous |
| org.axonframework.messaging.core.Context | axon-messaging-5.0.3 | 0.0383 | Bottleneck,  | articleRank | -0.3232 | pageRank | -0.1949 | pageToArticleRankDifference | -0.1547 | Anomalous |
| org.axonframework.common.configuration.Configuration | axon-common-5.0.3 | 0.0344 | Hub,  | articleRank | -0.2958 | pageRank | -0.1693 | incomingDependencies | -0.1544 | Anomalous |
| org.axonframework.messaging.eventhandling.processing.streaming.token.TrackingToken | axon-messaging-5.0.3 | 0.0334 |  | articleRank | -0.301 | pageRank | -0.1542 | incomingDependencies | -0.1529 | Anomalous |
| org.axonframework.conversion.ContentTypeConverter | axon-conversion-5.0.3 | 0.0317 |  | articleRank | -0.2988 | pageRank | -0.1707 | pageToArticleRankDifference | -0.1049 | Anomalous |
| org.axonframework.common.AxonConfigurationException | axon-common-5.0.3 | 0.0311 |  | articleRank | -0.2874 | pageRank | -0.1854 | pageToArticleRankDifference | -0.1351 | Anomalous |
